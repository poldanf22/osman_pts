...
if uploaded_file is not None:
    ...
    # min jumlah benar
    min_maw = df.iloc[t, len_col-48]
    min_map = df.iloc[t, len_col-47]
    min_ind = df.iloc[t, len_col-46]
    min_eng = df.iloc[t, len_col-45]
    min_sej = df.iloc[t, len_col-44]
    min_geo = df.iloc[t, len_col-43]
    min_eko = df.iloc[t, len_col-42]
    min_sos = df.iloc[t, len_col-41]
    min_fis = df.iloc[t, len_col-40]
    min_kim = df.iloc[t, len_col-39]
    min_bio = df.iloc[t, len_col-38]
    min_jml = df.iloc[t, len_col-37]

    # min nilai standar
    min_Smaw = df.iloc[t, len_col-25]
    min_Smap = df.iloc[t, len_col-24]
    min_Sind = df.iloc[t, len_col-23]
    min_Seng = df.iloc[t, len_col-22]
    min_Ssej = df.iloc[t, len_col-21]
    min_Sgeo = df.iloc[t, len_col-20]
    min_Seko = df.iloc[t, len_col-19]
    min_Ssos = df.iloc[t, len_col-18]
    min_Sfis = df.iloc[t, len_col-17]
    min_Skim = df.iloc[t, len_col-16]
    min_Sbio = df.iloc[t, len_col-15]
    min_Sjml = df.iloc[t, len_col-14]
