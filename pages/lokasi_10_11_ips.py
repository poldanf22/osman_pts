...
uploaded_file = st.file_uploader('Letakkan file excel NILAI STANDAR [LOKASI 101-160]', type='xlsx')
...
if uploaded_file is not None:
	...
	# JUMLAH PESERTA
	peserta = df.iloc[r,len_col-199] 

	# rata-rata jumlah benar
	rata_mat=df.iloc[r,len_col-32]
	rata_ind=df.iloc[r,len_col-31]
	rata_eng=df.iloc[r,len_col-30]
	rata_sej=df.iloc[r,len_col-29]
	rata_geo=df.iloc[r,len_col-28]
	rata_sos=df.iloc[r,len_col-27]
	rata_eko=df.iloc[r,len_col-26]
	rata_jml=df.iloc[r,len_col-25]

	# rata-rata nilai standar
	rata_Smat=df.iloc[t,len_col-17]
	rata_Sind=df.iloc[t,len_col-16]
	rata_Seng=df.iloc[t,len_col-15]
	rata_Ssej=df.iloc[t,len_col-14]
	rata_Sgeo=df.iloc[t,len_col-13]
	rata_Ssos=df.iloc[t,len_col-12]
	rata_Seko=df.iloc[t,len_col-11]
	rata_Sjml=df.iloc[t,len_col-10]

	# max jumlah benar
	max_mat=df.iloc[t,len_col-32]
	max_ind=df.iloc[t,len_col-31]
	max_eng=df.iloc[t,len_col-30]
	max_sej=df.iloc[t,len_col-29]
	max_geo=df.iloc[t,len_col-28]
	max_sos=df.iloc[t,len_col-27]
	max_eko=df.iloc[t,len_col-26]
	max_jml=df.iloc[t,len_col-25]

	# max nilai standar
	max_Smat=df.iloc[r,len_col-17]
	max_Sind=df.iloc[r,len_col-16]
	max_Seng=df.iloc[r,len_col-15]
	max_Ssej=df.iloc[r,len_col-14]
	max_Sgeo=df.iloc[r,len_col-13]
	max_Ssos=df.iloc[r,len_col-12]
	max_Seko=df.iloc[r,len_col-11]
	max_Sjml=df.iloc[r,len_col-10]

	# min jumlah benar
	min_mat=df.iloc[u,len_col-32]
	min_ind=df.iloc[u,len_col-31]
	min_eng=df.iloc[u,len_col-30]
	min_sej=df.iloc[u,len_col-29]
	min_geo=df.iloc[u,len_col-28]
	min_sos=df.iloc[u,len_col-27]
	min_eko=df.iloc[u,len_col-26]
	min_jml=df.iloc[u,len_col-25]

	# min nilai standar
	min_Smat=df.iloc[s,len_col-17]
	min_Sind=df.iloc[s,len_col-16]
	min_Seng=df.iloc[s,len_col-15]
	min_Ssej=df.iloc[s,len_col-14]
	min_Sgeo=df.iloc[s,len_col-13]
	min_Ssos=df.iloc[s,len_col-12]
	min_Seko=df.iloc[s,len_col-11]
	min_Sjml=df.iloc[s,len_col-10]

	data_jml_benar = {'BIDANG STUDI':['MATEMATIKA (MAT)', 'B. INDONESIA (IND)', 'B. INGGRIS (ENG)', 'SEJARAH (SEJ)', 'GEOGRAFI (GEO)', 'SOSIOLOGI (SOS)', 'EKONOMI (EKO)', 'JUMLAH (JML)'],
	           'TERENDAH':[min_mat, min_ind, min_eng, min_sej, min_geo, min_sos, min_eko, min_jml],
	           'RATA-RATA':[rata_mat, rata_ind, rata_eng, rata_sej, rata_geo, rata_sos, rata_eko, rata_jml],
	           'TERTINGGI':[max_mat, max_ind, max_eng, max_sej, max_geo, max_sos, max_eko, max_jml]}

	jml_benar=pd.DataFrame(data_jml_benar)

	data_n_standar = {'BIDANG STUDI':['MATEMATIKA (MAT)', 'B. INDONESIA (IND)', 'B. INGGRIS (ENG)', 'SEJARAH (SEJ)', 'GEOGRAFI (GEO)', 'SOSIOLOGI (SOS)', 'EKONOMI (EKO)', 'JUMLAH (JML)'],
	           'TERENDAH':[min_Smat, min_Sind, min_Seng, min_Ssej, min_Sgeo, min_Ssos, min_Seko, min_Sjml],
	           'RATA-RATA':[rata_Smat, rata_Sind, rata_Seng, rata_Ssej, rata_Sgeo, rata_Ssos, rata_Seko, rata_Sjml],
	           'TERTINGGI':[max_Smat, max_Sind, max_Seng, max_Ssej, max_Sgeo, max_Ssos, max_Seko, max_Sjml]}
	...
	data_jml_soal = {'BIDANG STUDI':['MAT', 'IND', 'ENG', 'SEJ', 'GEO', 'SOS', 'EKO'],
	                'JUMLAH':[JML_SOAL_MAT, JML_SOAL_IND, JML_SOAL_ENG, JML_SOAL_SEJ, JML_SOAL_GEO, JML_SOAL_SOS, JML_SOAL_EKO]}

	jml_soal = pd.DataFrame(data_jml_soal)

	df = df[['LOKASI', 'RANK LOK.', 'RANK NAS.', 'NOMOR NF', 'NAMA SISWA', 'NAMA SEKOLAH', 'KELAS', 'MAT', 'IND', 'ENG', 'SEJ', 'GEO', 'SOS', 'EKO', 'JML', 'S_MAT', 'S_IND', 'S_ENG', 'S_SEJ', 'S_GEO', 'S_SOS', 'S_EKO', 'S_JML' ]]
	...
	sort101_10=sort101_10.drop(sort101_10[(sort101_10['RANK LOK.']>10)].index)
	# 102
	sort102_10=sort102.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort102_10['LOKASI']
	sort102_10=sort102_10.drop(sort102_10[(sort102_10['RANK LOK.']>10)].index)
	# 103
	sort103_10=sort103.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort103_10['LOKASI']
	sort103_10=sort103_10.drop(sort103_10[(sort103_10['RANK LOK.']>10)].index)
	# # 104
...
jml_benar.to_excel(writer, sheet_name='cover',
	...
	worksheetcover.merge_range('A4:F5', 'PENILAIAN AKHIR SEMESTER', sub_titleCover)
	worksheetcover.merge_range('A6:F7', 'SEMESTER 1 TAHUN 2022-2023', headerCover)
	worksheetcover.write('A9', 'JUMLAH BENAR', sub_headerCover)
	worksheetcover.write('A21', 'NILAI STANDAR', sub_headerCover)
	worksheetcover.merge_range('F8:G9', '10 SMA IPS', kelasCover)
	...
	worksheet101.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TAMAN MARGASATWA', title)
	worksheet101.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet101.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet101.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet101.write('G5', 'MAT', body)
	worksheet101.write('H5', 'IND', body)
	worksheet101.write('I5', 'ENG', body)
	worksheet101.write('J5', 'SEJ', body)
	worksheet101.write('K5', 'GEO', body)
	worksheet101.write('L5', 'SOS', body)
	worksheet101.write('M5', 'EKO', body)
	worksheet101.write('N5', 'JML', body)
	worksheet101.write('O5', 'MAT', body)
	worksheet101.write('P5', 'IND', body)
	worksheet101.write('Q5', 'ENG', body)
	worksheet101.write('R5', 'SEJ', body)
	worksheet101.write('S5', 'GEO', body)
	worksheet101.write('T5', 'SOS', body)
	worksheet101.write('U5', 'EKO', body)
	worksheet101.write('V5', 'JML', body)



	worksheet101.conditional_format(5,0,row101_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet101.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TAMAN MARGASATWA', title)
	worksheet101.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet101.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet101.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet101.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet101.write('O22', 'MAT', body)
	...
	worksheet101.conditional_format(22,0,row101+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet102.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CEMPAKA', title)
	worksheet102.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet102.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet102.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet102.write('G5', 'MAT', body)
	worksheet102.write('H5', 'IND', body)
	worksheet102.write('I5', 'ENG', body)
	worksheet102.write('J5', 'SEJ', body)
	worksheet102.write('K5', 'GEO', body)
	worksheet102.write('L5', 'SOS', body)
	worksheet102.write('M5', 'EKO', body)
	worksheet102.write('N5', 'JML', body)
	worksheet102.write('O5', 'MAT', body)
	worksheet102.write('P5', 'IND', body)
	worksheet102.write('Q5', 'ENG', body)
	worksheet102.write('R5', 'SEJ', body)
	worksheet102.write('S5', 'GEO', body)
	worksheet102.write('T5', 'SOS', body)
	worksheet102.write('U5', 'EKO', body)
	worksheet102.write('V5', 'JML', body)



	worksheet102.conditional_format(5,0,row102_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet102.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CEMPAKA', title)
	worksheet102.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet102.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet102.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet102.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet102.write('O22', 'MAT', body)
	...
	worksheet103.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PANGKALAN JATI', title)
	worksheet103.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet103.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet103.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet103.write('G5', 'MAT', body)
	worksheet103.write('H5', 'IND', body)
	worksheet103.write('I5', 'ENG', body)
	worksheet103.write('J5', 'SEJ', body)
	worksheet103.write('K5', 'GEO', body)
	worksheet103.write('L5', 'SOS', body)
	worksheet103.write('M5', 'EKO', body)
	worksheet103.write('N5', 'JML', body)
	worksheet103.write('O5', 'MAT', body)
	worksheet103.write('P5', 'IND', body)
	worksheet103.write('Q5', 'ENG', body)
	worksheet103.write('R5', 'SEJ', body)
	worksheet103.write('S5', 'GEO', body)
	worksheet103.write('T5', 'SOS', body)
	worksheet103.write('U5', 'EKO', body)
	worksheet103.write('V5', 'JML', body)



	worksheet103.conditional_format(5,0,row103_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet103.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PANGKALAN JATI', title)
	worksheet103.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet103.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet103.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet103.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet103.write('O22', 'MAT', body)
	...
	# worksheet104.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KENARI', title)
	# worksheet104.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet104.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet104.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet104.write('G5', 'MAT', body)
	# worksheet104.write('H5', 'IND', body)
	# worksheet104.write('I5', 'ENG', body)
	# worksheet104.write('J5', 'SEJ', body)
	# worksheet104.write('K5', 'GEO', body)
	# worksheet104.write('L5', 'SOS', body)
	# worksheet104.write('M5', 'EKO', body)
	# worksheet104.write('N5', 'JML', body)
	# worksheet104.write('O5', 'MAT', body)
	# worksheet104.write('P5', 'IND', body)
	# worksheet104.write('Q5', 'ENG', body)
	# worksheet104.write('R5', 'SEJ', body)
	# worksheet104.write('S5', 'GEO', body)
	# worksheet104.write('T5', 'SOS', body)
	# worksheet104.write('U5', 'EKO', body)
	# worksheet104.write('V5', 'JML', body)
	...
	# worksheet104.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KENARI', title)
	# worksheet104.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet104.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet105.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BUARAN', title)
	worksheet105.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet105.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet105.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet105.write('G5', 'MAT', body)
	worksheet105.write('H5', 'IND', body)
	worksheet105.write('I5', 'ENG', body)
	worksheet105.write('J5', 'SEJ', body)
	worksheet105.write('K5', 'GEO', body)
	worksheet105.write('L5', 'SOS', body)
	worksheet105.write('M5', 'EKO', body)
	worksheet105.write('N5', 'JML', body)
	worksheet105.write('O5', 'MAT', body)
	worksheet105.write('P5', 'IND', body)
	worksheet105.write('Q5', 'ENG', body)
	worksheet105.write('R5', 'SEJ', body)
	worksheet105.write('S5', 'GEO', body)
	worksheet105.write('T5', 'SOS', body)
	worksheet105.write('U5', 'EKO', body)
	worksheet105.write('V5', 'JML', body)



	worksheet105.conditional_format(5,0,row105_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet105.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BUARAN', title)
	worksheet105.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet105.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet105.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet105.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet105.write('O22', 'MAT', body)
	...
	worksheet106.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF HEK-KRAMAT JATI', title)
	worksheet106.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet106.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet106.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet106.write('G5', 'MAT', body)
	worksheet106.write('H5', 'IND', body)
	worksheet106.write('I5', 'ENG', body)
	worksheet106.write('J5', 'SEJ', body)
	worksheet106.write('K5', 'GEO', body)
	worksheet106.write('L5', 'SOS', body)
	worksheet106.write('M5', 'EKO', body)
	worksheet106.write('N5', 'JML', body)
	worksheet106.write('O5', 'MAT', body)
	worksheet106.write('P5', 'IND', body)
	worksheet106.write('Q5', 'ENG', body)
	worksheet106.write('R5', 'SEJ', body)
	worksheet106.write('S5', 'GEO', body)
	worksheet106.write('T5', 'SOS', body)
	worksheet106.write('U5', 'EKO', body)
	worksheet106.write('V5', 'JML', body)



	worksheet106.conditional_format(5,0,row106_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet106.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF HEK-KRAMAT JATI', title)
	worksheet106.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet106.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet106.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet106.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet106.write('O22', 'MAT', body)
	...
	worksheet107.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MAMPANG', title)
	worksheet107.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet107.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet107.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet107.write('G5', 'MAT', body)
	worksheet107.write('H5', 'IND', body)
	worksheet107.write('I5', 'ENG', body)
	worksheet107.write('J5', 'SEJ', body)
	worksheet107.write('K5', 'GEO', body)
	worksheet107.write('L5', 'SOS', body)
	worksheet107.write('M5', 'EKO', body)
	worksheet107.write('N5', 'JML', body)
	worksheet107.write('O5', 'MAT', body)
	worksheet107.write('P5', 'IND', body)
	worksheet107.write('Q5', 'ENG', body)
	worksheet107.write('R5', 'SEJ', body)
	worksheet107.write('S5', 'GEO', body)
	worksheet107.write('T5', 'SOS', body)
	worksheet107.write('U5', 'EKO', body)
	worksheet107.write('V5', 'JML', body)



	worksheet107.conditional_format(5,0,row107_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet107.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MAMPANG', title)
	worksheet107.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet107.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet107.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet107.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet107.write('O22', 'MAT', body)
	...
	worksheet108.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PALMERAH', title)
	worksheet108.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet108.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet108.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet108.write('G5', 'MAT', body)
	worksheet108.write('H5', 'IND', body)
	worksheet108.write('I5', 'ENG', body)
	worksheet108.write('J5', 'SEJ', body)
	worksheet108.write('K5', 'GEO', body)
	worksheet108.write('L5', 'SOS', body)
	worksheet108.write('M5', 'EKO', body)
	worksheet108.write('N5', 'JML', body)
	worksheet108.write('O5', 'MAT', body)
	worksheet108.write('P5', 'IND', body)
	worksheet108.write('Q5', 'ENG', body)
	worksheet108.write('R5', 'SEJ', body)
	worksheet108.write('S5', 'GEO', body)
	worksheet108.write('T5', 'SOS', body)
	worksheet108.write('U5', 'EKO', body)
	worksheet108.write('V5', 'JML', body)



	worksheet108.conditional_format(5,0,row108_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet108.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PALMERAH', title)
	worksheet108.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet108.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet108.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet108.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet108.write('O22', 'MAT', body)
	...
	worksheet109.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PASAR MINGGU', title)
	worksheet109.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet109.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet109.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet109.write('G5', 'MAT', body)
	worksheet109.write('H5', 'IND', body)
	worksheet109.write('I5', 'ENG', body)
	worksheet109.write('J5', 'SEJ', body)
	worksheet109.write('K5', 'GEO', body)
	worksheet109.write('L5', 'SOS', body)
	worksheet109.write('M5', 'EKO', body)
	worksheet109.write('N5', 'JML', body)
	worksheet109.write('O5', 'MAT', body)
	worksheet109.write('P5', 'IND', body)
	worksheet109.write('Q5', 'ENG', body)
	worksheet109.write('R5', 'SEJ', body)
	worksheet109.write('S5', 'GEO', body)
	worksheet109.write('T5', 'SOS', body)
	worksheet109.write('U5', 'EKO', body)
	worksheet109.write('V5', 'JML', body)



	worksheet109.conditional_format(5,0,row109_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet109.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PASAR MINGGU', title)
	worksheet109.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet109.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet109.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet109.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet109.write('O22', 'MAT', body)
	...
	worksheet110.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BINTARO', title)
	worksheet110.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet110.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet110.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet110.write('G5', 'MAT', body)
	worksheet110.write('H5', 'IND', body)
	worksheet110.write('I5', 'ENG', body)
	worksheet110.write('J5', 'SEJ', body)
	worksheet110.write('K5', 'GEO', body)
	worksheet110.write('L5', 'SOS', body)
	worksheet110.write('M5', 'EKO', body)
	worksheet110.write('N5', 'JML', body)
	worksheet110.write('O5', 'MAT', body)
	worksheet110.write('P5', 'IND', body)
	worksheet110.write('Q5', 'ENG', body)
	worksheet110.write('R5', 'SEJ', body)
	worksheet110.write('S5', 'GEO', body)
	worksheet110.write('T5', 'SOS', body)
	worksheet110.write('U5', 'EKO', body)
	worksheet110.write('V5', 'JML', body)



	worksheet110.conditional_format(5,0,row110_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet110.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BINTARO', title)
	worksheet110.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet110.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet110.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet110.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet110.write('O22', 'MAT', body)
	...
	worksheet111.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF LAMPIRI', title)
	worksheet111.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet111.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet111.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet111.write('G5', 'MAT', body)
	worksheet111.write('H5', 'IND', body)
	worksheet111.write('I5', 'ENG', body)
	worksheet111.write('J5', 'SEJ', body)
	worksheet111.write('K5', 'GEO', body)
	worksheet111.write('L5', 'SOS', body)
	worksheet111.write('M5', 'EKO', body)
	worksheet111.write('N5', 'JML', body)
	worksheet111.write('O5', 'MAT', body)
	worksheet111.write('P5', 'IND', body)
	worksheet111.write('Q5', 'ENG', body)
	worksheet111.write('R5', 'SEJ', body)
	worksheet111.write('S5', 'GEO', body)
	worksheet111.write('T5', 'SOS', body)
	worksheet111.write('U5', 'EKO', body)
	worksheet111.write('V5', 'JML', body)



	worksheet111.conditional_format(5,0,row111_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet111.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF LAMPIRI', title)
	worksheet111.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet111.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet111.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet111.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet111.write('O22', 'MAT', body)
	...
	worksheet112.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PONDOK BAMBU', title)
	worksheet112.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet112.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet112.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet112.write('G5', 'MAT', body)
	worksheet112.write('H5', 'IND', body)
	worksheet112.write('I5', 'ENG', body)
	worksheet112.write('J5', 'SEJ', body)
	worksheet112.write('K5', 'GEO', body)
	worksheet112.write('L5', 'SOS', body)
	worksheet112.write('M5', 'EKO', body)
	worksheet112.write('N5', 'JML', body)
	worksheet112.write('O5', 'MAT', body)
	worksheet112.write('P5', 'IND', body)
	worksheet112.write('Q5', 'ENG', body)
	worksheet112.write('R5', 'SEJ', body)
	worksheet112.write('S5', 'GEO', body)
	worksheet112.write('T5', 'SOS', body)
	worksheet112.write('U5', 'EKO', body)
	worksheet112.write('V5', 'JML', body)



	worksheet112.conditional_format(5,0,row112_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet112.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PONDOK BAMBU', title)
	worksheet112.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet112.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet112.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet112.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet112.write('O22', 'MAT', body)
	...
	worksheet113.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RAWA BADAK', title)
	worksheet113.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet113.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet113.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet113.write('G5', 'MAT', body)
	worksheet113.write('H5', 'IND', body)
	worksheet113.write('I5', 'ENG', body)
	worksheet113.write('J5', 'SEJ', body)
	worksheet113.write('K5', 'GEO', body)
	worksheet113.write('L5', 'SOS', body)
	worksheet113.write('M5', 'EKO', body)
	worksheet113.write('N5', 'JML', body)
	worksheet113.write('O5', 'MAT', body)
	worksheet113.write('P5', 'IND', body)
	worksheet113.write('Q5', 'ENG', body)
	worksheet113.write('R5', 'SEJ', body)
	worksheet113.write('S5', 'GEO', body)
	worksheet113.write('T5', 'SOS', body)
	worksheet113.write('U5', 'EKO', body)
	worksheet113.write('V5', 'JML', body)



	worksheet113.conditional_format(5,0,row113_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet113.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RAWA BADAK', title)
	worksheet113.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet113.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet113.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet113.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet113.write('O22', 'MAT', body)
	...
	# worksheet114.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PASAR REBO', title)
	# worksheet114.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet114.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet114.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet114.write('G5', 'MAT', body)
	# worksheet114.write('H5', 'IND', body)
	# worksheet114.write('I5', 'ENG', body)
	# worksheet114.write('J5', 'SEJ', body)
	# worksheet114.write('K5', 'GEO', body)
	# worksheet114.write('L5', 'SOS', body)
	# worksheet114.write('M5', 'EKO', body)
	# worksheet114.write('N5', 'JML', body)
	# worksheet114.write('O5', 'MAT', body)
	# worksheet114.write('P5', 'IND', body)
	# worksheet114.write('Q5', 'ENG', body)
	# worksheet114.write('R5', 'SEJ', body)
	# worksheet114.write('S5', 'GEO', body)
	# worksheet114.write('T5', 'SOS', body)
	# worksheet114.write('U5', 'EKO', body)
	# worksheet114.write('V5', 'JML', body)
	...
	# worksheet114.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PASAR REBO', title)
	# worksheet114.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet114.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet115.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RAWAMANGUN', title)
	worksheet115.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet115.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet115.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet115.write('G5', 'MAT', body)
	worksheet115.write('H5', 'IND', body)
	worksheet115.write('I5', 'ENG', body)
	worksheet115.write('J5', 'SEJ', body)
	worksheet115.write('K5', 'GEO', body)
	worksheet115.write('L5', 'SOS', body)
	worksheet115.write('M5', 'EKO', body)
	worksheet115.write('N5', 'JML', body)
	worksheet115.write('O5', 'MAT', body)
	worksheet115.write('P5', 'IND', body)
	worksheet115.write('Q5', 'ENG', body)
	worksheet115.write('R5', 'SEJ', body)
	worksheet115.write('S5', 'GEO', body)
	worksheet115.write('T5', 'SOS', body)
	worksheet115.write('U5', 'EKO', body)
	worksheet115.write('V5', 'JML', body)



	worksheet115.conditional_format(5,0,row115_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet115.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RAWAMANGUN', title)
	worksheet115.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet115.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet115.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet115.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet115.write('O22', 'MAT', body)
	...
	worksheet116.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIRACAS', title)
	worksheet116.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet116.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet116.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet116.write('G5', 'MAT', body)
	worksheet116.write('H5', 'IND', body)
	worksheet116.write('I5', 'ENG', body)
	worksheet116.write('J5', 'SEJ', body)
	worksheet116.write('K5', 'GEO', body)
	worksheet116.write('L5', 'SOS', body)
	worksheet116.write('M5', 'EKO', body)
	worksheet116.write('N5', 'JML', body)
	worksheet116.write('O5', 'MAT', body)
	worksheet116.write('P5', 'IND', body)
	worksheet116.write('Q5', 'ENG', body)
	worksheet116.write('R5', 'SEJ', body)
	worksheet116.write('S5', 'GEO', body)
	worksheet116.write('T5', 'SOS', body)
	worksheet116.write('U5', 'EKO', body)
	worksheet116.write('V5', 'JML', body)

	worksheet116.conditional_format(5,0,row116_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet116.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIRACAS', title)
	worksheet116.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet116.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet116.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet116.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet116.write('O22', 'MAT', body)
	...
	worksheet117.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KAMPUNG MELAYU', title)
	worksheet117.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet117.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet117.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet117.write('G5', 'MAT', body)
	worksheet117.write('H5', 'IND', body)
	worksheet117.write('I5', 'ENG', body)
	worksheet117.write('J5', 'SEJ', body)
	worksheet117.write('K5', 'GEO', body)
	worksheet117.write('L5', 'SOS', body)
	worksheet117.write('M5', 'EKO', body)
	worksheet117.write('N5', 'JML', body)
	worksheet117.write('O5', 'MAT', body)
	worksheet117.write('P5', 'IND', body)
	worksheet117.write('Q5', 'ENG', body)
	worksheet117.write('R5', 'SEJ', body)
	worksheet117.write('S5', 'GEO', body)
	worksheet117.write('T5', 'SOS', body)
	worksheet117.write('U5', 'EKO', body)
	worksheet117.write('V5', 'JML', body)


	worksheet117.conditional_format(5,0,row117_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet117.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KAMPUNG MELAYU', title)
	worksheet117.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet117.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet117.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet117.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet117.write('O22', 'MAT', body)
	...
	worksheet118.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF AKSES UI', title)
	worksheet118.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet118.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet118.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet118.write('G5', 'MAT', body)
	worksheet118.write('H5', 'IND', body)
	worksheet118.write('I5', 'ENG', body)
	worksheet118.write('J5', 'SEJ', body)
	worksheet118.write('K5', 'GEO', body)
	worksheet118.write('L5', 'SOS', body)
	worksheet118.write('M5', 'EKO', body)
	worksheet118.write('N5', 'JML', body)
	worksheet118.write('O5', 'MAT', body)
	worksheet118.write('P5', 'IND', body)
	worksheet118.write('Q5', 'ENG', body)
	worksheet118.write('R5', 'SEJ', body)
	worksheet118.write('S5', 'GEO', body)
	worksheet118.write('T5', 'SOS', body)
	worksheet118.write('U5', 'EKO', body)
	worksheet118.write('V5', 'JML', body)



	worksheet118.conditional_format(5,0,row118_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet118.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF AKSES UI', title)
	worksheet118.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet118.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet118.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet118.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet118.write('O22', 'MAT', body)
	...
	worksheet119.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JATIMEKAR', title)
	worksheet119.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet119.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet119.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet119.write('G5', 'MAT', body)
	worksheet119.write('H5', 'IND', body)
	worksheet119.write('I5', 'ENG', body)
	worksheet119.write('J5', 'SEJ', body)
	worksheet119.write('K5', 'GEO', body)
	worksheet119.write('L5', 'SOS', body)
	worksheet119.write('M5', 'EKO', body)
	worksheet119.write('N5', 'JML', body)
	worksheet119.write('O5', 'MAT', body)
	worksheet119.write('P5', 'IND', body)
	worksheet119.write('Q5', 'ENG', body)
	worksheet119.write('R5', 'SEJ', body)
	worksheet119.write('S5', 'GEO', body)
	worksheet119.write('T5', 'SOS', body)
	worksheet119.write('U5', 'EKO', body)
	worksheet119.write('V5', 'JML', body)



	worksheet119.conditional_format(5,0,row119_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet119.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JATIMEKAR', title)
	worksheet119.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet119.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet119.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet119.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet119.write('O22', 'MAT', body)
	...
	worksheet120.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RAWALUMBU', title)
	worksheet120.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet120.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet120.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet120.write('G5', 'MAT', body)
	worksheet120.write('H5', 'IND', body)
	worksheet120.write('I5', 'ENG', body)
	worksheet120.write('J5', 'SEJ', body)
	worksheet120.write('K5', 'GEO', body)
	worksheet120.write('L5', 'SOS', body)
	worksheet120.write('M5', 'EKO', body)
	worksheet120.write('N5', 'JML', body)
	worksheet120.write('O5', 'MAT', body)
	worksheet120.write('P5', 'IND', body)
	worksheet120.write('Q5', 'ENG', body)
	worksheet120.write('R5', 'SEJ', body)
	worksheet120.write('S5', 'GEO', body)
	worksheet120.write('T5', 'SOS', body)
	worksheet120.write('U5', 'EKO', body)
	worksheet120.write('V5', 'JML', body)



	worksheet120.conditional_format(5,0,row120_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet120.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RAWALUMBU', title)
	worksheet120.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet120.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet120.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet120.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet120.write('O22', 'MAT', body)
	...
	worksheet121.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TAMAN HARAPAN BARU', title)
	worksheet121.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet121.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet121.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet121.write('G5', 'MAT', body)
	worksheet121.write('H5', 'IND', body)
	worksheet121.write('I5', 'ENG', body)
	worksheet121.write('J5', 'SEJ', body)
	worksheet121.write('K5', 'GEO', body)
	worksheet121.write('L5', 'SOS', body)
	worksheet121.write('M5', 'EKO', body)
	worksheet121.write('N5', 'JML', body)
	worksheet121.write('O5', 'MAT', body)
	worksheet121.write('P5', 'IND', body)
	worksheet121.write('Q5', 'ENG', body)
	worksheet121.write('R5', 'SEJ', body)
	worksheet121.write('S5', 'GEO', body)
	worksheet121.write('T5', 'SOS', body)
	worksheet121.write('U5', 'EKO', body)
	worksheet121.write('V5', 'JML', body)



	worksheet121.conditional_format(5,0,row121_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet121.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TAMAN HARAPAN BARU', title)
	worksheet121.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet121.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet121.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet121.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet121.write('O22', 'MAT', body)
	...
	worksheet122.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF VILA NUSA INDAH', title)
	worksheet122.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet122.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet122.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet122.write('G5', 'MAT', body)
	worksheet122.write('H5', 'IND', body)
	worksheet122.write('I5', 'ENG', body)
	worksheet122.write('J5', 'SEJ', body)
	worksheet122.write('K5', 'GEO', body)
	worksheet122.write('L5', 'SOS', body)
	worksheet122.write('M5', 'EKO', body)
	worksheet122.write('N5', 'JML', body)
	worksheet122.write('O5', 'MAT', body)
	worksheet122.write('P5', 'IND', body)
	worksheet122.write('Q5', 'ENG', body)
	worksheet122.write('R5', 'SEJ', body)
	worksheet122.write('S5', 'GEO', body)
	worksheet122.write('T5', 'SOS', body)
	worksheet122.write('U5', 'EKO', body)
	worksheet122.write('V5', 'JML', body)



	worksheet122.conditional_format(5,0,row122_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet122.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF VILA NUSA INDAH', title)
	worksheet122.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet122.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet122.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet122.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet122.write('O22', 'MAT', body)
	...
	worksheet123.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JATIWARNA', title)
	worksheet123.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet123.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet123.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet123.write('G5', 'MAT', body)
	worksheet123.write('H5', 'IND', body)
	worksheet123.write('I5', 'ENG', body)
	worksheet123.write('J5', 'SEJ', body)
	worksheet123.write('K5', 'GEO', body)
	worksheet123.write('L5', 'SOS', body)
	worksheet123.write('M5', 'EKO', body)
	worksheet123.write('N5', 'JML', body)
	worksheet123.write('O5', 'MAT', body)
	worksheet123.write('P5', 'IND', body)
	worksheet123.write('Q5', 'ENG', body)
	worksheet123.write('R5', 'SEJ', body)
	worksheet123.write('S5', 'GEO', body)
	worksheet123.write('T5', 'SOS', body)
	worksheet123.write('U5', 'EKO', body)
	worksheet123.write('V5', 'JML', body)



	worksheet123.conditional_format(5,0,row123_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet123.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JATIWARNA', title)
	worksheet123.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet123.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet123.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet123.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet123.write('O22', 'MAT', body)
	...
	worksheet124.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TAMBUN', title)
	worksheet124.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet124.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet124.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet124.write('G5', 'MAT', body)
	worksheet124.write('H5', 'IND', body)
	worksheet124.write('I5', 'ENG', body)
	worksheet124.write('J5', 'SEJ', body)
	worksheet124.write('K5', 'GEO', body)
	worksheet124.write('L5', 'SOS', body)
	worksheet124.write('M5', 'EKO', body)
	worksheet124.write('N5', 'JML', body)
	worksheet124.write('O5', 'MAT', body)
	worksheet124.write('P5', 'IND', body)
	worksheet124.write('Q5', 'ENG', body)
	worksheet124.write('R5', 'SEJ', body)
	worksheet124.write('S5', 'GEO', body)
	worksheet124.write('T5', 'SOS', body)
	worksheet124.write('U5', 'EKO', body)
	worksheet124.write('V5', 'JML', body)



	worksheet124.conditional_format(5,0,row124_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet124.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TAMBUN', title)
	worksheet124.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet124.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet124.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet124.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet124.write('O22', 'MAT', body)
	...
	worksheet125.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF DAAN MOGOT', title)
	worksheet125.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet125.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet125.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet125.write('G5', 'MAT', body)
	worksheet125.write('H5', 'IND', body)
	worksheet125.write('I5', 'ENG', body)
	worksheet125.write('J5', 'SEJ', body)
	worksheet125.write('K5', 'GEO', body)
	worksheet125.write('L5', 'SOS', body)
	worksheet125.write('M5', 'EKO', body)
	worksheet125.write('N5', 'JML', body)
	worksheet125.write('O5', 'MAT', body)
	worksheet125.write('P5', 'IND', body)
	worksheet125.write('Q5', 'ENG', body)
	worksheet125.write('R5', 'SEJ', body)
	worksheet125.write('S5', 'GEO', body)
	worksheet125.write('T5', 'SOS', body)
	worksheet125.write('U5', 'EKO', body)
	worksheet125.write('V5', 'JML', body)



	worksheet125.conditional_format(5,0,row125_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet125.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF DAAN MOGOT', title)
	worksheet125.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet125.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet125.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet125.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet125.write('O22', 'MAT', body)
	...
	worksheet126.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIBUBUR', title)
	worksheet126.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet126.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet126.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet126.write('G5', 'MAT', body)
	worksheet126.write('H5', 'IND', body)
	worksheet126.write('I5', 'ENG', body)
	worksheet126.write('J5', 'SEJ', body)
	worksheet126.write('K5', 'GEO', body)
	worksheet126.write('L5', 'SOS', body)
	worksheet126.write('M5', 'EKO', body)
	worksheet126.write('N5', 'JML', body)
	worksheet126.write('O5', 'MAT', body)
	worksheet126.write('P5', 'IND', body)
	worksheet126.write('Q5', 'ENG', body)
	worksheet126.write('R5', 'SEJ', body)
	worksheet126.write('S5', 'GEO', body)
	worksheet126.write('T5', 'SOS', body)
	worksheet126.write('U5', 'EKO', body)
	worksheet126.write('V5', 'JML', body)



	worksheet126.conditional_format(5,0,row126_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet126.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIBUBUR', title)
	worksheet126.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet126.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet126.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet126.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet126.write('O22', 'MAT', body)
	...
	worksheet127.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CENGKARENG', title)
	worksheet127.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet127.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet127.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet127.write('G5', 'MAT', body)
	worksheet127.write('H5', 'IND', body)
	worksheet127.write('I5', 'ENG', body)
	worksheet127.write('J5', 'SEJ', body)
	worksheet127.write('K5', 'GEO', body)
	worksheet127.write('L5', 'SOS', body)
	worksheet127.write('M5', 'EKO', body)
	worksheet127.write('N5', 'JML', body)
	worksheet127.write('O5', 'MAT', body)
	worksheet127.write('P5', 'IND', body)
	worksheet127.write('Q5', 'ENG', body)
	worksheet127.write('R5', 'SEJ', body)
	worksheet127.write('S5', 'GEO', body)
	worksheet127.write('T5', 'SOS', body)
	worksheet127.write('U5', 'EKO', body)
	worksheet127.write('V5', 'JML', body)



	worksheet127.conditional_format(5,0,row127_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet127.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CENGKARENG', title)
	worksheet127.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet127.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet127.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet127.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet127.write('O22', 'MAT', body)
	...
	worksheet128.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PETUKANGAN', title)
	worksheet128.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet128.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet128.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet128.write('G5', 'MAT', body)
	worksheet128.write('H5', 'IND', body)
	worksheet128.write('I5', 'ENG', body)
	worksheet128.write('J5', 'SEJ', body)
	worksheet128.write('K5', 'GEO', body)
	worksheet128.write('L5', 'SOS', body)
	worksheet128.write('M5', 'EKO', body)
	worksheet128.write('N5', 'JML', body)
	worksheet128.write('O5', 'MAT', body)
	worksheet128.write('P5', 'IND', body)
	worksheet128.write('Q5', 'ENG', body)
	worksheet128.write('R5', 'SEJ', body)
	worksheet128.write('S5', 'GEO', body)
	worksheet128.write('T5', 'SOS', body)
	worksheet128.write('U5', 'EKO', body)
	worksheet128.write('V5', 'JML', body)



	worksheet128.conditional_format(5,0,row128_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet128.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PETUKANGAN', title)
	worksheet128.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet128.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet128.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet128.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet128.write('O22', 'MAT', body)
	...
	worksheet129.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MERUYA UTARA', title)
	worksheet129.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet129.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet129.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet129.write('G5', 'MAT', body)
	worksheet129.write('H5', 'IND', body)
	worksheet129.write('I5', 'ENG', body)
	worksheet129.write('J5', 'SEJ', body)
	worksheet129.write('K5', 'GEO', body)
	worksheet129.write('L5', 'SOS', body)
	worksheet129.write('M5', 'EKO', body)
	worksheet129.write('N5', 'JML', body)
	worksheet129.write('O5', 'MAT', body)
	worksheet129.write('P5', 'IND', body)
	worksheet129.write('Q5', 'ENG', body)
	worksheet129.write('R5', 'SEJ', body)
	worksheet129.write('S5', 'GEO', body)
	worksheet129.write('T5', 'SOS', body)
	worksheet129.write('U5', 'EKO', body)
	worksheet129.write('V5', 'JML', body)



	worksheet129.conditional_format(5,0,row129_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet129.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MERUYA UTARA', title)
	worksheet129.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet129.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet129.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet129.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet129.write('O22', 'MAT', body)
	...
	worksheet130.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BINTARA', title)
	worksheet130.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet130.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet130.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet130.write('G5', 'MAT', body)
	worksheet130.write('H5', 'IND', body)
	worksheet130.write('I5', 'ENG', body)
	worksheet130.write('J5', 'SEJ', body)
	worksheet130.write('K5', 'GEO', body)
	worksheet130.write('L5', 'SOS', body)
	worksheet130.write('M5', 'EKO', body)
	worksheet130.write('N5', 'JML', body)
	worksheet130.write('O5', 'MAT', body)
	worksheet130.write('P5', 'IND', body)
	worksheet130.write('Q5', 'ENG', body)
	worksheet130.write('R5', 'SEJ', body)
	worksheet130.write('S5', 'GEO', body)
	worksheet130.write('T5', 'SOS', body)
	worksheet130.write('U5', 'EKO', body)
	worksheet130.write('V5', 'JML', body)



	worksheet130.conditional_format(5,0,row130_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet130.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BINTARA', title)
	worksheet130.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet130.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet130.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet130.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet130.write('O22', 'MAT', body)
	...
	worksheet131.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MALANG', title)
	worksheet131.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet131.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet131.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet131.write('G5', 'MAT', body)
	worksheet131.write('H5', 'IND', body)
	worksheet131.write('I5', 'ENG', body)
	worksheet131.write('J5', 'SEJ', body)
	worksheet131.write('K5', 'GEO', body)
	worksheet131.write('L5', 'SOS', body)
	worksheet131.write('M5', 'EKO', body)
	worksheet131.write('N5', 'JML', body)
	worksheet131.write('O5', 'MAT', body)
	worksheet131.write('P5', 'IND', body)
	worksheet131.write('Q5', 'ENG', body)
	worksheet131.write('R5', 'SEJ', body)
	worksheet131.write('S5', 'GEO', body)
	worksheet131.write('T5', 'SOS', body)
	worksheet131.write('U5', 'EKO', body)
	worksheet131.write('V5', 'JML', body)



	worksheet131.conditional_format(5,0,row131_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet131.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MALANG', title)
	worksheet131.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet131.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet131.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet131.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet131.write('O22', 'MAT', body)
	...
	worksheet132.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MEDAN BARU', title)
	worksheet132.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet132.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet132.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet132.write('G5', 'MAT', body)
	worksheet132.write('H5', 'IND', body)
	worksheet132.write('I5', 'ENG', body)
	worksheet132.write('J5', 'SEJ', body)
	worksheet132.write('K5', 'GEO', body)
	worksheet132.write('L5', 'SOS', body)
	worksheet132.write('M5', 'EKO', body)
	worksheet132.write('N5', 'JML', body)
	worksheet132.write('O5', 'MAT', body)
	worksheet132.write('P5', 'IND', body)
	worksheet132.write('Q5', 'ENG', body)
	worksheet132.write('R5', 'SEJ', body)
	worksheet132.write('S5', 'GEO', body)
	worksheet132.write('T5', 'SOS', body)
	worksheet132.write('U5', 'EKO', body)
	worksheet132.write('V5', 'JML', body)



	worksheet132.conditional_format(5,0,row132_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet132.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MEDAN BARU', title)
	worksheet132.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet132.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet132.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet132.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet132.write('O22', 'MAT', body)
	...
	worksheet133.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MEDAN HELVETIA', title)
	worksheet133.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet133.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet133.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet133.write('G5', 'MAT', body)
	worksheet133.write('H5', 'IND', body)
	worksheet133.write('I5', 'ENG', body)
	worksheet133.write('J5', 'SEJ', body)
	worksheet133.write('K5', 'GEO', body)
	worksheet133.write('L5', 'SOS', body)
	worksheet133.write('M5', 'EKO', body)
	worksheet133.write('N5', 'JML', body)
	worksheet133.write('O5', 'MAT', body)
	worksheet133.write('P5', 'IND', body)
	worksheet133.write('Q5', 'ENG', body)
	worksheet133.write('R5', 'SEJ', body)
	worksheet133.write('S5', 'GEO', body)
	worksheet133.write('T5', 'SOS', body)
	worksheet133.write('U5', 'EKO', body)
	worksheet133.write('V5', 'JML', body)



	worksheet133.conditional_format(5,0,row133_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet133.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MEDAN HELVETIA', title)
	worksheet133.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet133.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet133.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet133.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet133.write('O22', 'MAT', body)
	...
	worksheet134.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIHANJUANG', title)
	worksheet134.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet134.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet134.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet134.write('G5', 'MAT', body)
	worksheet134.write('H5', 'IND', body)
	worksheet134.write('I5', 'ENG', body)
	worksheet134.write('J5', 'SEJ', body)
	worksheet134.write('K5', 'GEO', body)
	worksheet134.write('L5', 'SOS', body)
	worksheet134.write('M5', 'EKO', body)
	worksheet134.write('N5', 'JML', body)
	worksheet134.write('O5', 'MAT', body)
	worksheet134.write('P5', 'IND', body)
	worksheet134.write('Q5', 'ENG', body)
	worksheet134.write('R5', 'SEJ', body)
	worksheet134.write('S5', 'GEO', body)
	worksheet134.write('T5', 'SOS', body)
	worksheet134.write('U5', 'EKO', body)
	worksheet134.write('V5', 'JML', body)



	worksheet134.conditional_format(5,0,row134_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet134.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIHANJUANG', title)
	worksheet134.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet134.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet134.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet134.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet134.write('O22', 'MAT', body)
	...
	worksheet135.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BUAH BATU', title)
	worksheet135.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet135.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet135.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet135.write('G5', 'MAT', body)
	worksheet135.write('H5', 'IND', body)
	worksheet135.write('I5', 'ENG', body)
	worksheet135.write('J5', 'SEJ', body)
	worksheet135.write('K5', 'GEO', body)
	worksheet135.write('L5', 'SOS', body)
	worksheet135.write('M5', 'EKO', body)
	worksheet135.write('N5', 'JML', body)
	worksheet135.write('O5', 'MAT', body)
	worksheet135.write('P5', 'IND', body)
	worksheet135.write('Q5', 'ENG', body)
	worksheet135.write('R5', 'SEJ', body)
	worksheet135.write('S5', 'GEO', body)
	worksheet135.write('T5', 'SOS', body)
	worksheet135.write('U5', 'EKO', body)
	worksheet135.write('V5', 'JML', body)



	worksheet135.conditional_format(5,0,row135_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet135.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BUAH BATU', title)
	worksheet135.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet135.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet135.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet135.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet135.write('O22', 'MAT', body)
	...
	worksheet136.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUMBAWA', title)
	worksheet136.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet136.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet136.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet136.write('G5', 'MAT', body)
	worksheet136.write('H5', 'IND', body)
	worksheet136.write('I5', 'ENG', body)
	worksheet136.write('J5', 'SEJ', body)
	worksheet136.write('K5', 'GEO', body)
	worksheet136.write('L5', 'SOS', body)
	worksheet136.write('M5', 'EKO', body)
	worksheet136.write('N5', 'JML', body)
	worksheet136.write('O5', 'MAT', body)
	worksheet136.write('P5', 'IND', body)
	worksheet136.write('Q5', 'ENG', body)
	worksheet136.write('R5', 'SEJ', body)
	worksheet136.write('S5', 'GEO', body)
	worksheet136.write('T5', 'SOS', body)
	worksheet136.write('U5', 'EKO', body)
	worksheet136.write('V5', 'JML', body)



	worksheet136.conditional_format(5,0,row136_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet136.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUMBAWA', title)
	worksheet136.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet136.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet136.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet136.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet136.write('O22', 'MAT', body)
	...
	worksheet137.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF UJUNG BERUNG', title)
	worksheet137.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet137.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet137.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet137.write('G5', 'MAT', body)
	worksheet137.write('H5', 'IND', body)
	worksheet137.write('I5', 'ENG', body)
	worksheet137.write('J5', 'SEJ', body)
	worksheet137.write('K5', 'GEO', body)
	worksheet137.write('L5', 'SOS', body)
	worksheet137.write('M5', 'EKO', body)
	worksheet137.write('N5', 'JML', body)
	worksheet137.write('O5', 'MAT', body)
	worksheet137.write('P5', 'IND', body)
	worksheet137.write('Q5', 'ENG', body)
	worksheet137.write('R5', 'SEJ', body)
	worksheet137.write('S5', 'GEO', body)
	worksheet137.write('T5', 'SOS', body)
	worksheet137.write('U5', 'EKO', body)
	worksheet137.write('V5', 'JML', body)



	worksheet137.conditional_format(5,0,row137_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet137.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF UJUNG BERUNG', title)
	worksheet137.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet137.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet137.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet137.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet137.write('O22', 'MAT', body)
	...
	worksheet138.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SANGKURIANG', title)
	worksheet138.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet138.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet138.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet138.write('G5', 'MAT', body)
	worksheet138.write('H5', 'IND', body)
	worksheet138.write('I5', 'ENG', body)
	worksheet138.write('J5', 'SEJ', body)
	worksheet138.write('K5', 'GEO', body)
	worksheet138.write('L5', 'SOS', body)
	worksheet138.write('M5', 'EKO', body)
	worksheet138.write('N5', 'JML', body)
	worksheet138.write('O5', 'MAT', body)
	worksheet138.write('P5', 'IND', body)
	worksheet138.write('Q5', 'ENG', body)
	worksheet138.write('R5', 'SEJ', body)
	worksheet138.write('S5', 'GEO', body)
	worksheet138.write('T5', 'SOS', body)
	worksheet138.write('U5', 'EKO', body)
	worksheet138.write('V5', 'JML', body)



	worksheet138.conditional_format(5,0,row138_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet138.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SANGKURIANG', title)
	worksheet138.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet138.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet138.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet138.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet138.write('O22', 'MAT', body)
	...
	# worksheet139.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SARIJADI', title)
	# worksheet139.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet139.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet139.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet139.write('G5', 'MAT', body)
	# worksheet139.write('H5', 'IND', body)
	# worksheet139.write('I5', 'ENG', body)
	# worksheet139.write('J5', 'SEJ', body)
	# worksheet139.write('K5', 'GEO', body)
	# worksheet139.write('L5', 'SOS', body)
	# worksheet139.write('M5', 'EKO', body)
	# worksheet139.write('N5', 'JML', body)
	# worksheet139.write('O5', 'MAT', body)
	# worksheet139.write('P5', 'IND', body)
	# worksheet139.write('Q5', 'ENG', body)
	# worksheet139.write('R5', 'SEJ', body)
	# worksheet139.write('S5', 'GEO', body)
	# worksheet139.write('T5', 'SOS', body)
	# worksheet139.write('U5', 'EKO', body)
	# worksheet139.write('V5', 'JML', body)
	...
	# worksheet139.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SARIJADI', title)
	# worksheet139.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet139.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet140.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KARAWACI', title)
	worksheet140.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet140.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet140.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet140.write('G5', 'MAT', body)
	worksheet140.write('H5', 'IND', body)
	worksheet140.write('I5', 'ENG', body)
	worksheet140.write('J5', 'SEJ', body)
	worksheet140.write('K5', 'GEO', body)
	worksheet140.write('L5', 'SOS', body)
	worksheet140.write('M5', 'EKO', body)
	worksheet140.write('N5', 'JML', body)
	worksheet140.write('O5', 'MAT', body)
	worksheet140.write('P5', 'IND', body)
	worksheet140.write('Q5', 'ENG', body)
	worksheet140.write('R5', 'SEJ', body)
	worksheet140.write('S5', 'GEO', body)
	worksheet140.write('T5', 'SOS', body)
	worksheet140.write('U5', 'EKO', body)
	worksheet140.write('V5', 'JML', body)



	worksheet140.conditional_format(5,0,row140_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet140.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KARAWACI', title)
	worksheet140.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet140.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet140.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet140.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet140.write('O22', 'MAT', body)
	...
	worksheet141.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF VETERAN TANGERANG', title)
	worksheet141.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet141.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet141.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet141.write('G5', 'MAT', body)
	worksheet141.write('H5', 'IND', body)
	worksheet141.write('I5', 'ENG', body)
	worksheet141.write('J5', 'SEJ', body)
	worksheet141.write('K5', 'GEO', body)
	worksheet141.write('L5', 'SOS', body)
	worksheet141.write('M5', 'EKO', body)
	worksheet141.write('N5', 'JML', body)
	worksheet141.write('O5', 'MAT', body)
	worksheet141.write('P5', 'IND', body)
	worksheet141.write('Q5', 'ENG', body)
	worksheet141.write('R5', 'SEJ', body)
	worksheet141.write('S5', 'GEO', body)
	worksheet141.write('T5', 'SOS', body)
	worksheet141.write('U5', 'EKO', body)
	worksheet141.write('V5', 'JML', body)



	worksheet141.conditional_format(5,0,row141_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet141.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF VETERAN TANGERANG', title)
	worksheet141.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet141.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet141.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet141.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet141.write('O22', 'MAT', body)
	...
	worksheet142.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PERUMNAS 2 TANGERANG', title)
	worksheet142.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet142.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet142.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet142.write('G5', 'MAT', body)
	worksheet142.write('H5', 'IND', body)
	worksheet142.write('I5', 'ENG', body)
	worksheet142.write('J5', 'SEJ', body)
	worksheet142.write('K5', 'GEO', body)
	worksheet142.write('L5', 'SOS', body)
	worksheet142.write('M5', 'EKO', body)
	worksheet142.write('N5', 'JML', body)
	worksheet142.write('O5', 'MAT', body)
	worksheet142.write('P5', 'IND', body)
	worksheet142.write('Q5', 'ENG', body)
	worksheet142.write('R5', 'SEJ', body)
	worksheet142.write('S5', 'GEO', body)
	worksheet142.write('T5', 'SOS', body)
	worksheet142.write('U5', 'EKO', body)
	worksheet142.write('V5', 'JML', body)



	worksheet142.conditional_format(5,0,row142_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet142.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PERUMNAS 2 TANGERANG', title)
	worksheet142.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet142.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet142.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet142.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet142.write('O22', 'MAT', body)
	...
	worksheet143.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KAYURINGIN', title)
	worksheet143.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet143.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet143.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet143.write('G5', 'MAT', body)
	worksheet143.write('H5', 'IND', body)
	worksheet143.write('I5', 'ENG', body)
	worksheet143.write('J5', 'SEJ', body)
	worksheet143.write('K5', 'GEO', body)
	worksheet143.write('L5', 'SOS', body)
	worksheet143.write('M5', 'EKO', body)
	worksheet143.write('N5', 'JML', body)
	worksheet143.write('O5', 'MAT', body)
	worksheet143.write('P5', 'IND', body)
	worksheet143.write('Q5', 'ENG', body)
	worksheet143.write('R5', 'SEJ', body)
	worksheet143.write('S5', 'GEO', body)
	worksheet143.write('T5', 'SOS', body)
	worksheet143.write('U5', 'EKO', body)
	worksheet143.write('V5', 'JML', body)



	worksheet143.conditional_format(5,0,row143_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet143.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KAYURINGIN', title)
	worksheet143.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet143.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet143.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet143.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet143.write('O22', 'MAT', body)
	...
	worksheet144.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF AGUS SALIM', title)
	worksheet144.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet144.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet144.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet144.write('G5', 'MAT', body)
	worksheet144.write('H5', 'IND', body)
	worksheet144.write('I5', 'ENG', body)
	worksheet144.write('J5', 'SEJ', body)
	worksheet144.write('K5', 'GEO', body)
	worksheet144.write('L5', 'SOS', body)
	worksheet144.write('M5', 'EKO', body)
	worksheet144.write('N5', 'JML', body)
	worksheet144.write('O5', 'MAT', body)
	worksheet144.write('P5', 'IND', body)
	worksheet144.write('Q5', 'ENG', body)
	worksheet144.write('R5', 'SEJ', body)
	worksheet144.write('S5', 'GEO', body)
	worksheet144.write('T5', 'SOS', body)
	worksheet144.write('U5', 'EKO', body)
	worksheet144.write('V5', 'JML', body)



	worksheet144.conditional_format(5,0,row144_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet144.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF AGUS SALIM', title)
	worksheet144.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet144.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet144.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet144.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet144.write('O22', 'MAT', body)
	...
	worksheet145.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUMERU', title)
	worksheet145.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet145.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet145.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet145.write('G5', 'MAT', body)
	worksheet145.write('H5', 'IND', body)
	worksheet145.write('I5', 'ENG', body)
	worksheet145.write('J5', 'SEJ', body)
	worksheet145.write('K5', 'GEO', body)
	worksheet145.write('L5', 'SOS', body)
	worksheet145.write('M5', 'EKO', body)
	worksheet145.write('N5', 'JML', body)
	worksheet145.write('O5', 'MAT', body)
	worksheet145.write('P5', 'IND', body)
	worksheet145.write('Q5', 'ENG', body)
	worksheet145.write('R5', 'SEJ', body)
	worksheet145.write('S5', 'GEO', body)
	worksheet145.write('T5', 'SOS', body)
	worksheet145.write('U5', 'EKO', body)
	worksheet145.write('V5', 'JML', body)



	worksheet145.conditional_format(5,0,row145_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet145.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUMERU', title)
	worksheet145.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet145.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet145.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet145.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet145.write('O22', 'MAT', body)
	...
	worksheet146.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIKEAS', title)
	worksheet146.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet146.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet146.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet146.write('G5', 'MAT', body)
	worksheet146.write('H5', 'IND', body)
	worksheet146.write('I5', 'ENG', body)
	worksheet146.write('J5', 'SEJ', body)
	worksheet146.write('K5', 'GEO', body)
	worksheet146.write('L5', 'SOS', body)
	worksheet146.write('M5', 'EKO', body)
	worksheet146.write('N5', 'JML', body)
	worksheet146.write('O5', 'MAT', body)
	worksheet146.write('P5', 'IND', body)
	worksheet146.write('Q5', 'ENG', body)
	worksheet146.write('R5', 'SEJ', body)
	worksheet146.write('S5', 'GEO', body)
	worksheet146.write('T5', 'SOS', body)
	worksheet146.write('U5', 'EKO', body)
	worksheet146.write('V5', 'JML', body)



	worksheet146.conditional_format(5,0,row146_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet146.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIKEAS', title)
	worksheet146.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet146.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet146.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet146.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet146.write('O22', 'MAT', body)
	...
	worksheet148.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIJAWA MASJID', title)
	worksheet148.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet148.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet148.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet148.write('G5', 'MAT', body)
	worksheet148.write('H5', 'IND', body)
	worksheet148.write('I5', 'ENG', body)
	worksheet148.write('J5', 'SEJ', body)
	worksheet148.write('K5', 'GEO', body)
	worksheet148.write('L5', 'SOS', body)
	worksheet148.write('M5', 'EKO', body)
	worksheet148.write('N5', 'JML', body)
	worksheet148.write('O5', 'MAT', body)
	worksheet148.write('P5', 'IND', body)
	worksheet148.write('Q5', 'ENG', body)
	worksheet148.write('R5', 'SEJ', body)
	worksheet148.write('S5', 'GEO', body)
	worksheet148.write('T5', 'SOS', body)
	worksheet148.write('U5', 'EKO', body)
	worksheet148.write('V5', 'JML', body)



	worksheet148.conditional_format(5,0,row148_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet148.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIJAWA MASJID', title)
	worksheet148.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet148.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet148.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet148.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet148.write('O22', 'MAT', body)
	...
	worksheet149.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PALEDANG', title)
	worksheet149.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet149.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet149.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet149.write('G5', 'MAT', body)
	worksheet149.write('H5', 'IND', body)
	worksheet149.write('I5', 'ENG', body)
	worksheet149.write('J5', 'SEJ', body)
	worksheet149.write('K5', 'GEO', body)
	worksheet149.write('L5', 'SOS', body)
	worksheet149.write('M5', 'EKO', body)
	worksheet149.write('N5', 'JML', body)
	worksheet149.write('O5', 'MAT', body)
	worksheet149.write('P5', 'IND', body)
	worksheet149.write('Q5', 'ENG', body)
	worksheet149.write('R5', 'SEJ', body)
	worksheet149.write('S5', 'GEO', body)
	worksheet149.write('T5', 'SOS', body)
	worksheet149.write('U5', 'EKO', body)
	worksheet149.write('V5', 'JML', body)



	worksheet149.conditional_format(5,0,row149_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet149.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PALEDANG', title)
	worksheet149.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet149.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet149.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet149.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet149.write('O22', 'MAT', body)
	...
	worksheet150.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GEDONG KUNING', title)
	worksheet150.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet150.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet150.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet150.write('G5', 'MAT', body)
	worksheet150.write('H5', 'IND', body)
	worksheet150.write('I5', 'ENG', body)
	worksheet150.write('J5', 'SEJ', body)
	worksheet150.write('K5', 'GEO', body)
	worksheet150.write('L5', 'SOS', body)
	worksheet150.write('M5', 'EKO', body)
	worksheet150.write('N5', 'JML', body)
	worksheet150.write('O5', 'MAT', body)
	worksheet150.write('P5', 'IND', body)
	worksheet150.write('Q5', 'ENG', body)
	worksheet150.write('R5', 'SEJ', body)
	worksheet150.write('S5', 'GEO', body)
	worksheet150.write('T5', 'SOS', body)
	worksheet150.write('U5', 'EKO', body)
	worksheet150.write('V5', 'JML', body)



	worksheet150.conditional_format(5,0,row150_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet150.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GEDONG KUNING', title)
	worksheet150.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet150.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet150.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet150.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet150.write('O22', 'MAT', body)
	...
	worksheet151.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JATIWARINGIN', title)
	worksheet151.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet151.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet151.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet151.write('G5', 'MAT', body)
	worksheet151.write('H5', 'IND', body)
	worksheet151.write('I5', 'ENG', body)
	worksheet151.write('J5', 'SEJ', body)
	worksheet151.write('K5', 'GEO', body)
	worksheet151.write('L5', 'SOS', body)
	worksheet151.write('M5', 'EKO', body)
	worksheet151.write('N5', 'JML', body)
	worksheet151.write('O5', 'MAT', body)
	worksheet151.write('P5', 'IND', body)
	worksheet151.write('Q5', 'ENG', body)
	worksheet151.write('R5', 'SEJ', body)
	worksheet151.write('S5', 'GEO', body)
	worksheet151.write('T5', 'SOS', body)
	worksheet151.write('U5', 'EKO', body)
	worksheet151.write('V5', 'JML', body)



	worksheet151.conditional_format(5,0,row151_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet151.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JATIWARINGIN', title)
	worksheet151.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet151.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet151.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet151.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet151.write('O22', 'MAT', body)
	...
	worksheet152.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CILEDUG', title)
	worksheet152.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet152.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet152.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet152.write('G5', 'MAT', body)
	worksheet152.write('H5', 'IND', body)
	worksheet152.write('I5', 'ENG', body)
	worksheet152.write('J5', 'SEJ', body)
	worksheet152.write('K5', 'GEO', body)
	worksheet152.write('L5', 'SOS', body)
	worksheet152.write('M5', 'EKO', body)
	worksheet152.write('N5', 'JML', body)
	worksheet152.write('O5', 'MAT', body)
	worksheet152.write('P5', 'IND', body)
	worksheet152.write('Q5', 'ENG', body)
	worksheet152.write('R5', 'SEJ', body)
	worksheet152.write('S5', 'GEO', body)
	worksheet152.write('T5', 'SOS', body)
	worksheet152.write('U5', 'EKO', body)
	worksheet152.write('V5', 'JML', body)



	worksheet152.conditional_format(5,0,row152_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet152.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CILEDUG', title)
	worksheet152.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet152.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet152.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet152.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet152.write('O22', 'MAT', body)
	...
	worksheet153.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KRANGGAN', title)
	worksheet153.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet153.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet153.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet153.write('G5', 'MAT', body)
	worksheet153.write('H5', 'IND', body)
	worksheet153.write('I5', 'ENG', body)
	worksheet153.write('J5', 'SEJ', body)
	worksheet153.write('K5', 'GEO', body)
	worksheet153.write('L5', 'SOS', body)
	worksheet153.write('M5', 'EKO', body)
	worksheet153.write('N5', 'JML', body)
	worksheet153.write('O5', 'MAT', body)
	worksheet153.write('P5', 'IND', body)
	worksheet153.write('Q5', 'ENG', body)
	worksheet153.write('R5', 'SEJ', body)
	worksheet153.write('S5', 'GEO', body)
	worksheet153.write('T5', 'SOS', body)
	worksheet153.write('U5', 'EKO', body)
	worksheet153.write('V5', 'JML', body)



	worksheet153.conditional_format(5,0,row153_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet153.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KRANGGAN', title)
	worksheet153.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet153.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet153.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet153.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet153.write('O22', 'MAT', body)
	...
	worksheet154.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MUSTIKA JAYA', title)
	worksheet154.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet154.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet154.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet154.write('G5', 'MAT', body)
	worksheet154.write('H5', 'IND', body)
	worksheet154.write('I5', 'ENG', body)
	worksheet154.write('J5', 'SEJ', body)
	worksheet154.write('K5', 'GEO', body)
	worksheet154.write('L5', 'SOS', body)
	worksheet154.write('M5', 'EKO', body)
	worksheet154.write('N5', 'JML', body)
	worksheet154.write('O5', 'MAT', body)
	worksheet154.write('P5', 'IND', body)
	worksheet154.write('Q5', 'ENG', body)
	worksheet154.write('R5', 'SEJ', body)
	worksheet154.write('S5', 'GEO', body)
	worksheet154.write('T5', 'SOS', body)
	worksheet154.write('U5', 'EKO', body)
	worksheet154.write('V5', 'JML', body)



	worksheet154.conditional_format(5,0,row154_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet154.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MUSTIKA JAYA', title)
	worksheet154.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet154.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet154.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet154.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet154.write('O22', 'MAT', body)
	...
	worksheet155.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF ALEXINDO', title)
	worksheet155.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet155.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet155.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet155.write('G5', 'MAT', body)
	worksheet155.write('H5', 'IND', body)
	worksheet155.write('I5', 'ENG', body)
	worksheet155.write('J5', 'SEJ', body)
	worksheet155.write('K5', 'GEO', body)
	worksheet155.write('L5', 'SOS', body)
	worksheet155.write('M5', 'EKO', body)
	worksheet155.write('N5', 'JML', body)
	worksheet155.write('O5', 'MAT', body)
	worksheet155.write('P5', 'IND', body)
	worksheet155.write('Q5', 'ENG', body)
	worksheet155.write('R5', 'SEJ', body)
	worksheet155.write('S5', 'GEO', body)
	worksheet155.write('T5', 'SOS', body)
	worksheet155.write('U5', 'EKO', body)
	worksheet155.write('V5', 'JML', body)



	worksheet155.conditional_format(5,0,row155_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet155.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF ALEXINDO', title)
	worksheet155.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet155.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet155.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet155.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet155.write('O22', 'MAT', body)
	...
	worksheet156.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIBITUNG', title)
	worksheet156.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet156.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet156.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet156.write('G5', 'MAT', body)
	worksheet156.write('H5', 'IND', body)
	worksheet156.write('I5', 'ENG', body)
	worksheet156.write('J5', 'SEJ', body)
	worksheet156.write('K5', 'GEO', body)
	worksheet156.write('L5', 'SOS', body)
	worksheet156.write('M5', 'EKO', body)
	worksheet156.write('N5', 'JML', body)
	worksheet156.write('O5', 'MAT', body)
	worksheet156.write('P5', 'IND', body)
	worksheet156.write('Q5', 'ENG', body)
	worksheet156.write('R5', 'SEJ', body)
	worksheet156.write('S5', 'GEO', body)
	worksheet156.write('T5', 'SOS', body)
	worksheet156.write('U5', 'EKO', body)
	worksheet156.write('V5', 'JML', body)



	worksheet156.conditional_format(5,0,row156_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet156.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIBITUNG', title)
	worksheet156.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet156.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet156.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet156.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet156.write('O22', 'MAT', body)
	...
	worksheet157.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KRAMAT JAYA', title)
	worksheet157.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet157.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet157.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet157.write('G5', 'MAT', body)
	worksheet157.write('H5', 'IND', body)
	worksheet157.write('I5', 'ENG', body)
	worksheet157.write('J5', 'SEJ', body)
	worksheet157.write('K5', 'GEO', body)
	worksheet157.write('L5', 'SOS', body)
	worksheet157.write('M5', 'EKO', body)
	worksheet157.write('N5', 'JML', body)
	worksheet157.write('O5', 'MAT', body)
	worksheet157.write('P5', 'IND', body)
	worksheet157.write('Q5', 'ENG', body)
	worksheet157.write('R5', 'SEJ', body)
	worksheet157.write('S5', 'GEO', body)
	worksheet157.write('T5', 'SOS', body)
	worksheet157.write('U5', 'EKO', body)
	worksheet157.write('V5', 'JML', body)



	worksheet157.conditional_format(5,0,row157_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet157.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KRAMAT JAYA', title)
	worksheet157.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet157.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet157.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet157.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet157.write('O22', 'MAT', body)
	...
	worksheet158.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PONDOK GEDE', title)
	worksheet158.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet158.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet158.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet158.write('G5', 'MAT', body)
	worksheet158.write('H5', 'IND', body)
	worksheet158.write('I5', 'ENG', body)
	worksheet158.write('J5', 'SEJ', body)
	worksheet158.write('K5', 'GEO', body)
	worksheet158.write('L5', 'SOS', body)
	worksheet158.write('M5', 'EKO', body)
	worksheet158.write('N5', 'JML', body)
	worksheet158.write('O5', 'MAT', body)
	worksheet158.write('P5', 'IND', body)
	worksheet158.write('Q5', 'ENG', body)
	worksheet158.write('R5', 'SEJ', body)
	worksheet158.write('S5', 'GEO', body)
	worksheet158.write('T5', 'SOS', body)
	worksheet158.write('U5', 'EKO', body)
	worksheet158.write('V5', 'JML', body)



	worksheet158.conditional_format(5,0,row158_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet158.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PONDOK GEDE', title)
	worksheet158.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet158.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet158.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet158.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet158.write('O22', 'MAT', body)
	...
	worksheet159.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GALAXY', title)
	worksheet159.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet159.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet159.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet159.write('G5', 'MAT', body)
	worksheet159.write('H5', 'IND', body)
	worksheet159.write('I5', 'ENG', body)
	worksheet159.write('J5', 'SEJ', body)
	worksheet159.write('K5', 'GEO', body)
	worksheet159.write('L5', 'SOS', body)
	worksheet159.write('M5', 'EKO', body)
	worksheet159.write('N5', 'JML', body)
	worksheet159.write('O5', 'MAT', body)
	worksheet159.write('P5', 'IND', body)
	worksheet159.write('Q5', 'ENG', body)
	worksheet159.write('R5', 'SEJ', body)
	worksheet159.write('S5', 'GEO', body)
	worksheet159.write('T5', 'SOS', body)
	worksheet159.write('U5', 'EKO', body)
	worksheet159.write('V5', 'JML', body)



	worksheet159.conditional_format(5,0,row159_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet159.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GALAXY', title)
	worksheet159.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet159.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet159.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet159.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet159.write('O22', 'MAT', body)
	...
	worksheet160.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIGANJUR', title)
	worksheet160.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet160.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet160.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet160.write('G5', 'MAT', body)
	worksheet160.write('H5', 'IND', body)
	worksheet160.write('I5', 'ENG', body)
	worksheet160.write('J5', 'SEJ', body)
	worksheet160.write('K5', 'GEO', body)
	worksheet160.write('L5', 'SOS', body)
	worksheet160.write('M5', 'EKO', body)
	worksheet160.write('N5', 'JML', body)
	worksheet160.write('O5', 'MAT', body)
	worksheet160.write('P5', 'IND', body)
	worksheet160.write('Q5', 'ENG', body)
	worksheet160.write('R5', 'SEJ', body)
	worksheet160.write('S5', 'GEO', body)
	worksheet160.write('T5', 'SOS', body)
	worksheet160.write('U5', 'EKO', body)
	worksheet160.write('V5', 'JML', body)



	worksheet160.conditional_format(5,0,row160_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet160.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIGANJUR', title)
	worksheet160.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet160.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet160.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet160.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet160.write('O22', 'MAT', body)
	...
	workbook.close()
	st.success("File telah disimpan di E:\ apk osman v.1.1\hasil untuk lokasi")



uploaded_file = st.file_uploader('Letakkan file excel NILAI STANDAR kelas 10 SMA IPS PAS SM1 [LOKASI 162-236]', type='xlsx')
...
if uploaded_file is not None:
	...
	sort162_10=sort162_10.drop(sort162_10[(sort162_10['RANK LOK.']>10)].index)
	# 163
	sort163_10=sort163.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort163_10['LOKASI']
	sort163_10=sort163_10.drop(sort163_10[(sort163_10['RANK LOK.']>10)].index)
	# 164
	sort164_10=sort164.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort164_10['LOKASI']
	sort164_10=sort164_10.drop(sort164_10[(sort164_10['RANK LOK.']>10)].index)
	# 165
	sort165_10=sort165.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort165_10['LOKASI']
	sort165_10=sort165_10.drop(sort165_10[(sort165_10['RANK LOK.']>10)].index)
	# # 166
	...
	# worksheet161.set_column('G:V', 5, center)
	# worksheet161.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BENHIL', title)
	# worksheet161.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet161.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet161.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet161.write('G5', 'MAT', body)
	# worksheet161.write('H5', 'IND', body)
	# worksheet161.write('I5', 'ENG', body)
	# worksheet161.write('J5', 'SEJ', body)
	# worksheet161.write('K5', 'GEO', body)
	# worksheet161.write('L5', 'SOS', body)
	# worksheet161.write('M5', 'EKO', body)
	# worksheet161.write('N5', 'JML', body)
	# worksheet161.write('O5', 'MAT', body)
	# worksheet161.write('P5', 'IND', body)
	# worksheet161.write('Q5', 'ENG', body)
	# worksheet161.write('R5', 'SEJ', body)
	# worksheet161.write('S5', 'GEO', body)
	# worksheet161.write('T5', 'SOS', body)
	# worksheet161.write('U5', 'EKO', body)
	# worksheet161.write('V5', 'JML', body)



	# worksheet161.conditional_format(5,0,row161_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet161.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BENHIL', title)
	# worksheet161.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet161.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet161.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet161.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet161.write('K22', 'GEO', body)
	# worksheet161.write('L22', 'SOS', body)
	# worksheet161.write('M22', 'EKO', body)
	# worksheet161.write('N22', 'JML', body)
	# worksheet161.write('O22', 'MAT', body)
	# worksheet161.write('P22', 'IND', body)
	# worksheet161.write('Q22', 'ENG', body)
	# worksheet161.write('R22', 'SEJ', body)
	# worksheet161.write('S22', 'GEO', body)
	# worksheet161.write('T22', 'SOS', body)
	# worksheet161.write('U22', 'EKO', body)
	# worksheet161.write('V22', 'JML', body)

	# worksheet161.conditional_format(22,0,row161+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet162.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PUNTI KAYU', title)
	worksheet162.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet162.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet162.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet162.write('G5', 'MAT', body)
	worksheet162.write('H5', 'IND', body)
	worksheet162.write('I5', 'ENG', body)
	worksheet162.write('J5', 'SEJ', body)
	worksheet162.write('K5', 'GEO', body)
	worksheet162.write('L5', 'SOS', body)
	worksheet162.write('M5', 'EKO', body)
	worksheet162.write('N5', 'JML', body)
	worksheet162.write('O5', 'MAT', body)
	worksheet162.write('P5', 'IND', body)
	worksheet162.write('Q5', 'ENG', body)
	worksheet162.write('R5', 'SEJ', body)
	worksheet162.write('S5', 'GEO', body)
	worksheet162.write('T5', 'SOS', body)
	worksheet162.write('U5', 'EKO', body)
	worksheet162.write('V5', 'JML', body)



	worksheet162.conditional_format(5,0,row162_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet162.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PUNTI KAYU', title)
	worksheet162.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet162.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet162.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet162.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet162.write('O22', 'MAT', body)
	...
	worksheet162.conditional_format(22,0,row162+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet163.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUKAMTO', title)
	worksheet163.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet163.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet163.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet163.write('G5', 'MAT', body)
	worksheet163.write('H5', 'IND', body)
	worksheet163.write('I5', 'ENG', body)
	worksheet163.write('J5', 'SEJ', body)
	worksheet163.write('K5', 'GEO', body)
	worksheet163.write('L5', 'SOS', body)
	worksheet163.write('M5', 'EKO', body)
	worksheet163.write('N5', 'JML', body)
	worksheet163.write('O5', 'MAT', body)
	worksheet163.write('P5', 'IND', body)
	worksheet163.write('Q5', 'ENG', body)
	worksheet163.write('R5', 'SEJ', body)
	worksheet163.write('S5', 'GEO', body)
	worksheet163.write('T5', 'SOS', body)
	worksheet163.write('U5', 'EKO', body)
	worksheet163.write('V5', 'JML', body)



	worksheet163.conditional_format(5,0,row163_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet163.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUKAMTO', title)
	worksheet163.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet163.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet163.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet163.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet163.write('O22', 'MAT', body)
	...
	worksheet164.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BUKIT BESAR', title)
	worksheet164.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet164.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet164.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet164.write('G5', 'MAT', body)
	worksheet164.write('H5', 'IND', body)
	worksheet164.write('I5', 'ENG', body)
	worksheet164.write('J5', 'SEJ', body)
	worksheet164.write('K5', 'GEO', body)
	worksheet164.write('L5', 'SOS', body)
	worksheet164.write('M5', 'EKO', body)
	worksheet164.write('N5', 'JML', body)
	worksheet164.write('O5', 'MAT', body)
	worksheet164.write('P5', 'IND', body)
	worksheet164.write('Q5', 'ENG', body)
	worksheet164.write('R5', 'SEJ', body)
	worksheet164.write('S5', 'GEO', body)
	worksheet164.write('T5', 'SOS', body)
	worksheet164.write('U5', 'EKO', body)
	worksheet164.write('V5', 'JML', body)



	worksheet164.conditional_format(5,0,row164_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet164.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BUKIT BESAR', title)
	worksheet164.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet164.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet164.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet164.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet164.write('O22', 'MAT', body)
	...
	worksheet165.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUDIRMAN', title)
	worksheet165.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet165.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet165.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet165.write('G5', 'MAT', body)
	worksheet165.write('H5', 'IND', body)
	worksheet165.write('I5', 'ENG', body)
	worksheet165.write('J5', 'SEJ', body)
	worksheet165.write('K5', 'GEO', body)
	worksheet165.write('L5', 'SOS', body)
	worksheet165.write('M5', 'EKO', body)
	worksheet165.write('N5', 'JML', body)
	worksheet165.write('O5', 'MAT', body)
	worksheet165.write('P5', 'IND', body)
	worksheet165.write('Q5', 'ENG', body)
	worksheet165.write('R5', 'SEJ', body)
	worksheet165.write('S5', 'GEO', body)
	worksheet165.write('T5', 'SOS', body)
	worksheet165.write('U5', 'EKO', body)
	worksheet165.write('V5', 'JML', body)



	worksheet165.conditional_format(5,0,row165_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet165.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUDIRMAN', title)
	worksheet165.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet165.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet165.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet165.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet165.write('O22', 'MAT', body)
	...
	# worksheet166.set_column('G:V', 5, center)
	# worksheet166.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIMANGGU', title)
	# worksheet166.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet166.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet166.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet166.write('G5', 'MAT', body)
	# worksheet166.write('H5', 'IND', body)
	# worksheet166.write('I5', 'ENG', body)
	# worksheet166.write('J5', 'SEJ', body)
	# worksheet166.write('K5', 'GEO', body)
	# worksheet166.write('L5', 'SOS', body)
	# worksheet166.write('M5', 'EKO', body)
	# worksheet166.write('N5', 'JML', body)
	# worksheet166.write('O5', 'MAT', body)
	# worksheet166.write('P5', 'IND', body)
	# worksheet166.write('Q5', 'ENG', body)
	# worksheet166.write('R5', 'SEJ', body)
	# worksheet166.write('S5', 'GEO', body)
	# worksheet166.write('T5', 'SOS', body)
	# worksheet166.write('U5', 'EKO', body)
	# worksheet166.write('V5', 'JML', body)



	# worksheet166.conditional_format(5,0,row166_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet166.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIMANGGU', title)
	# worksheet166.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet166.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet166.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet166.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet166.write('K22', 'GEO', body)
	# worksheet166.write('L22', 'SOS', body)
	# worksheet166.write('M22', 'EKO', body)
	# worksheet166.write('N22', 'JML', body)
	# worksheet166.write('O22', 'MAT', body)
	# worksheet166.write('P22', 'IND', body)
	# worksheet166.write('Q22', 'ENG', body)
	# worksheet166.write('R22', 'SEJ', body)
	# worksheet166.write('S22', 'GEO', body)
	# worksheet166.write('T22', 'SOS', body)
	# worksheet166.write('U22', 'EKO', body)
	# worksheet166.write('V22', 'JML', body)

	# worksheet166.conditional_format(22,0,row166+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet167.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CILANGKAP', title)
	worksheet167.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet167.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet167.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet167.write('G5', 'MAT', body)
	worksheet167.write('H5', 'IND', body)
	worksheet167.write('I5', 'ENG', body)
	worksheet167.write('J5', 'SEJ', body)
	worksheet167.write('K5', 'GEO', body)
	worksheet167.write('L5', 'SOS', body)
	worksheet167.write('M5', 'EKO', body)
	worksheet167.write('N5', 'JML', body)
	worksheet167.write('O5', 'MAT', body)
	worksheet167.write('P5', 'IND', body)
	worksheet167.write('Q5', 'ENG', body)
	worksheet167.write('R5', 'SEJ', body)
	worksheet167.write('S5', 'GEO', body)
	worksheet167.write('T5', 'SOS', body)
	worksheet167.write('U5', 'EKO', body)
	worksheet167.write('V5', 'JML', body)



	worksheet167.conditional_format(5,0,row167_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet167.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CILANGKAP', title)
	worksheet167.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet167.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet167.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet167.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet167.write('O22', 'MAT', body)
	...
	worksheet168.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF HALIM', title)
	worksheet168.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet168.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet168.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet168.write('G5', 'MAT', body)
	worksheet168.write('H5', 'IND', body)
	worksheet168.write('I5', 'ENG', body)
	worksheet168.write('J5', 'SEJ', body)
	worksheet168.write('K5', 'GEO', body)
	worksheet168.write('L5', 'SOS', body)
	worksheet168.write('M5', 'EKO', body)
	worksheet168.write('N5', 'JML', body)
	worksheet168.write('O5', 'MAT', body)
	worksheet168.write('P5', 'IND', body)
	worksheet168.write('Q5', 'ENG', body)
	worksheet168.write('R5', 'SEJ', body)
	worksheet168.write('S5', 'GEO', body)
	worksheet168.write('T5', 'SOS', body)
	worksheet168.write('U5', 'EKO', body)
	worksheet168.write('V5', 'JML', body)



	worksheet168.conditional_format(5,0,row168_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet168.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF HALIM', title)
	worksheet168.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet168.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet168.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet168.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet168.write('O22', 'MAT', body)
	...
	worksheet169.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TANAH MERDEKA', title)
	worksheet169.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet169.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet169.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet169.write('G5', 'MAT', body)
	worksheet169.write('H5', 'IND', body)
	worksheet169.write('I5', 'ENG', body)
	worksheet169.write('J5', 'SEJ', body)
	worksheet169.write('K5', 'GEO', body)
	worksheet169.write('L5', 'SOS', body)
	worksheet169.write('M5', 'EKO', body)
	worksheet169.write('N5', 'JML', body)
	worksheet169.write('O5', 'MAT', body)
	worksheet169.write('P5', 'IND', body)
	worksheet169.write('Q5', 'ENG', body)
	worksheet169.write('R5', 'SEJ', body)
	worksheet169.write('S5', 'GEO', body)
	worksheet169.write('T5', 'SOS', body)
	worksheet169.write('U5', 'EKO', body)
	worksheet169.write('V5', 'JML', body)



	worksheet169.conditional_format(5,0,row169_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet169.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TANAH MERDEKA', title)
	worksheet169.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet169.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet169.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet169.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet169.write('O22', 'MAT', body)
	...
	worksheet171.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIPUTAT', title)
	worksheet171.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet171.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet171.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet171.write('G5', 'MAT', body)
	worksheet171.write('H5', 'IND', body)
	worksheet171.write('I5', 'ENG', body)
	worksheet171.write('J5', 'SEJ', body)
	worksheet171.write('K5', 'GEO', body)
	worksheet171.write('L5', 'SOS', body)
	worksheet171.write('M5', 'EKO', body)
	worksheet171.write('N5', 'JML', body)
	worksheet171.write('O5', 'MAT', body)
	worksheet171.write('P5', 'IND', body)
	worksheet171.write('Q5', 'ENG', body)
	worksheet171.write('R5', 'SEJ', body)
	worksheet171.write('S5', 'GEO', body)
	worksheet171.write('T5', 'SOS', body)
	worksheet171.write('U5', 'EKO', body)
	worksheet171.write('V5', 'JML', body)



	worksheet171.conditional_format(5,0,row171_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet171.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIPUTAT', title)
	worksheet171.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet171.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet171.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet171.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet171.write('O22', 'MAT', body)
	...
	worksheet173.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SALEMBA', title)
	worksheet173.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet173.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet173.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet173.write('G5', 'MAT', body)
	worksheet173.write('H5', 'IND', body)
	worksheet173.write('I5', 'ENG', body)
	worksheet173.write('J5', 'SEJ', body)
	worksheet173.write('K5', 'GEO', body)
	worksheet173.write('L5', 'SOS', body)
	worksheet173.write('M5', 'EKO', body)
	worksheet173.write('N5', 'JML', body)
	worksheet173.write('O5', 'MAT', body)
	worksheet173.write('P5', 'IND', body)
	worksheet173.write('Q5', 'ENG', body)
	worksheet173.write('R5', 'SEJ', body)
	worksheet173.write('S5', 'GEO', body)
	worksheet173.write('T5', 'SOS', body)
	worksheet173.write('U5', 'EKO', body)
	worksheet173.write('V5', 'JML', body)



	worksheet173.conditional_format(5,0,row173_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet173.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SALEMBA', title)
	worksheet173.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet173.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet173.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet173.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet173.write('O22', 'MAT', body)
	...
	worksheet174.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIPINANG', title)
	worksheet174.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet174.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet174.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet174.write('G5', 'MAT', body)
	worksheet174.write('H5', 'IND', body)
	worksheet174.write('I5', 'ENG', body)
	worksheet174.write('J5', 'SEJ', body)
	worksheet174.write('K5', 'GEO', body)
	worksheet174.write('L5', 'SOS', body)
	worksheet174.write('M5', 'EKO', body)
	worksheet174.write('N5', 'JML', body)
	worksheet174.write('O5', 'MAT', body)
	worksheet174.write('P5', 'IND', body)
	worksheet174.write('Q5', 'ENG', body)
	worksheet174.write('R5', 'SEJ', body)
	worksheet174.write('S5', 'GEO', body)
	worksheet174.write('T5', 'SOS', body)
	worksheet174.write('U5', 'EKO', body)
	worksheet174.write('V5', 'JML', body)



	worksheet174.conditional_format(5,0,row174_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet174.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIPINANG', title)
	worksheet174.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet174.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet174.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet174.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet174.write('O22', 'MAT', body)
	...
	worksheet175.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KRAMAT ASEM', title)
	worksheet175.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet175.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet175.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet175.write('G5', 'MAT', body)
	worksheet175.write('H5', 'IND', body)
	worksheet175.write('I5', 'ENG', body)
	worksheet175.write('J5', 'SEJ', body)
	worksheet175.write('K5', 'GEO', body)
	worksheet175.write('L5', 'SOS', body)
	worksheet175.write('M5', 'EKO', body)
	worksheet175.write('N5', 'JML', body)
	worksheet175.write('O5', 'MAT', body)
	worksheet175.write('P5', 'IND', body)
	worksheet175.write('Q5', 'ENG', body)
	worksheet175.write('R5', 'SEJ', body)
	worksheet175.write('S5', 'GEO', body)
	worksheet175.write('T5', 'SOS', body)
	worksheet175.write('U5', 'EKO', body)
	worksheet175.write('V5', 'JML', body)



	worksheet175.conditional_format(5,0,row175_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet175.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KRAMAT ASEM', title)
	worksheet175.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet175.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet175.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet175.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet175.write('O22', 'MAT', body)
	...
	worksheet176.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PANGKALAN ASEM', title)
	worksheet176.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet176.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet176.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet176.write('G5', 'MAT', body)
	worksheet176.write('H5', 'IND', body)
	worksheet176.write('I5', 'ENG', body)
	worksheet176.write('J5', 'SEJ', body)
	worksheet176.write('K5', 'GEO', body)
	worksheet176.write('L5', 'SOS', body)
	worksheet176.write('M5', 'EKO', body)
	worksheet176.write('N5', 'JML', body)
	worksheet176.write('O5', 'MAT', body)
	worksheet176.write('P5', 'IND', body)
	worksheet176.write('Q5', 'ENG', body)
	worksheet176.write('R5', 'SEJ', body)
	worksheet176.write('S5', 'GEO', body)
	worksheet176.write('T5', 'SOS', body)
	worksheet176.write('U5', 'EKO', body)
	worksheet176.write('V5', 'JML', body)



	worksheet176.conditional_format(5,0,row176_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet176.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PANGKALAN ASEM', title)
	worksheet176.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet176.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet176.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet176.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet176.write('O22', 'MAT', body)
	...
	worksheet177.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PAMULANG 2', title)
	worksheet177.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet177.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet177.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet177.write('G5', 'MAT', body)
	worksheet177.write('H5', 'IND', body)
	worksheet177.write('I5', 'ENG', body)
	worksheet177.write('J5', 'SEJ', body)
	worksheet177.write('K5', 'GEO', body)
	worksheet177.write('L5', 'SOS', body)
	worksheet177.write('M5', 'EKO', body)
	worksheet177.write('N5', 'JML', body)
	worksheet177.write('O5', 'MAT', body)
	worksheet177.write('P5', 'IND', body)
	worksheet177.write('Q5', 'ENG', body)
	worksheet177.write('R5', 'SEJ', body)
	worksheet177.write('S5', 'GEO', body)
	worksheet177.write('T5', 'SOS', body)
	worksheet177.write('U5', 'EKO', body)
	worksheet177.write('V5', 'JML', body)



	worksheet177.conditional_format(5,0,row177_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet177.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PAMULANG 2', title)
	worksheet177.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet177.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet177.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet177.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet177.write('O22', 'MAT', body)
	...
	worksheet178.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PURI BETA LARANGAN', title)
	worksheet178.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet178.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet178.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet178.write('G5', 'MAT', body)
	worksheet178.write('H5', 'IND', body)
	worksheet178.write('I5', 'ENG', body)
	worksheet178.write('J5', 'SEJ', body)
	worksheet178.write('K5', 'GEO', body)
	worksheet178.write('L5', 'SOS', body)
	worksheet178.write('M5', 'EKO', body)
	worksheet178.write('N5', 'JML', body)
	worksheet178.write('O5', 'MAT', body)
	worksheet178.write('P5', 'IND', body)
	worksheet178.write('Q5', 'ENG', body)
	worksheet178.write('R5', 'SEJ', body)
	worksheet178.write('S5', 'GEO', body)
	worksheet178.write('T5', 'SOS', body)
	worksheet178.write('U5', 'EKO', body)
	worksheet178.write('V5', 'JML', body)



	worksheet178.conditional_format(5,0,row178_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet178.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PURI BETA LARANGAN', title)
	worksheet178.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet178.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet178.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet178.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet178.write('O22', 'MAT', body)
	...
	worksheet179.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CEGER', title)
	worksheet179.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet179.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet179.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet179.write('G5', 'MAT', body)
	worksheet179.write('H5', 'IND', body)
	worksheet179.write('I5', 'ENG', body)
	worksheet179.write('J5', 'SEJ', body)
	worksheet179.write('K5', 'GEO', body)
	worksheet179.write('L5', 'SOS', body)
	worksheet179.write('M5', 'EKO', body)
	worksheet179.write('N5', 'JML', body)
	worksheet179.write('O5', 'MAT', body)
	worksheet179.write('P5', 'IND', body)
	worksheet179.write('Q5', 'ENG', body)
	worksheet179.write('R5', 'SEJ', body)
	worksheet179.write('S5', 'GEO', body)
	worksheet179.write('T5', 'SOS', body)
	worksheet179.write('U5', 'EKO', body)
	worksheet179.write('V5', 'JML', body)



	worksheet179.conditional_format(5,0,row179_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet179.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CEGER', title)
	worksheet179.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet179.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet179.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet179.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet179.write('O22', 'MAT', body)
	...
	worksheet180.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SMA KOMPLEK', title)
	worksheet180.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet180.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet180.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet180.write('G5', 'MAT', body)
	worksheet180.write('H5', 'IND', body)
	worksheet180.write('I5', 'ENG', body)
	worksheet180.write('J5', 'SEJ', body)
	worksheet180.write('K5', 'GEO', body)
	worksheet180.write('L5', 'SOS', body)
	worksheet180.write('M5', 'EKO', body)
	worksheet180.write('N5', 'JML', body)
	worksheet180.write('O5', 'MAT', body)
	worksheet180.write('P5', 'IND', body)
	worksheet180.write('Q5', 'ENG', body)
	worksheet180.write('R5', 'SEJ', body)
	worksheet180.write('S5', 'GEO', body)
	worksheet180.write('T5', 'SOS', body)
	worksheet180.write('U5', 'EKO', body)
	worksheet180.write('V5', 'JML', body)



	worksheet180.conditional_format(5,0,row180_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet180.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SMA KOMPLEK', title)
	worksheet180.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet180.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet180.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet180.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet180.write('O22', 'MAT', body)
	...
	worksheet181.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GAYUNGSARI', title)
	worksheet181.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet181.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet181.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet181.write('G5', 'MAT', body)
	worksheet181.write('H5', 'IND', body)
	worksheet181.write('I5', 'ENG', body)
	worksheet181.write('J5', 'SEJ', body)
	worksheet181.write('K5', 'GEO', body)
	worksheet181.write('L5', 'SOS', body)
	worksheet181.write('M5', 'EKO', body)
	worksheet181.write('N5', 'JML', body)
	worksheet181.write('O5', 'MAT', body)
	worksheet181.write('P5', 'IND', body)
	worksheet181.write('Q5', 'ENG', body)
	worksheet181.write('R5', 'SEJ', body)
	worksheet181.write('S5', 'GEO', body)
	worksheet181.write('T5', 'SOS', body)
	worksheet181.write('U5', 'EKO', body)
	worksheet181.write('V5', 'JML', body)



	worksheet181.conditional_format(5,0,row181_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet181.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GAYUNGSARI', title)
	worksheet181.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet181.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet181.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet181.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet181.write('O22', 'MAT', body)
	...
	worksheet182.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TUPAREV', title)
	worksheet182.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet182.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet182.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet182.write('G5', 'MAT', body)
	worksheet182.write('H5', 'IND', body)
	worksheet182.write('I5', 'ENG', body)
	worksheet182.write('J5', 'SEJ', body)
	worksheet182.write('K5', 'GEO', body)
	worksheet182.write('L5', 'SOS', body)
	worksheet182.write('M5', 'EKO', body)
	worksheet182.write('N5', 'JML', body)
	worksheet182.write('O5', 'MAT', body)
	worksheet182.write('P5', 'IND', body)
	worksheet182.write('Q5', 'ENG', body)
	worksheet182.write('R5', 'SEJ', body)
	worksheet182.write('S5', 'GEO', body)
	worksheet182.write('T5', 'SOS', body)
	worksheet182.write('U5', 'EKO', body)
	worksheet182.write('V5', 'JML', body)



	worksheet182.conditional_format(5,0,row182_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet182.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TUPAREV', title)
	worksheet182.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet182.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet182.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet182.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet182.write('O22', 'MAT', body)
	...
	worksheet183.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PERUMNAS KLENDER', title)
	worksheet183.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet183.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet183.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet183.write('G5', 'MAT', body)
	worksheet183.write('H5', 'IND', body)
	worksheet183.write('I5', 'ENG', body)
	worksheet183.write('J5', 'SEJ', body)
	worksheet183.write('K5', 'GEO', body)
	worksheet183.write('L5', 'SOS', body)
	worksheet183.write('M5', 'EKO', body)
	worksheet183.write('N5', 'JML', body)
	worksheet183.write('O5', 'MAT', body)
	worksheet183.write('P5', 'IND', body)
	worksheet183.write('Q5', 'ENG', body)
	worksheet183.write('R5', 'SEJ', body)
	worksheet183.write('S5', 'GEO', body)
	worksheet183.write('T5', 'SOS', body)
	worksheet183.write('U5', 'EKO', body)
	worksheet183.write('V5', 'JML', body)



	worksheet183.conditional_format(5,0,row183_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet183.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PERUMNAS KLENDER', title)
	worksheet183.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet183.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet183.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet183.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet183.write('O22', 'MAT', body)
	...
	worksheet184.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KARANG AKHIR', title)
	worksheet184.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet184.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet184.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet184.write('G5', 'MAT', body)
	worksheet184.write('H5', 'IND', body)
	worksheet184.write('I5', 'ENG', body)
	worksheet184.write('J5', 'SEJ', body)
	worksheet184.write('K5', 'GEO', body)
	worksheet184.write('L5', 'SOS', body)
	worksheet184.write('M5', 'EKO', body)
	worksheet184.write('N5', 'JML', body)
	worksheet184.write('O5', 'MAT', body)
	worksheet184.write('P5', 'IND', body)
	worksheet184.write('Q5', 'ENG', body)
	worksheet184.write('R5', 'SEJ', body)
	worksheet184.write('S5', 'GEO', body)
	worksheet184.write('T5', 'SOS', body)
	worksheet184.write('U5', 'EKO', body)
	worksheet184.write('V5', 'JML', body)



	worksheet184.conditional_format(5,0,row184_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet184.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KARANG AKHIR', title)
	worksheet184.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet184.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet184.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet184.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet184.write('O22', 'MAT', body)
	...
	worksheet185.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SIMPANG TIGA', title)
	worksheet185.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet185.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet185.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet185.write('G5', 'MAT', body)
	worksheet185.write('H5', 'IND', body)
	worksheet185.write('I5', 'ENG', body)
	worksheet185.write('J5', 'SEJ', body)
	worksheet185.write('K5', 'GEO', body)
	worksheet185.write('L5', 'SOS', body)
	worksheet185.write('M5', 'EKO', body)
	worksheet185.write('N5', 'JML', body)
	worksheet185.write('O5', 'MAT', body)
	worksheet185.write('P5', 'IND', body)
	worksheet185.write('Q5', 'ENG', body)
	worksheet185.write('R5', 'SEJ', body)
	worksheet185.write('S5', 'GEO', body)
	worksheet185.write('T5', 'SOS', body)
	worksheet185.write('U5', 'EKO', body)
	worksheet185.write('V5', 'JML', body)



	worksheet185.conditional_format(5,0,row185_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet185.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SIMPANG TIGA', title)
	worksheet185.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet185.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet185.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet185.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet185.write('O22', 'MAT', body)
	...
	worksheet186.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RUKO PCI', title)
	worksheet186.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet186.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet186.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet186.write('G5', 'MAT', body)
	worksheet186.write('H5', 'IND', body)
	worksheet186.write('I5', 'ENG', body)
	worksheet186.write('J5', 'SEJ', body)
	worksheet186.write('K5', 'GEO', body)
	worksheet186.write('L5', 'SOS', body)
	worksheet186.write('M5', 'EKO', body)
	worksheet186.write('N5', 'JML', body)
	worksheet186.write('O5', 'MAT', body)
	worksheet186.write('P5', 'IND', body)
	worksheet186.write('Q5', 'ENG', body)
	worksheet186.write('R5', 'SEJ', body)
	worksheet186.write('S5', 'GEO', body)
	worksheet186.write('T5', 'SOS', body)
	worksheet186.write('U5', 'EKO', body)
	worksheet186.write('V5', 'JML', body)



	worksheet186.conditional_format(5,0,row186_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet186.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RUKO PCI', title)
	worksheet186.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet186.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet186.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet186.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet186.write('O22', 'MAT', body)
	...
	worksheet187.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KRAMATWATU', title)
	worksheet187.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet187.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet187.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet187.write('G5', 'MAT', body)
	worksheet187.write('H5', 'IND', body)
	worksheet187.write('I5', 'ENG', body)
	worksheet187.write('J5', 'SEJ', body)
	worksheet187.write('K5', 'GEO', body)
	worksheet187.write('L5', 'SOS', body)
	worksheet187.write('M5', 'EKO', body)
	worksheet187.write('N5', 'JML', body)
	worksheet187.write('O5', 'MAT', body)
	worksheet187.write('P5', 'IND', body)
	worksheet187.write('Q5', 'ENG', body)
	worksheet187.write('R5', 'SEJ', body)
	worksheet187.write('S5', 'GEO', body)
	worksheet187.write('T5', 'SOS', body)
	worksheet187.write('U5', 'EKO', body)
	worksheet187.write('V5', 'JML', body)



	worksheet187.conditional_format(5,0,row187_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet187.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KRAMATWATU', title)
	worksheet187.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet187.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet187.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet187.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet187.write('O22', 'MAT', body)
	...
	# worksheet188.set_column('G:V', 5, center)
	# worksheet188.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KEPANDEAN', title)
	# worksheet188.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet188.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet188.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet188.write('G5', 'MAT', body)
	# worksheet188.write('H5', 'IND', body)
	# worksheet188.write('I5', 'ENG', body)
	# worksheet188.write('J5', 'SEJ', body)
	# worksheet188.write('K5', 'GEO', body)
	# worksheet188.write('L5', 'SOS', body)
	# worksheet188.write('M5', 'EKO', body)
	# worksheet188.write('N5', 'JML', body)
	# worksheet188.write('O5', 'MAT', body)
	# worksheet188.write('P5', 'IND', body)
	# worksheet188.write('Q5', 'ENG', body)
	# worksheet188.write('R5', 'SEJ', body)
	# worksheet188.write('S5', 'GEO', body)
	# worksheet188.write('T5', 'SOS', body)
	# worksheet188.write('U5', 'EKO', body)
	# worksheet188.write('V5', 'JML', body)



	# worksheet188.conditional_format(5,0,row188_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet188.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KEPANDEAN', title)
	# worksheet188.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet188.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet188.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet188.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet188.write('K22', 'GEO', body)
	# worksheet188.write('L22', 'SOS', body)
	# worksheet188.write('M22', 'EKO', body)
	# worksheet188.write('N22', 'JML', body)
	# worksheet188.write('O22', 'MAT', body)
	# worksheet188.write('P22', 'IND', body)
	# worksheet188.write('Q22', 'ENG', body)
	# worksheet188.write('R22', 'SEJ', body)
	# worksheet188.write('S22', 'GEO', body)
	# worksheet188.write('T22', 'SOS', body)
	# worksheet188.write('U22', 'EKO', body)
	# worksheet188.write('V22', 'JML', body)

	# worksheet188.conditional_format(22,0,row188+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet189.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PINANG', title)
	worksheet189.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet189.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet189.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet189.write('G5', 'MAT', body)
	worksheet189.write('H5', 'IND', body)
	worksheet189.write('I5', 'ENG', body)
	worksheet189.write('J5', 'SEJ', body)
	worksheet189.write('K5', 'GEO', body)
	worksheet189.write('L5', 'SOS', body)
	worksheet189.write('M5', 'EKO', body)
	worksheet189.write('N5', 'JML', body)
	worksheet189.write('O5', 'MAT', body)
	worksheet189.write('P5', 'IND', body)
	worksheet189.write('Q5', 'ENG', body)
	worksheet189.write('R5', 'SEJ', body)
	worksheet189.write('S5', 'GEO', body)
	worksheet189.write('T5', 'SOS', body)
	worksheet189.write('U5', 'EKO', body)
	worksheet189.write('V5', 'JML', body)



	worksheet189.conditional_format(5,0,row189_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet189.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PINANG', title)
	worksheet189.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet189.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet189.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet189.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet189.write('O22', 'MAT', body)
	...
	worksheet190.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BOJONG GEDE', title)
	worksheet190.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet190.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet190.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet190.write('G5', 'MAT', body)
	worksheet190.write('H5', 'IND', body)
	worksheet190.write('I5', 'ENG', body)
	worksheet190.write('J5', 'SEJ', body)
	worksheet190.write('K5', 'GEO', body)
	worksheet190.write('L5', 'SOS', body)
	worksheet190.write('M5', 'EKO', body)
	worksheet190.write('N5', 'JML', body)
	worksheet190.write('O5', 'MAT', body)
	worksheet190.write('P5', 'IND', body)
	worksheet190.write('Q5', 'ENG', body)
	worksheet190.write('R5', 'SEJ', body)
	worksheet190.write('S5', 'GEO', body)
	worksheet190.write('T5', 'SOS', body)
	worksheet190.write('U5', 'EKO', body)
	worksheet190.write('V5', 'JML', body)



	worksheet190.conditional_format(5,0,row190_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet190.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BOJONG GEDE', title)
	worksheet190.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet190.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet190.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet190.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet190.write('O22', 'MAT', body)
	...
	worksheet191.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF POMAD', title)
	worksheet191.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet191.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet191.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet191.write('G5', 'MAT', body)
	worksheet191.write('H5', 'IND', body)
	worksheet191.write('I5', 'ENG', body)
	worksheet191.write('J5', 'SEJ', body)
	worksheet191.write('K5', 'GEO', body)
	worksheet191.write('L5', 'SOS', body)
	worksheet191.write('M5', 'EKO', body)
	worksheet191.write('N5', 'JML', body)
	worksheet191.write('O5', 'MAT', body)
	worksheet191.write('P5', 'IND', body)
	worksheet191.write('Q5', 'ENG', body)
	worksheet191.write('R5', 'SEJ', body)
	worksheet191.write('S5', 'GEO', body)
	worksheet191.write('T5', 'SOS', body)
	worksheet191.write('U5', 'EKO', body)
	worksheet191.write('V5', 'JML', body)



	worksheet191.conditional_format(5,0,row191_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet191.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF POMAD', title)
	worksheet191.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet191.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet191.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet191.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet191.write('O22', 'MAT', body)
	...
	worksheet192.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CONDET', title)
	worksheet192.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet192.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet192.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet192.write('G5', 'MAT', body)
	worksheet192.write('H5', 'IND', body)
	worksheet192.write('I5', 'ENG', body)
	worksheet192.write('J5', 'SEJ', body)
	worksheet192.write('K5', 'GEO', body)
	worksheet192.write('L5', 'SOS', body)
	worksheet192.write('M5', 'EKO', body)
	worksheet192.write('N5', 'JML', body)
	worksheet192.write('O5', 'MAT', body)
	worksheet192.write('P5', 'IND', body)
	worksheet192.write('Q5', 'ENG', body)
	worksheet192.write('R5', 'SEJ', body)
	worksheet192.write('S5', 'GEO', body)
	worksheet192.write('T5', 'SOS', body)
	worksheet192.write('U5', 'EKO', body)
	worksheet192.write('V5', 'JML', body)



	worksheet192.conditional_format(5,0,row192_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet192.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CONDET', title)
	worksheet192.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet192.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet192.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet192.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet192.write('O22', 'MAT', body)
	...
	worksheet193.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JOMBANG', title)
	worksheet193.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet193.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet193.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet193.write('G5', 'MAT', body)
	worksheet193.write('H5', 'IND', body)
	worksheet193.write('I5', 'ENG', body)
	worksheet193.write('J5', 'SEJ', body)
	worksheet193.write('K5', 'GEO', body)
	worksheet193.write('L5', 'SOS', body)
	worksheet193.write('M5', 'EKO', body)
	worksheet193.write('N5', 'JML', body)
	worksheet193.write('O5', 'MAT', body)
	worksheet193.write('P5', 'IND', body)
	worksheet193.write('Q5', 'ENG', body)
	worksheet193.write('R5', 'SEJ', body)
	worksheet193.write('S5', 'GEO', body)
	worksheet193.write('T5', 'SOS', body)
	worksheet193.write('U5', 'EKO', body)
	worksheet193.write('V5', 'JML', body)



	worksheet193.conditional_format(5,0,row193_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet193.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JOMBANG', title)
	worksheet193.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet193.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet193.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet193.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet193.write('O22', 'MAT', body)
	...
	worksheet194.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KEMAYORAN', title)
	worksheet194.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet194.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet194.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet194.write('G5', 'MAT', body)
	worksheet194.write('H5', 'IND', body)
	worksheet194.write('I5', 'ENG', body)
	worksheet194.write('J5', 'SEJ', body)
	worksheet194.write('K5', 'GEO', body)
	worksheet194.write('L5', 'SOS', body)
	worksheet194.write('M5', 'EKO', body)
	worksheet194.write('N5', 'JML', body)
	worksheet194.write('O5', 'MAT', body)
	worksheet194.write('P5', 'IND', body)
	worksheet194.write('Q5', 'ENG', body)
	worksheet194.write('R5', 'SEJ', body)
	worksheet194.write('S5', 'GEO', body)
	worksheet194.write('T5', 'SOS', body)
	worksheet194.write('U5', 'EKO', body)
	worksheet194.write('V5', 'JML', body)



	worksheet194.conditional_format(5,0,row194_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet194.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KEMAYORAN', title)
	worksheet194.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet194.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet194.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet194.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet194.write('O22', 'MAT', body)
	...
	worksheet195.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KALISARI', title)
	worksheet195.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet195.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet195.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet195.write('G5', 'MAT', body)
	worksheet195.write('H5', 'IND', body)
	worksheet195.write('I5', 'ENG', body)
	worksheet195.write('J5', 'SEJ', body)
	worksheet195.write('K5', 'GEO', body)
	worksheet195.write('L5', 'SOS', body)
	worksheet195.write('M5', 'EKO', body)
	worksheet195.write('N5', 'JML', body)
	worksheet195.write('O5', 'MAT', body)
	worksheet195.write('P5', 'IND', body)
	worksheet195.write('Q5', 'ENG', body)
	worksheet195.write('R5', 'SEJ', body)
	worksheet195.write('S5', 'GEO', body)
	worksheet195.write('T5', 'SOS', body)
	worksheet195.write('U5', 'EKO', body)
	worksheet195.write('V5', 'JML', body)



	worksheet195.conditional_format(5,0,row195_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet195.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KALISARI', title)
	worksheet195.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet195.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet195.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet195.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet195.write('O22', 'MAT', body)
	...
	worksheet196.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PAMULANG 1', title)
	worksheet196.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet196.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet196.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet196.write('G5', 'MAT', body)
	worksheet196.write('H5', 'IND', body)
	worksheet196.write('I5', 'ENG', body)
	worksheet196.write('J5', 'SEJ', body)
	worksheet196.write('K5', 'GEO', body)
	worksheet196.write('L5', 'SOS', body)
	worksheet196.write('M5', 'EKO', body)
	worksheet196.write('N5', 'JML', body)
	worksheet196.write('O5', 'MAT', body)
	worksheet196.write('P5', 'IND', body)
	worksheet196.write('Q5', 'ENG', body)
	worksheet196.write('R5', 'SEJ', body)
	worksheet196.write('S5', 'GEO', body)
	worksheet196.write('T5', 'SOS', body)
	worksheet196.write('U5', 'EKO', body)
	worksheet196.write('V5', 'JML', body)



	worksheet196.conditional_format(5,0,row196_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet196.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PAMULANG 1', title)
	worksheet196.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet196.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet196.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet196.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet196.write('O22', 'MAT', body)
	...
	worksheet197.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PANDEGLANG BARU', title)
	worksheet197.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet197.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet197.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet197.write('G5', 'MAT', body)
	worksheet197.write('H5', 'IND', body)
	worksheet197.write('I5', 'ENG', body)
	worksheet197.write('J5', 'SEJ', body)
	worksheet197.write('K5', 'GEO', body)
	worksheet197.write('L5', 'SOS', body)
	worksheet197.write('M5', 'EKO', body)
	worksheet197.write('N5', 'JML', body)
	worksheet197.write('O5', 'MAT', body)
	worksheet197.write('P5', 'IND', body)
	worksheet197.write('Q5', 'ENG', body)
	worksheet197.write('R5', 'SEJ', body)
	worksheet197.write('S5', 'GEO', body)
	worksheet197.write('T5', 'SOS', body)
	worksheet197.write('U5', 'EKO', body)
	worksheet197.write('V5', 'JML', body)



	worksheet197.conditional_format(5,0,row197_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet197.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PANDEGLANG BARU', title)
	worksheet197.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet197.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet197.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet197.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet197.write('O22', 'MAT', body)
	...
	worksheet198.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RUNGKUT', title)
	worksheet198.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet198.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet198.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet198.write('G5', 'MAT', body)
	worksheet198.write('H5', 'IND', body)
	worksheet198.write('I5', 'ENG', body)
	worksheet198.write('J5', 'SEJ', body)
	worksheet198.write('K5', 'GEO', body)
	worksheet198.write('L5', 'SOS', body)
	worksheet198.write('M5', 'EKO', body)
	worksheet198.write('N5', 'JML', body)
	worksheet198.write('O5', 'MAT', body)
	worksheet198.write('P5', 'IND', body)
	worksheet198.write('Q5', 'ENG', body)
	worksheet198.write('R5', 'SEJ', body)
	worksheet198.write('S5', 'GEO', body)
	worksheet198.write('T5', 'SOS', body)
	worksheet198.write('U5', 'EKO', body)
	worksheet198.write('V5', 'JML', body)



	worksheet198.conditional_format(5,0,row198_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet198.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RUNGKUT', title)
	worksheet198.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet198.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet198.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet198.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet198.write('O22', 'MAT', body)
	...
	worksheet199.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIOMAS', title)
	worksheet199.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet199.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet199.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet199.write('G5', 'MAT', body)
	worksheet199.write('H5', 'IND', body)
	worksheet199.write('I5', 'ENG', body)
	worksheet199.write('J5', 'SEJ', body)
	worksheet199.write('K5', 'GEO', body)
	worksheet199.write('L5', 'SOS', body)
	worksheet199.write('M5', 'EKO', body)
	worksheet199.write('N5', 'JML', body)
	worksheet199.write('O5', 'MAT', body)
	worksheet199.write('P5', 'IND', body)
	worksheet199.write('Q5', 'ENG', body)
	worksheet199.write('R5', 'SEJ', body)
	worksheet199.write('S5', 'GEO', body)
	worksheet199.write('T5', 'SOS', body)
	worksheet199.write('U5', 'EKO', body)
	worksheet199.write('V5', 'JML', body)



	worksheet199.conditional_format(5,0,row199_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet199.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIOMAS', title)
	worksheet199.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet199.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet199.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet199.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet199.write('O22', 'MAT', body)
	...
	worksheet201.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUNTER JAYA', title)
	worksheet201.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet201.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet201.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet201.write('G5', 'MAT', body)
	worksheet201.write('H5', 'IND', body)
	worksheet201.write('I5', 'ENG', body)
	worksheet201.write('J5', 'SEJ', body)
	worksheet201.write('K5', 'GEO', body)
	worksheet201.write('L5', 'SOS', body)
	worksheet201.write('M5', 'EKO', body)
	worksheet201.write('N5', 'JML', body)
	worksheet201.write('O5', 'MAT', body)
	worksheet201.write('P5', 'IND', body)
	worksheet201.write('Q5', 'ENG', body)
	worksheet201.write('R5', 'SEJ', body)
	worksheet201.write('S5', 'GEO', body)
	worksheet201.write('T5', 'SOS', body)
	worksheet201.write('U5', 'EKO', body)
	worksheet201.write('V5', 'JML', body)



	worksheet201.conditional_format(5,0,row201_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet201.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUNTER JAYA', title)
	worksheet201.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet201.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet201.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet201.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet201.write('O22', 'MAT', body)
	...
	worksheet202.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PENGGILINGAN', title)
	worksheet202.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet202.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet202.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet202.write('G5', 'MAT', body)
	worksheet202.write('H5', 'IND', body)
	worksheet202.write('I5', 'ENG', body)
	worksheet202.write('J5', 'SEJ', body)
	worksheet202.write('K5', 'GEO', body)
	worksheet202.write('L5', 'SOS', body)
	worksheet202.write('M5', 'EKO', body)
	worksheet202.write('N5', 'JML', body)
	worksheet202.write('O5', 'MAT', body)
	worksheet202.write('P5', 'IND', body)
	worksheet202.write('Q5', 'ENG', body)
	worksheet202.write('R5', 'SEJ', body)
	worksheet202.write('S5', 'GEO', body)
	worksheet202.write('T5', 'SOS', body)
	worksheet202.write('U5', 'EKO', body)
	worksheet202.write('V5', 'JML', body)



	worksheet202.conditional_format(5,0,row202_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet202.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PENGGILINGAN', title)
	worksheet202.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet202.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet202.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet202.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet202.write('O22', 'MAT', body)
	...
	worksheet203.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GORONTALO', title)
	worksheet203.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet203.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet203.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet203.write('G5', 'MAT', body)
	worksheet203.write('H5', 'IND', body)
	worksheet203.write('I5', 'ENG', body)
	worksheet203.write('J5', 'SEJ', body)
	worksheet203.write('K5', 'GEO', body)
	worksheet203.write('L5', 'SOS', body)
	worksheet203.write('M5', 'EKO', body)
	worksheet203.write('N5', 'JML', body)
	worksheet203.write('O5', 'MAT', body)
	worksheet203.write('P5', 'IND', body)
	worksheet203.write('Q5', 'ENG', body)
	worksheet203.write('R5', 'SEJ', body)
	worksheet203.write('S5', 'GEO', body)
	worksheet203.write('T5', 'SOS', body)
	worksheet203.write('U5', 'EKO', body)
	worksheet203.write('V5', 'JML', body)



	worksheet203.conditional_format(5,0,row203_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet203.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GORONTALO', title)
	worksheet203.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet203.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet203.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet203.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet203.write('O22', 'MAT', body)
	...
	worksheet210.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KOPO', title)
	worksheet210.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet210.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet210.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet210.write('G5', 'MAT', body)
	worksheet210.write('H5', 'IND', body)
	worksheet210.write('I5', 'ENG', body)
	worksheet210.write('J5', 'SEJ', body)
	worksheet210.write('K5', 'GEO', body)
	worksheet210.write('L5', 'SOS', body)
	worksheet210.write('M5', 'EKO', body)
	worksheet210.write('N5', 'JML', body)
	worksheet210.write('O5', 'MAT', body)
	worksheet210.write('P5', 'IND', body)
	worksheet210.write('Q5', 'ENG', body)
	worksheet210.write('R5', 'SEJ', body)
	worksheet210.write('S5', 'GEO', body)
	worksheet210.write('T5', 'SOS', body)
	worksheet210.write('U5', 'EKO', body)
	worksheet210.write('V5', 'JML', body)



	worksheet210.conditional_format(5,0,row210_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet210.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KOPO', title)
	worksheet210.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet210.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet210.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet210.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet210.write('O22', 'MAT', body)
	...
	worksheet211.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF VILLA INDAH PERMAI', title)
	worksheet211.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet211.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet211.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet211.write('G5', 'MAT', body)
	worksheet211.write('H5', 'IND', body)
	worksheet211.write('I5', 'ENG', body)
	worksheet211.write('J5', 'SEJ', body)
	worksheet211.write('K5', 'GEO', body)
	worksheet211.write('L5', 'SOS', body)
	worksheet211.write('M5', 'EKO', body)
	worksheet211.write('N5', 'JML', body)
	worksheet211.write('O5', 'MAT', body)
	worksheet211.write('P5', 'IND', body)
	worksheet211.write('Q5', 'ENG', body)
	worksheet211.write('R5', 'SEJ', body)
	worksheet211.write('S5', 'GEO', body)
	worksheet211.write('T5', 'SOS', body)
	worksheet211.write('U5', 'EKO', body)
	worksheet211.write('V5', 'JML', body)



	worksheet211.conditional_format(5,0,row211_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet211.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF VILLA INDAH PERMAI', title)
	worksheet211.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet211.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet211.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet211.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet211.write('O22', 'MAT', body)
	...
	worksheet212.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CISAUK', title)
	worksheet212.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet212.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet212.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet212.write('G5', 'MAT', body)
	worksheet212.write('H5', 'IND', body)
	worksheet212.write('I5', 'ENG', body)
	worksheet212.write('J5', 'SEJ', body)
	worksheet212.write('K5', 'GEO', body)
	worksheet212.write('L5', 'SOS', body)
	worksheet212.write('M5', 'EKO', body)
	worksheet212.write('N5', 'JML', body)
	worksheet212.write('O5', 'MAT', body)
	worksheet212.write('P5', 'IND', body)
	worksheet212.write('Q5', 'ENG', body)
	worksheet212.write('R5', 'SEJ', body)
	worksheet212.write('S5', 'GEO', body)
	worksheet212.write('T5', 'SOS', body)
	worksheet212.write('U5', 'EKO', body)
	worksheet212.write('V5', 'JML', body)



	worksheet212.conditional_format(5,0,row212_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet212.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CISAUK', title)
	worksheet212.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet212.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet212.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet212.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet212.write('O22', 'MAT', body)
	...
	worksheet216.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RADIO DALAM', title)
	worksheet216.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet216.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet216.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet216.write('G5', 'MAT', body)
	worksheet216.write('H5', 'IND', body)
	worksheet216.write('I5', 'ENG', body)
	worksheet216.write('J5', 'SEJ', body)
	worksheet216.write('K5', 'GEO', body)
	worksheet216.write('L5', 'SOS', body)
	worksheet216.write('M5', 'EKO', body)
	worksheet216.write('N5', 'JML', body)
	worksheet216.write('O5', 'MAT', body)
	worksheet216.write('P5', 'IND', body)
	worksheet216.write('Q5', 'ENG', body)
	worksheet216.write('R5', 'SEJ', body)
	worksheet216.write('S5', 'GEO', body)
	worksheet216.write('T5', 'SOS', body)
	worksheet216.write('U5', 'EKO', body)
	worksheet216.write('V5', 'JML', body)



	worksheet216.conditional_format(5,0,row216_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet216.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RADIO DALAM', title)
	worksheet216.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet216.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet216.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet216.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet216.write('O22', 'MAT', body)
	...
	worksheet217.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KALIBATA CITY', title)
	worksheet217.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet217.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet217.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet217.write('G5', 'MAT', body)
	worksheet217.write('H5', 'IND', body)
	worksheet217.write('I5', 'ENG', body)
	worksheet217.write('J5', 'SEJ', body)
	worksheet217.write('K5', 'GEO', body)
	worksheet217.write('L5', 'SOS', body)
	worksheet217.write('M5', 'EKO', body)
	worksheet217.write('N5', 'JML', body)
	worksheet217.write('O5', 'MAT', body)
	worksheet217.write('P5', 'IND', body)
	worksheet217.write('Q5', 'ENG', body)
	worksheet217.write('R5', 'SEJ', body)
	worksheet217.write('S5', 'GEO', body)
	worksheet217.write('T5', 'SOS', body)
	worksheet217.write('U5', 'EKO', body)
	worksheet217.write('V5', 'JML', body)



	worksheet217.conditional_format(5,0,row217_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet217.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KALIBATA CITY', title)
	worksheet217.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet217.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet217.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet217.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet217.write('O22', 'MAT', body)
	...
	worksheet218.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JAGAKARSA', title)
	worksheet218.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet218.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet218.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet218.write('G5', 'MAT', body)
	worksheet218.write('H5', 'IND', body)
	worksheet218.write('I5', 'ENG', body)
	worksheet218.write('J5', 'SEJ', body)
	worksheet218.write('K5', 'GEO', body)
	worksheet218.write('L5', 'SOS', body)
	worksheet218.write('M5', 'EKO', body)
	worksheet218.write('N5', 'JML', body)
	worksheet218.write('O5', 'MAT', body)
	worksheet218.write('P5', 'IND', body)
	worksheet218.write('Q5', 'ENG', body)
	worksheet218.write('R5', 'SEJ', body)
	worksheet218.write('S5', 'GEO', body)
	worksheet218.write('T5', 'SOS', body)
	worksheet218.write('U5', 'EKO', body)
	worksheet218.write('V5', 'JML', body)



	worksheet218.conditional_format(5,0,row218_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet218.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JAGAKARSA', title)
	worksheet218.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet218.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet218.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet218.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet218.write('O22', 'MAT', body)
	...
	worksheet219.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TEBET', title)
	worksheet219.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet219.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet219.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet219.write('G5', 'MAT', body)
	worksheet219.write('H5', 'IND', body)
	worksheet219.write('I5', 'ENG', body)
	worksheet219.write('J5', 'SEJ', body)
	worksheet219.write('K5', 'GEO', body)
	worksheet219.write('L5', 'SOS', body)
	worksheet219.write('M5', 'EKO', body)
	worksheet219.write('N5', 'JML', body)
	worksheet219.write('O5', 'MAT', body)
	worksheet219.write('P5', 'IND', body)
	worksheet219.write('Q5', 'ENG', body)
	worksheet219.write('R5', 'SEJ', body)
	worksheet219.write('S5', 'GEO', body)
	worksheet219.write('T5', 'SOS', body)
	worksheet219.write('U5', 'EKO', body)
	worksheet219.write('V5', 'JML', body)



	worksheet219.conditional_format(5,0,row219_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet219.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TEBET', title)
	worksheet219.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet219.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet219.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet219.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet219.write('O22', 'MAT', body)
	...
	worksheet220.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PADALARANG', title)
	worksheet220.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet220.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet220.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet220.write('G5', 'MAT', body)
	worksheet220.write('H5', 'IND', body)
	worksheet220.write('I5', 'ENG', body)
	worksheet220.write('J5', 'SEJ', body)
	worksheet220.write('K5', 'GEO', body)
	worksheet220.write('L5', 'SOS', body)
	worksheet220.write('M5', 'EKO', body)
	worksheet220.write('N5', 'JML', body)
	worksheet220.write('O5', 'MAT', body)
	worksheet220.write('P5', 'IND', body)
	worksheet220.write('Q5', 'ENG', body)
	worksheet220.write('R5', 'SEJ', body)
	worksheet220.write('S5', 'GEO', body)
	worksheet220.write('T5', 'SOS', body)
	worksheet220.write('U5', 'EKO', body)
	worksheet220.write('V5', 'JML', body)



	worksheet220.conditional_format(5,0,row220_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet220.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PADALARANG', title)
	worksheet220.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet220.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet220.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet220.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet220.write('O22', 'MAT', body)
	...
	# worksheet222.set_column('G:V', 5, center)
	# worksheet222.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CILANDAK', title)
	# worksheet222.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet222.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet222.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet222.write('G5', 'MAT', body)
	# worksheet222.write('H5', 'IND', body)
	# worksheet222.write('I5', 'ENG', body)
	# worksheet222.write('J5', 'SEJ', body)
	# worksheet222.write('K5', 'GEO', body)
	# worksheet222.write('L5', 'SOS', body)
	# worksheet222.write('M5', 'EKO', body)
	# worksheet222.write('N5', 'JML', body)
	# worksheet222.write('O5', 'MAT', body)
	# worksheet222.write('P5', 'IND', body)
	# worksheet222.write('Q5', 'ENG', body)
	# worksheet222.write('R5', 'SEJ', body)
	# worksheet222.write('S5', 'GEO', body)
	# worksheet222.write('T5', 'SOS', body)
	# worksheet222.write('U5', 'EKO', body)
	# worksheet222.write('V5', 'JML', body)



	# worksheet222.conditional_format(5,0,row222_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet222.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CILANDAK', title)
	# worksheet222.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet222.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet222.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet222.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet222.write('K22', 'GEO', body)
	# worksheet222.write('L22', 'SOS', body)
	# worksheet222.write('M22', 'EKO', body)
	# worksheet222.write('N22', 'JML', body)
	# worksheet222.write('O22', 'MAT', body)
	# worksheet222.write('P22', 'IND', body)
	# worksheet222.write('Q22', 'ENG', body)
	# worksheet222.write('R22', 'SEJ', body)
	# worksheet222.write('S22', 'GEO', body)
	# worksheet222.write('T22', 'SOS', body)
	# worksheet222.write('U22', 'EKO', body)
	# worksheet222.write('V22', 'JML', body)

	# worksheet222.conditional_format(22,0,row222+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet226.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KEBON JERUK', title)
	worksheet226.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet226.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet226.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet226.write('G5', 'MAT', body)
	worksheet226.write('H5', 'IND', body)
	worksheet226.write('I5', 'ENG', body)
	worksheet226.write('J5', 'SEJ', body)
	worksheet226.write('K5', 'GEO', body)
	worksheet226.write('L5', 'SOS', body)
	worksheet226.write('M5', 'EKO', body)
	worksheet226.write('N5', 'JML', body)
	worksheet226.write('O5', 'MAT', body)
	worksheet226.write('P5', 'IND', body)
	worksheet226.write('Q5', 'ENG', body)
	worksheet226.write('R5', 'SEJ', body)
	worksheet226.write('S5', 'GEO', body)
	worksheet226.write('T5', 'SOS', body)
	worksheet226.write('U5', 'EKO', body)
	worksheet226.write('V5', 'JML', body)



	worksheet226.conditional_format(5,0,row226_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet226.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KEBON JERUK', title)
	worksheet226.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet226.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet226.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet226.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet226.write('O22', 'MAT', body)
	...
	worksheet227.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MERUYA SELATAN', title)
	worksheet227.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet227.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet227.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet227.write('G5', 'MAT', body)
	worksheet227.write('H5', 'IND', body)
	worksheet227.write('I5', 'ENG', body)
	worksheet227.write('J5', 'SEJ', body)
	worksheet227.write('K5', 'GEO', body)
	worksheet227.write('L5', 'SOS', body)
	worksheet227.write('M5', 'EKO', body)
	worksheet227.write('N5', 'JML', body)
	worksheet227.write('O5', 'MAT', body)
	worksheet227.write('P5', 'IND', body)
	worksheet227.write('Q5', 'ENG', body)
	worksheet227.write('R5', 'SEJ', body)
	worksheet227.write('S5', 'GEO', body)
	worksheet227.write('T5', 'SOS', body)
	worksheet227.write('U5', 'EKO', body)
	worksheet227.write('V5', 'JML', body)



	worksheet227.conditional_format(5,0,row227_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet227.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MERUYA SELATAN', title)
	worksheet227.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet227.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet227.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet227.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet227.write('O22', 'MAT', body)
	...
	worksheet228.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TANJUNG DUREN', title)
	worksheet228.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet228.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet228.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet228.write('G5', 'MAT', body)
	worksheet228.write('H5', 'IND', body)
	worksheet228.write('I5', 'ENG', body)
	worksheet228.write('J5', 'SEJ', body)
	worksheet228.write('K5', 'GEO', body)
	worksheet228.write('L5', 'SOS', body)
	worksheet228.write('M5', 'EKO', body)
	worksheet228.write('N5', 'JML', body)
	worksheet228.write('O5', 'MAT', body)
	worksheet228.write('P5', 'IND', body)
	worksheet228.write('Q5', 'ENG', body)
	worksheet228.write('R5', 'SEJ', body)
	worksheet228.write('S5', 'GEO', body)
	worksheet228.write('T5', 'SOS', body)
	worksheet228.write('U5', 'EKO', body)
	worksheet228.write('V5', 'JML', body)



	worksheet228.conditional_format(5,0,row228_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet228.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TANJUNG DUREN', title)
	worksheet228.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet228.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet228.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet228.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet228.write('O22', 'MAT', body)
	...
	worksheet229.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TOMANG', title)
	worksheet229.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet229.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet229.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet229.write('G5', 'MAT', body)
	worksheet229.write('H5', 'IND', body)
	worksheet229.write('I5', 'ENG', body)
	worksheet229.write('J5', 'SEJ', body)
	worksheet229.write('K5', 'GEO', body)
	worksheet229.write('L5', 'SOS', body)
	worksheet229.write('M5', 'EKO', body)
	worksheet229.write('N5', 'JML', body)
	worksheet229.write('O5', 'MAT', body)
	worksheet229.write('P5', 'IND', body)
	worksheet229.write('Q5', 'ENG', body)
	worksheet229.write('R5', 'SEJ', body)
	worksheet229.write('S5', 'GEO', body)
	worksheet229.write('T5', 'SOS', body)
	worksheet229.write('U5', 'EKO', body)
	worksheet229.write('V5', 'JML', body)



	worksheet229.conditional_format(5,0,row229_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet229.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TOMANG', title)
	worksheet229.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet229.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet229.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet229.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet229.write('O22', 'MAT', body)
	...
	worksheet230.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KERADENAN', title)
	worksheet230.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet230.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet230.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet230.write('G5', 'MAT', body)
	worksheet230.write('H5', 'IND', body)
	worksheet230.write('I5', 'ENG', body)
	worksheet230.write('J5', 'SEJ', body)
	worksheet230.write('K5', 'GEO', body)
	worksheet230.write('L5', 'SOS', body)
	worksheet230.write('M5', 'EKO', body)
	worksheet230.write('N5', 'JML', body)
	worksheet230.write('O5', 'MAT', body)
	worksheet230.write('P5', 'IND', body)
	worksheet230.write('Q5', 'ENG', body)
	worksheet230.write('R5', 'SEJ', body)
	worksheet230.write('S5', 'GEO', body)
	worksheet230.write('T5', 'SOS', body)
	worksheet230.write('U5', 'EKO', body)
	worksheet230.write('V5', 'JML', body)



	worksheet230.conditional_format(5,0,row230_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet230.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KERADENAN', title)
	worksheet230.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet230.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet230.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet230.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet230.write('O22', 'MAT', body)
	...
	worksheet231.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RA KOSASIH SUKABUMI', title)
	worksheet231.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet231.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet231.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet231.write('G5', 'MAT', body)
	worksheet231.write('H5', 'IND', body)
	worksheet231.write('I5', 'ENG', body)
	worksheet231.write('J5', 'SEJ', body)
	worksheet231.write('K5', 'GEO', body)
	worksheet231.write('L5', 'SOS', body)
	worksheet231.write('M5', 'EKO', body)
	worksheet231.write('N5', 'JML', body)
	worksheet231.write('O5', 'MAT', body)
	worksheet231.write('P5', 'IND', body)
	worksheet231.write('Q5', 'ENG', body)
	worksheet231.write('R5', 'SEJ', body)
	worksheet231.write('S5', 'GEO', body)
	worksheet231.write('T5', 'SOS', body)
	worksheet231.write('U5', 'EKO', body)
	worksheet231.write('V5', 'JML', body)



	worksheet231.conditional_format(5,0,row231_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet231.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RA KOSASIH SUKABUMI', title)
	worksheet231.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet231.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet231.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet231.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet231.write('O22', 'MAT', body)
	...
	worksheet233.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BANGBARUNG', title)
	worksheet233.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet233.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet233.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet233.write('G5', 'MAT', body)
	worksheet233.write('H5', 'IND', body)
	worksheet233.write('I5', 'ENG', body)
	worksheet233.write('J5', 'SEJ', body)
	worksheet233.write('K5', 'GEO', body)
	worksheet233.write('L5', 'SOS', body)
	worksheet233.write('M5', 'EKO', body)
	worksheet233.write('N5', 'JML', body)
	worksheet233.write('O5', 'MAT', body)
	worksheet233.write('P5', 'IND', body)
	worksheet233.write('Q5', 'ENG', body)
	worksheet233.write('R5', 'SEJ', body)
	worksheet233.write('S5', 'GEO', body)
	worksheet233.write('T5', 'SOS', body)
	worksheet233.write('U5', 'EKO', body)
	worksheet233.write('V5', 'JML', body)



	worksheet233.conditional_format(5,0,row233_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet233.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BANGBARUNG', title)
	worksheet233.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet233.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet233.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet233.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet233.write('O22', 'MAT', body)
	...
	worksheet234.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF LIMUS PRATAMA', title)
	worksheet234.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet234.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet234.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet234.write('G5', 'MAT', body)
	worksheet234.write('H5', 'IND', body)
	worksheet234.write('I5', 'ENG', body)
	worksheet234.write('J5', 'SEJ', body)
	worksheet234.write('K5', 'GEO', body)
	worksheet234.write('L5', 'SOS', body)
	worksheet234.write('M5', 'EKO', body)
	worksheet234.write('N5', 'JML', body)
	worksheet234.write('O5', 'MAT', body)
	worksheet234.write('P5', 'IND', body)
	worksheet234.write('Q5', 'ENG', body)
	worksheet234.write('R5', 'SEJ', body)
	worksheet234.write('S5', 'GEO', body)
	worksheet234.write('T5', 'SOS', body)
	worksheet234.write('U5', 'EKO', body)
	worksheet234.write('V5', 'JML', body)



	worksheet234.conditional_format(5,0,row234_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet234.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF LIMUS PRATAMA', title)
	worksheet234.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet234.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet234.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet234.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet234.write('O22', 'MAT', body)
	...
	worksheet235.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIKARET CIBINONG', title)
	worksheet235.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet235.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet235.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet235.write('G5', 'MAT', body)
	worksheet235.write('H5', 'IND', body)
	worksheet235.write('I5', 'ENG', body)
	worksheet235.write('J5', 'SEJ', body)
	worksheet235.write('K5', 'GEO', body)
	worksheet235.write('L5', 'SOS', body)
	worksheet235.write('M5', 'EKO', body)
	worksheet235.write('N5', 'JML', body)
	worksheet235.write('O5', 'MAT', body)
	worksheet235.write('P5', 'IND', body)
	worksheet235.write('Q5', 'ENG', body)
	worksheet235.write('R5', 'SEJ', body)
	worksheet235.write('S5', 'GEO', body)
	worksheet235.write('T5', 'SOS', body)
	worksheet235.write('U5', 'EKO', body)
	worksheet235.write('V5', 'JML', body)



	worksheet235.conditional_format(5,0,row235_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet235.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIKARET CIBINONG', title)
	worksheet235.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet235.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet235.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet235.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet235.write('O22', 'MAT', body)
	...
	worksheet236.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GARUT', title)
	worksheet236.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet236.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet236.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet236.write('G5', 'MAT', body)
	worksheet236.write('H5', 'IND', body)
	worksheet236.write('I5', 'ENG', body)
	worksheet236.write('J5', 'SEJ', body)
	worksheet236.write('K5', 'GEO', body)
	worksheet236.write('L5', 'SOS', body)
	worksheet236.write('M5', 'EKO', body)
	worksheet236.write('N5', 'JML', body)
	worksheet236.write('O5', 'MAT', body)
	worksheet236.write('P5', 'IND', body)
	worksheet236.write('Q5', 'ENG', body)
	worksheet236.write('R5', 'SEJ', body)
	worksheet236.write('S5', 'GEO', body)
	worksheet236.write('T5', 'SOS', body)
	worksheet236.write('U5', 'EKO', body)
	worksheet236.write('V5', 'JML', body)



	worksheet236.conditional_format(5,0,row236_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet236.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GARUT', title)
	worksheet236.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet236.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet236.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet236.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet236.write('O22', 'MAT', body)
...
uploaded_file = st.file_uploader('Letakkan file excel NILAI STANDAR kelas 10 SMA IPS PAS SM1 [LOKASI 237-299]', type='xlsx')
...
if uploaded_file is not None:
	...
	sort248_10=sort248_10.drop(sort248_10[(sort248_10['RANK LOK.']>10)].index)
	# 249
	sort249_10=sort249.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort249_10['LOKASI']
	sort249_10=sort249_10.drop(sort249_10[(sort249_10['RANK LOK.']>10)].index)
	# 250
	sort250_10=sort250.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort250_10['LOKASI']
	sort250_10=sort250_10.drop(sort250_10[(sort250_10['RANK LOK.']>10)].index)
	# # 251
	...
	sort252_10=sort252_10.drop(sort252_10[(sort252_10['RANK LOK.']>10)].index)
	# # 253
	...
	sort298_10=sort298_10.drop(sort298_10[(sort298_10['RANK LOK.']>10)].index)
	# 299
	sort299_10=sort299.sort_values(by=['RANK LOK.'], ascending=[True])
	del sort299_10['LOKASI']
	sort299_10=sort299_10.drop(sort299_10[(sort299_10['RANK LOK.']>10)].index)
	...
	worksheet237.set_column('G:V', 5, center)
	worksheet237.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TASIKMALAYA', title)
	worksheet237.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet237.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet237.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet237.write('G5', 'MAT', body)
	worksheet237.write('H5', 'IND', body)
	worksheet237.write('I5', 'ENG', body)
	worksheet237.write('J5', 'SEJ', body)
	worksheet237.write('K5', 'GEO', body)
	worksheet237.write('L5', 'SOS', body)
	worksheet237.write('M5', 'EKO', body)
	worksheet237.write('N5', 'JML', body)
	worksheet237.write('O5', 'MAT', body)
	worksheet237.write('P5', 'IND', body)
	worksheet237.write('Q5', 'ENG', body)
	worksheet237.write('R5', 'SEJ', body)
	worksheet237.write('S5', 'GEO', body)
	worksheet237.write('T5', 'SOS', body)
	worksheet237.write('U5', 'EKO', body)
	worksheet237.write('V5', 'JML', body)



	worksheet237.conditional_format(5,0,row237_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet237.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TASIKMALAYA', title)
	worksheet237.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet237.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet237.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet237.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet237.write('K22', 'GEO', body)
	worksheet237.write('L22', 'SOS', body)
	worksheet237.write('M22', 'EKO', body)
	worksheet237.write('N22', 'JML', body)
	worksheet237.write('O22', 'MAT', body)
	worksheet237.write('P22', 'IND', body)
	worksheet237.write('Q22', 'ENG', body)
	worksheet237.write('R22', 'SEJ', body)
	worksheet237.write('S22', 'GEO', body)
	worksheet237.write('T22', 'SOS', body)
	worksheet237.write('U22', 'EKO', body)
	worksheet237.write('V22', 'JML', body)

	worksheet237.conditional_format(22,0,row237+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet238.set_column('G:V', 5, center)
	worksheet238.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUBANG', title)
	worksheet238.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet238.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet238.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet238.write('G5', 'MAT', body)
	worksheet238.write('H5', 'IND', body)
	worksheet238.write('I5', 'ENG', body)
	worksheet238.write('J5', 'SEJ', body)
	worksheet238.write('K5', 'GEO', body)
	worksheet238.write('L5', 'SOS', body)
	worksheet238.write('M5', 'EKO', body)
	worksheet238.write('N5', 'JML', body)
	worksheet238.write('O5', 'MAT', body)
	worksheet238.write('P5', 'IND', body)
	worksheet238.write('Q5', 'ENG', body)
	worksheet238.write('R5', 'SEJ', body)
	worksheet238.write('S5', 'GEO', body)
	worksheet238.write('T5', 'SOS', body)
	worksheet238.write('U5', 'EKO', body)
	worksheet238.write('V5', 'JML', body)



	worksheet238.conditional_format(5,0,row238_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet238.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUBANG', title)
	worksheet238.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet238.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet238.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet238.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet238.write('K22', 'GEO', body)
	worksheet238.write('L22', 'SOS', body)
	worksheet238.write('M22', 'EKO', body)
	worksheet238.write('N22', 'JML', body)
	worksheet238.write('O22', 'MAT', body)
	worksheet238.write('P22', 'IND', body)
	worksheet238.write('Q22', 'ENG', body)
	worksheet238.write('R22', 'SEJ', body)
	worksheet238.write('S22', 'GEO', body)
	worksheet238.write('T22', 'SOS', body)
	worksheet238.write('U22', 'EKO', body)
	worksheet238.write('V22', 'JML', body)

	worksheet238.conditional_format(22,0,row238+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet240.set_column('G:V', 5, center)
	worksheet240.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUMEDANG', title)
	worksheet240.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet240.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet240.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet240.write('G5', 'MAT', body)
	worksheet240.write('H5', 'IND', body)
	worksheet240.write('I5', 'ENG', body)
	worksheet240.write('J5', 'SEJ', body)
	worksheet240.write('K5', 'GEO', body)
	worksheet240.write('L5', 'SOS', body)
	worksheet240.write('M5', 'EKO', body)
	worksheet240.write('N5', 'JML', body)
	worksheet240.write('O5', 'MAT', body)
	worksheet240.write('P5', 'IND', body)
	worksheet240.write('Q5', 'ENG', body)
	worksheet240.write('R5', 'SEJ', body)
	worksheet240.write('S5', 'GEO', body)
	worksheet240.write('T5', 'SOS', body)
	worksheet240.write('U5', 'EKO', body)
	worksheet240.write('V5', 'JML', body)



	worksheet240.conditional_format(5,0,row240_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet240.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUMEDANG', title)
	worksheet240.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet240.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet240.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet240.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet240.write('K22', 'GEO', body)
	worksheet240.write('L22', 'SOS', body)
	worksheet240.write('M22', 'EKO', body)
	worksheet240.write('N22', 'JML', body)
	worksheet240.write('O22', 'MAT', body)
	worksheet240.write('P22', 'IND', body)
	worksheet240.write('Q22', 'ENG', body)
	worksheet240.write('R22', 'SEJ', body)
	worksheet240.write('S22', 'GEO', body)
	worksheet240.write('T22', 'SOS', body)
	worksheet240.write('U22', 'EKO', body)
	worksheet240.write('V22', 'JML', body)

	worksheet240.conditional_format(22,0,row240+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet241.set_column('G:V', 5, center)
	worksheet241.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MAJALENGKA', title)
	worksheet241.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet241.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet241.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet241.write('G5', 'MAT', body)
	worksheet241.write('H5', 'IND', body)
	worksheet241.write('I5', 'ENG', body)
	worksheet241.write('J5', 'SEJ', body)
	worksheet241.write('K5', 'GEO', body)
	worksheet241.write('L5', 'SOS', body)
	worksheet241.write('M5', 'EKO', body)
	worksheet241.write('N5', 'JML', body)
	worksheet241.write('O5', 'MAT', body)
	worksheet241.write('P5', 'IND', body)
	worksheet241.write('Q5', 'ENG', body)
	worksheet241.write('R5', 'SEJ', body)
	worksheet241.write('S5', 'GEO', body)
	worksheet241.write('T5', 'SOS', body)
	worksheet241.write('U5', 'EKO', body)
	worksheet241.write('V5', 'JML', body)



	worksheet241.conditional_format(5,0,row241_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet241.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MAJALENGKA', title)
	worksheet241.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet241.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet241.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet241.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet241.write('K22', 'GEO', body)
	worksheet241.write('L22', 'SOS', body)
	worksheet241.write('M22', 'EKO', body)
	worksheet241.write('N22', 'JML', body)
	worksheet241.write('O22', 'MAT', body)
	worksheet241.write('P22', 'IND', body)
	worksheet241.write('Q22', 'ENG', body)
	worksheet241.write('R22', 'SEJ', body)
	worksheet241.write('S22', 'GEO', body)
	worksheet241.write('T22', 'SOS', body)
	worksheet241.write('U22', 'EKO', body)
	worksheet241.write('V22', 'JML', body)

	worksheet241.conditional_format(22,0,row241+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet243.set_column('G:V', 5, center)
	worksheet243.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PURBALINGGA', title)
	worksheet243.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet243.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet243.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet243.write('G5', 'MAT', body)
	worksheet243.write('H5', 'IND', body)
	worksheet243.write('I5', 'ENG', body)
	worksheet243.write('J5', 'SEJ', body)
	worksheet243.write('K5', 'GEO', body)
	worksheet243.write('L5', 'SOS', body)
	worksheet243.write('M5', 'EKO', body)
	worksheet243.write('N5', 'JML', body)
	worksheet243.write('O5', 'MAT', body)
	worksheet243.write('P5', 'IND', body)
	worksheet243.write('Q5', 'ENG', body)
	worksheet243.write('R5', 'SEJ', body)
	worksheet243.write('S5', 'GEO', body)
	worksheet243.write('T5', 'SOS', body)
	worksheet243.write('U5', 'EKO', body)
	worksheet243.write('V5', 'JML', body)



	worksheet243.conditional_format(5,0,row243_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet243.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PURBALINGGA', title)
	worksheet243.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet243.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet243.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet243.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet243.write('K22', 'GEO', body)
	worksheet243.write('L22', 'SOS', body)
	worksheet243.write('M22', 'EKO', body)
	worksheet243.write('N22', 'JML', body)
	worksheet243.write('O22', 'MAT', body)
	worksheet243.write('P22', 'IND', body)
	worksheet243.write('Q22', 'ENG', body)
	worksheet243.write('R22', 'SEJ', body)
	worksheet243.write('S22', 'GEO', body)
	worksheet243.write('T22', 'SOS', body)
	worksheet243.write('U22', 'EKO', body)
	worksheet243.write('V22', 'JML', body)

	worksheet243.conditional_format(22,0,row243+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet244.set_column('G:V', 5, center)
	worksheet244.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SURAKARTA', title)
	worksheet244.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet244.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet244.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet244.write('G5', 'MAT', body)
	worksheet244.write('H5', 'IND', body)
	worksheet244.write('I5', 'ENG', body)
	worksheet244.write('J5', 'SEJ', body)
	worksheet244.write('K5', 'GEO', body)
	worksheet244.write('L5', 'SOS', body)
	worksheet244.write('M5', 'EKO', body)
	worksheet244.write('N5', 'JML', body)
	worksheet244.write('O5', 'MAT', body)
	worksheet244.write('P5', 'IND', body)
	worksheet244.write('Q5', 'ENG', body)
	worksheet244.write('R5', 'SEJ', body)
	worksheet244.write('S5', 'GEO', body)
	worksheet244.write('T5', 'SOS', body)
	worksheet244.write('U5', 'EKO', body)
	worksheet244.write('V5', 'JML', body)



	worksheet244.conditional_format(5,0,row244_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet244.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SURAKARTA', title)
	worksheet244.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet244.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet244.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet244.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet244.write('K22', 'GEO', body)
	worksheet244.write('L22', 'SOS', body)
	worksheet244.write('M22', 'EKO', body)
	worksheet244.write('N22', 'JML', body)
	worksheet244.write('O22', 'MAT', body)
	worksheet244.write('P22', 'IND', body)
	worksheet244.write('Q22', 'ENG', body)
	worksheet244.write('R22', 'SEJ', body)
	worksheet244.write('S22', 'GEO', body)
	worksheet244.write('T22', 'SOS', body)
	worksheet244.write('U22', 'EKO', body)
	worksheet244.write('V22', 'JML', body)

	worksheet244.conditional_format(22,0,row244+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet245.set_column('G:V', 5, center)
	worksheet245.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SEMARANG', title)
	worksheet245.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet245.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet245.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet245.write('G5', 'MAT', body)
	worksheet245.write('H5', 'IND', body)
	worksheet245.write('I5', 'ENG', body)
	worksheet245.write('J5', 'SEJ', body)
	worksheet245.write('K5', 'GEO', body)
	worksheet245.write('L5', 'SOS', body)
	worksheet245.write('M5', 'EKO', body)
	worksheet245.write('N5', 'JML', body)
	worksheet245.write('O5', 'MAT', body)
	worksheet245.write('P5', 'IND', body)
	worksheet245.write('Q5', 'ENG', body)
	worksheet245.write('R5', 'SEJ', body)
	worksheet245.write('S5', 'GEO', body)
	worksheet245.write('T5', 'SOS', body)
	worksheet245.write('U5', 'EKO', body)
	worksheet245.write('V5', 'JML', body)



	worksheet245.conditional_format(5,0,row245_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet245.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SEMARANG', title)
	worksheet245.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet245.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet245.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet245.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet245.write('K22', 'GEO', body)
	worksheet245.write('L22', 'SOS', body)
	worksheet245.write('M22', 'EKO', body)
	worksheet245.write('N22', 'JML', body)
	worksheet245.write('O22', 'MAT', body)
	worksheet245.write('P22', 'IND', body)
	worksheet245.write('Q22', 'ENG', body)
	worksheet245.write('R22', 'SEJ', body)
	worksheet245.write('S22', 'GEO', body)
	worksheet245.write('T22', 'SOS', body)
	worksheet245.write('U22', 'EKO', body)
	worksheet245.write('V22', 'JML', body)

	worksheet245.conditional_format(22,0,row245+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet246.set_column('G:V', 5, center)
	worksheet246.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KARTASURA', title)
	worksheet246.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet246.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet246.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet246.write('G5', 'MAT', body)
	worksheet246.write('H5', 'IND', body)
	worksheet246.write('I5', 'ENG', body)
	worksheet246.write('J5', 'SEJ', body)
	worksheet246.write('K5', 'GEO', body)
	worksheet246.write('L5', 'SOS', body)
	worksheet246.write('M5', 'EKO', body)
	worksheet246.write('N5', 'JML', body)
	worksheet246.write('O5', 'MAT', body)
	worksheet246.write('P5', 'IND', body)
	worksheet246.write('Q5', 'ENG', body)
	worksheet246.write('R5', 'SEJ', body)
	worksheet246.write('S5', 'GEO', body)
	worksheet246.write('T5', 'SOS', body)
	worksheet246.write('U5', 'EKO', body)
	worksheet246.write('V5', 'JML', body)



	worksheet246.conditional_format(5,0,row246_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet246.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KARTASURA', title)
	worksheet246.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet246.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet246.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet246.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet246.write('K22', 'GEO', body)
	worksheet246.write('L22', 'SOS', body)
	worksheet246.write('M22', 'EKO', body)
	worksheet246.write('N22', 'JML', body)
	worksheet246.write('O22', 'MAT', body)
	worksheet246.write('P22', 'IND', body)
	worksheet246.write('Q22', 'ENG', body)
	worksheet246.write('R22', 'SEJ', body)
	worksheet246.write('S22', 'GEO', body)
	worksheet246.write('T22', 'SOS', body)
	worksheet246.write('U22', 'EKO', body)
	worksheet246.write('V22', 'JML', body)

	worksheet246.conditional_format(22,0,row246+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	# worksheet247.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JURANG MANGU', title)
	...
	# worksheet247.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet247.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet247.write('G5', 'MAT', body)
	# worksheet247.write('H5', 'IND', body)
	# worksheet247.write('I5', 'ENG', body)
	# worksheet247.write('J5', 'SEJ', body)
	# worksheet247.write('K5', 'GEO', body)
	# worksheet247.write('L5', 'SOS', body)
	# worksheet247.write('M5', 'EKO', body)
	# worksheet247.write('N5', 'JML', body)
	# worksheet247.write('O5', 'MAT', body)
	# worksheet247.write('P5', 'IND', body)
	# worksheet247.write('Q5', 'ENG', body)
	# worksheet247.write('R5', 'SEJ', body)
	# worksheet247.write('S5', 'GEO', body)
	# worksheet247.write('T5', 'SOS', body)
	# worksheet247.write('U5', 'EKO', body)
	# worksheet247.write('V5', 'JML', body)



	# worksheet247.conditional_format(5,0,row247_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet247.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JURANG MANGU', title)
	# worksheet247.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet247.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	# worksheet247.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet247.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet247.write('K22', 'GEO', body)
	# worksheet247.write('L22', 'SOS', body)
	# worksheet247.write('M22', 'EKO', body)
	# worksheet247.write('N22', 'JML', body)
	# worksheet247.write('O22', 'MAT', body)
	# worksheet247.write('P22', 'IND', body)
	# worksheet247.write('Q22', 'ENG', body)
	# worksheet247.write('R22', 'SEJ', body)
	# worksheet247.write('S22', 'GEO', body)
	# worksheet247.write('T22', 'SOS', body)
	# worksheet247.write('U22', 'EKO', body)
	# worksheet247.write('V22', 'JML', body)

	# worksheet247.conditional_format(22,0,row247+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet248.set_column('G:V', 5, center)
	worksheet248.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BSD BOULEVARD', title)
	worksheet248.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet248.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet248.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet248.write('G5', 'MAT', body)
	worksheet248.write('H5', 'IND', body)
	worksheet248.write('I5', 'ENG', body)
	worksheet248.write('J5', 'SEJ', body)
	worksheet248.write('K5', 'GEO', body)
	worksheet248.write('L5', 'SOS', body)
	worksheet248.write('M5', 'EKO', body)
	worksheet248.write('N5', 'JML', body)
	worksheet248.write('O5', 'MAT', body)
	worksheet248.write('P5', 'IND', body)
	worksheet248.write('Q5', 'ENG', body)
	worksheet248.write('R5', 'SEJ', body)
	worksheet248.write('S5', 'GEO', body)
	worksheet248.write('T5', 'SOS', body)
	worksheet248.write('U5', 'EKO', body)
	worksheet248.write('V5', 'JML', body)



	worksheet248.conditional_format(5,0,row248_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet248.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BSD BOULEVARD', title)
	worksheet248.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet248.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet248.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet248.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet248.write('K22', 'GEO', body)
	worksheet248.write('L22', 'SOS', body)
	worksheet248.write('M22', 'EKO', body)
	worksheet248.write('N22', 'JML', body)
	worksheet248.write('O22', 'MAT', body)
	worksheet248.write('P22', 'IND', body)
	worksheet248.write('Q22', 'ENG', body)
	worksheet248.write('R22', 'SEJ', body)
	worksheet248.write('S22', 'GEO', body)
	worksheet248.write('T22', 'SOS', body)
	worksheet248.write('U22', 'EKO', body)
	worksheet248.write('V22', 'JML', body)

	worksheet248.conditional_format(22,0,row248+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet249.set_column('G:V', 5, center)
	worksheet249.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SANGIANG', title)
	worksheet249.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet249.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet249.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet249.write('G5', 'MAT', body)
	worksheet249.write('H5', 'IND', body)
	worksheet249.write('I5', 'ENG', body)
	worksheet249.write('J5', 'SEJ', body)
	worksheet249.write('K5', 'GEO', body)
	worksheet249.write('L5', 'SOS', body)
	worksheet249.write('M5', 'EKO', body)
	worksheet249.write('N5', 'JML', body)
	worksheet249.write('O5', 'MAT', body)
	worksheet249.write('P5', 'IND', body)
	worksheet249.write('Q5', 'ENG', body)
	worksheet249.write('R5', 'SEJ', body)
	worksheet249.write('S5', 'GEO', body)
	worksheet249.write('T5', 'SOS', body)
	worksheet249.write('U5', 'EKO', body)
	worksheet249.write('V5', 'JML', body)



	worksheet249.conditional_format(5,0,row249_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet249.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SANGIANG', title)
	worksheet249.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet249.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet249.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet249.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet249.write('K22', 'GEO', body)
	worksheet249.write('L22', 'SOS', body)
	worksheet249.write('M22', 'EKO', body)
	worksheet249.write('N22', 'JML', body)
	worksheet249.write('O22', 'MAT', body)
	worksheet249.write('P22', 'IND', body)
	worksheet249.write('Q22', 'ENG', body)
	worksheet249.write('R22', 'SEJ', body)
	worksheet249.write('S22', 'GEO', body)
	worksheet249.write('T22', 'SOS', body)
	worksheet249.write('U22', 'EKO', body)
	worksheet249.write('V22', 'JML', body)

	worksheet249.conditional_format(22,0,row249+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet250.set_column('G:V', 5, center)
	worksheet250.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BANJAR WIJAYA', title)
	worksheet250.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet250.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet250.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet250.write('G5', 'MAT', body)
	worksheet250.write('H5', 'IND', body)
	worksheet250.write('I5', 'ENG', body)
	worksheet250.write('J5', 'SEJ', body)
	worksheet250.write('K5', 'GEO', body)
	worksheet250.write('L5', 'SOS', body)
	worksheet250.write('M5', 'EKO', body)
	worksheet250.write('N5', 'JML', body)
	worksheet250.write('O5', 'MAT', body)
	worksheet250.write('P5', 'IND', body)
	worksheet250.write('Q5', 'ENG', body)
	worksheet250.write('R5', 'SEJ', body)
	worksheet250.write('S5', 'GEO', body)
	worksheet250.write('T5', 'SOS', body)
	worksheet250.write('U5', 'EKO', body)
	worksheet250.write('V5', 'JML', body)



	worksheet250.conditional_format(5,0,row250_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet250.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BANJAR WIJAYA', title)
	worksheet250.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet250.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet250.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet250.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet250.write('K22', 'GEO', body)
	worksheet250.write('L22', 'SOS', body)
	worksheet250.write('M22', 'EKO', body)
	worksheet250.write('N22', 'JML', body)
	worksheet250.write('O22', 'MAT', body)
	worksheet250.write('P22', 'IND', body)
	worksheet250.write('Q22', 'ENG', body)
	worksheet250.write('R22', 'SEJ', body)
	worksheet250.write('S22', 'GEO', body)
	worksheet250.write('T22', 'SOS', body)
	worksheet250.write('U22', 'EKO', body)
	worksheet250.write('V22', 'JML', body)

	worksheet250.conditional_format(22,0,row250+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	# worksheet251.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MELATI MAS', title)
	...
	# worksheet251.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet251.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet251.write('G5', 'MAT', body)
	# worksheet251.write('H5', 'IND', body)
	# worksheet251.write('I5', 'ENG', body)
	# worksheet251.write('J5', 'SEJ', body)
	# worksheet251.write('K5', 'GEO', body)
	# worksheet251.write('L5', 'SOS', body)
	# worksheet251.write('M5', 'EKO', body)
	# worksheet251.write('N5', 'JML', body)
	# worksheet251.write('O5', 'MAT', body)
	# worksheet251.write('P5', 'IND', body)
	# worksheet251.write('Q5', 'ENG', body)
	# worksheet251.write('R5', 'SEJ', body)
	# worksheet251.write('S5', 'GEO', body)
	# worksheet251.write('T5', 'SOS', body)
	# worksheet251.write('U5', 'EKO', body)
	# worksheet251.write('V5', 'JML', body)



	# worksheet251.conditional_format(5,0,row251_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet251.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MELATI MAS', title)
	# worksheet251.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet251.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	# worksheet251.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet251.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet251.write('K22', 'GEO', body)
	# worksheet251.write('L22', 'SOS', body)
	# worksheet251.write('M22', 'EKO', body)
	# worksheet251.write('N22', 'JML', body)
	# worksheet251.write('O22', 'MAT', body)
	# worksheet251.write('P22', 'IND', body)
	# worksheet251.write('Q22', 'ENG', body)
	# worksheet251.write('R22', 'SEJ', body)
	# worksheet251.write('S22', 'GEO', body)
	# worksheet251.write('T22', 'SOS', body)
	# worksheet251.write('U22', 'EKO', body)
	# worksheet251.write('V22', 'JML', body)

	# worksheet251.conditional_format(22,0,row251+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet252.set_column('G:V', 5, center)
	worksheet252.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIRENDEU', title)
	worksheet252.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet252.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet252.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet252.write('G5', 'MAT', body)
	worksheet252.write('H5', 'IND', body)
	worksheet252.write('I5', 'ENG', body)
	worksheet252.write('J5', 'SEJ', body)
	worksheet252.write('K5', 'GEO', body)
	worksheet252.write('L5', 'SOS', body)
	worksheet252.write('M5', 'EKO', body)
	worksheet252.write('N5', 'JML', body)
	worksheet252.write('O5', 'MAT', body)
	worksheet252.write('P5', 'IND', body)
	worksheet252.write('Q5', 'ENG', body)
	worksheet252.write('R5', 'SEJ', body)
	worksheet252.write('S5', 'GEO', body)
	worksheet252.write('T5', 'SOS', body)
	worksheet252.write('U5', 'EKO', body)
	worksheet252.write('V5', 'JML', body)



	worksheet252.conditional_format(5,0,row252_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet252.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIRENDEU', title)
	worksheet252.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet252.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet252.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet252.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet252.write('K22', 'GEO', body)
	worksheet252.write('L22', 'SOS', body)
	worksheet252.write('M22', 'EKO', body)
	worksheet252.write('N22', 'JML', body)
	worksheet252.write('O22', 'MAT', body)
	worksheet252.write('P22', 'IND', body)
	worksheet252.write('Q22', 'ENG', body)
	worksheet252.write('R22', 'SEJ', body)
	worksheet252.write('S22', 'GEO', body)
	worksheet252.write('T22', 'SOS', body)
	worksheet252.write('U22', 'EKO', body)
	worksheet252.write('V22', 'JML', body)

	worksheet252.conditional_format(22,0,row252+21,21, 
	                             {'type': 'no_errors', 'format': border})
	# # worksheet 253
	...
	# worksheet253.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KAMPUNG UTAN', title)
	...
	# worksheet253.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet253.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet253.write('G5', 'MAT', body)
	# worksheet253.write('H5', 'IND', body)
	# worksheet253.write('I5', 'ENG', body)
	# worksheet253.write('J5', 'SEJ', body)
	# worksheet253.write('K5', 'GEO', body)
	# worksheet253.write('L5', 'SOS', body)
	# worksheet253.write('M5', 'EKO', body)
	# worksheet253.write('N5', 'JML', body)
	# worksheet253.write('O5', 'MAT', body)
	# worksheet253.write('P5', 'IND', body)
	# worksheet253.write('Q5', 'ENG', body)
	# worksheet253.write('R5', 'SEJ', body)
	# worksheet253.write('S5', 'GEO', body)
	# worksheet253.write('T5', 'SOS', body)
	# worksheet253.write('U5', 'EKO', body)
	# worksheet253.write('V5', 'JML', body)



	# worksheet253.conditional_format(5,0,row253_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet253.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KAMPUNG UTAN', title)
	# worksheet253.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet253.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	# worksheet253.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet253.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet253.write('K22', 'GEO', body)
	# worksheet253.write('L22', 'SOS', body)
	# worksheet253.write('M22', 'EKO', body)
	# worksheet253.write('N22', 'JML', body)
	# worksheet253.write('O22', 'MAT', body)
	# worksheet253.write('P22', 'IND', body)
	# worksheet253.write('Q22', 'ENG', body)
	# worksheet253.write('R22', 'SEJ', body)
	# worksheet253.write('S22', 'GEO', body)
	# worksheet253.write('T22', 'SOS', body)
	# worksheet253.write('U22', 'EKO', body)
	# worksheet253.write('V22', 'JML', body)

	# worksheet253.conditional_format(22,0,row253+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet254.set_column('G:V', 5, center)
	worksheet254.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GRAHA RAYA', title)
	worksheet254.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet254.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet254.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet254.write('G5', 'MAT', body)
	worksheet254.write('H5', 'IND', body)
	worksheet254.write('I5', 'ENG', body)
	worksheet254.write('J5', 'SEJ', body)
	worksheet254.write('K5', 'GEO', body)
	worksheet254.write('L5', 'SOS', body)
	worksheet254.write('M5', 'EKO', body)
	worksheet254.write('N5', 'JML', body)
	worksheet254.write('O5', 'MAT', body)
	worksheet254.write('P5', 'IND', body)
	worksheet254.write('Q5', 'ENG', body)
	worksheet254.write('R5', 'SEJ', body)
	worksheet254.write('S5', 'GEO', body)
	worksheet254.write('T5', 'SOS', body)
	worksheet254.write('U5', 'EKO', body)
	worksheet254.write('V5', 'JML', body)



	worksheet254.conditional_format(5,0,row254_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet254.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GRAHA RAYA', title)
	worksheet254.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet254.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet254.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet254.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet254.write('K22', 'GEO', body)
	worksheet254.write('L22', 'SOS', body)
	worksheet254.write('M22', 'EKO', body)
	worksheet254.write('N22', 'JML', body)
	worksheet254.write('O22', 'MAT', body)
	worksheet254.write('P22', 'IND', body)
	worksheet254.write('Q22', 'ENG', body)
	worksheet254.write('R22', 'SEJ', body)
	worksheet254.write('S22', 'GEO', body)
	worksheet254.write('T22', 'SOS', body)
	worksheet254.write('U22', 'EKO', body)
	worksheet254.write('V22', 'JML', body)

	worksheet254.conditional_format(22,0,row254+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet255.set_column('G:V', 5, center)
	worksheet255.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MERPATI', title)
	worksheet255.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet255.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet255.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet255.write('G5', 'MAT', body)
	worksheet255.write('H5', 'IND', body)
	worksheet255.write('I5', 'ENG', body)
	worksheet255.write('J5', 'SEJ', body)
	worksheet255.write('K5', 'GEO', body)
	worksheet255.write('L5', 'SOS', body)
	worksheet255.write('M5', 'EKO', body)
	worksheet255.write('N5', 'JML', body)
	worksheet255.write('O5', 'MAT', body)
	worksheet255.write('P5', 'IND', body)
	worksheet255.write('Q5', 'ENG', body)
	worksheet255.write('R5', 'SEJ', body)
	worksheet255.write('S5', 'GEO', body)
	worksheet255.write('T5', 'SOS', body)
	worksheet255.write('U5', 'EKO', body)
	worksheet255.write('V5', 'JML', body)



	worksheet255.conditional_format(5,0,row255_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet255.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MERPATI', title)
	worksheet255.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet255.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet255.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet255.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet255.write('K22', 'GEO', body)
	worksheet255.write('L22', 'SOS', body)
	worksheet255.write('M22', 'EKO', body)
	worksheet255.write('N22', 'JML', body)
	worksheet255.write('O22', 'MAT', body)
	worksheet255.write('P22', 'IND', body)
	worksheet255.write('Q22', 'ENG', body)
	worksheet255.write('R22', 'SEJ', body)
	worksheet255.write('S22', 'GEO', body)
	worksheet255.write('T22', 'SOS', body)
	worksheet255.write('U22', 'EKO', body)
	worksheet255.write('V22', 'JML', body)

	worksheet255.conditional_format(22,0,row255+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet256.set_column('G:V', 5, center)
	worksheet256.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIRUAS', title)
	worksheet256.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet256.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet256.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet256.write('G5', 'MAT', body)
	worksheet256.write('H5', 'IND', body)
	worksheet256.write('I5', 'ENG', body)
	worksheet256.write('J5', 'SEJ', body)
	worksheet256.write('K5', 'GEO', body)
	worksheet256.write('L5', 'SOS', body)
	worksheet256.write('M5', 'EKO', body)
	worksheet256.write('N5', 'JML', body)
	worksheet256.write('O5', 'MAT', body)
	worksheet256.write('P5', 'IND', body)
	worksheet256.write('Q5', 'ENG', body)
	worksheet256.write('R5', 'SEJ', body)
	worksheet256.write('S5', 'GEO', body)
	worksheet256.write('T5', 'SOS', body)
	worksheet256.write('U5', 'EKO', body)
	worksheet256.write('V5', 'JML', body)



	worksheet256.conditional_format(5,0,row256_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet256.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIRUAS', title)
	worksheet256.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet256.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet256.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet256.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet256.write('K22', 'GEO', body)
	worksheet256.write('L22', 'SOS', body)
	worksheet256.write('M22', 'EKO', body)
	worksheet256.write('N22', 'JML', body)
	worksheet256.write('O22', 'MAT', body)
	worksheet256.write('P22', 'IND', body)
	worksheet256.write('Q22', 'ENG', body)
	worksheet256.write('R22', 'SEJ', body)
	worksheet256.write('S22', 'GEO', body)
	worksheet256.write('T22', 'SOS', body)
	worksheet256.write('U22', 'EKO', body)
	worksheet256.write('V22', 'JML', body)

	worksheet256.conditional_format(22,0,row256+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet258.set_column('G:V', 5, center)
	worksheet258.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF LHOKSEUMAWE', title)
	worksheet258.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet258.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet258.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet258.write('G5', 'MAT', body)
	worksheet258.write('H5', 'IND', body)
	worksheet258.write('I5', 'ENG', body)
	worksheet258.write('J5', 'SEJ', body)
	worksheet258.write('K5', 'GEO', body)
	worksheet258.write('L5', 'SOS', body)
	worksheet258.write('M5', 'EKO', body)
	worksheet258.write('N5', 'JML', body)
	worksheet258.write('O5', 'MAT', body)
	worksheet258.write('P5', 'IND', body)
	worksheet258.write('Q5', 'ENG', body)
	worksheet258.write('R5', 'SEJ', body)
	worksheet258.write('S5', 'GEO', body)
	worksheet258.write('T5', 'SOS', body)
	worksheet258.write('U5', 'EKO', body)
	worksheet258.write('V5', 'JML', body)



	worksheet258.conditional_format(5,0,row258_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet258.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF LHOKSEUMAWE', title)
	worksheet258.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet258.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet258.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet258.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet258.write('K22', 'GEO', body)
	worksheet258.write('L22', 'SOS', body)
	worksheet258.write('M22', 'EKO', body)
	worksheet258.write('N22', 'JML', body)
	worksheet258.write('O22', 'MAT', body)
	worksheet258.write('P22', 'IND', body)
	worksheet258.write('Q22', 'ENG', body)
	worksheet258.write('R22', 'SEJ', body)
	worksheet258.write('S22', 'GEO', body)
	worksheet258.write('T22', 'SOS', body)
	worksheet258.write('U22', 'EKO', body)
	worksheet258.write('V22', 'JML', body)

	worksheet258.conditional_format(22,0,row258+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet259.set_column('G:V', 5, center)
	worksheet259.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PANAM, PKU', title)
	worksheet259.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet259.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet259.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet259.write('G5', 'MAT', body)
	worksheet259.write('H5', 'IND', body)
	worksheet259.write('I5', 'ENG', body)
	worksheet259.write('J5', 'SEJ', body)
	worksheet259.write('K5', 'GEO', body)
	worksheet259.write('L5', 'SOS', body)
	worksheet259.write('M5', 'EKO', body)
	worksheet259.write('N5', 'JML', body)
	worksheet259.write('O5', 'MAT', body)
	worksheet259.write('P5', 'IND', body)
	worksheet259.write('Q5', 'ENG', body)
	worksheet259.write('R5', 'SEJ', body)
	worksheet259.write('S5', 'GEO', body)
	worksheet259.write('T5', 'SOS', body)
	worksheet259.write('U5', 'EKO', body)
	worksheet259.write('V5', 'JML', body)



	worksheet259.conditional_format(5,0,row259_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet259.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PANAM, PKU', title)
	worksheet259.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet259.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet259.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet259.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet259.write('K22', 'GEO', body)
	worksheet259.write('L22', 'SOS', body)
	worksheet259.write('M22', 'EKO', body)
	worksheet259.write('N22', 'JML', body)
	worksheet259.write('O22', 'MAT', body)
	worksheet259.write('P22', 'IND', body)
	worksheet259.write('Q22', 'ENG', body)
	worksheet259.write('R22', 'SEJ', body)
	worksheet259.write('S22', 'GEO', body)
	worksheet259.write('T22', 'SOS', body)
	worksheet259.write('U22', 'EKO', body)
	worksheet259.write('V22', 'JML', body)

	worksheet259.conditional_format(22,0,row259+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet260.set_column('G:V', 5, center)
	worksheet260.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF AM. SANGAJI', title)
	worksheet260.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet260.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet260.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet260.write('G5', 'MAT', body)
	worksheet260.write('H5', 'IND', body)
	worksheet260.write('I5', 'ENG', body)
	worksheet260.write('J5', 'SEJ', body)
	worksheet260.write('K5', 'GEO', body)
	worksheet260.write('L5', 'SOS', body)
	worksheet260.write('M5', 'EKO', body)
	worksheet260.write('N5', 'JML', body)
	worksheet260.write('O5', 'MAT', body)
	worksheet260.write('P5', 'IND', body)
	worksheet260.write('Q5', 'ENG', body)
	worksheet260.write('R5', 'SEJ', body)
	worksheet260.write('S5', 'GEO', body)
	worksheet260.write('T5', 'SOS', body)
	worksheet260.write('U5', 'EKO', body)
	worksheet260.write('V5', 'JML', body)



	worksheet260.conditional_format(5,0,row260_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet260.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF AM. SANGAJI', title)
	worksheet260.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet260.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet260.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet260.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet260.write('K22', 'GEO', body)
	worksheet260.write('L22', 'SOS', body)
	worksheet260.write('M22', 'EKO', body)
	worksheet260.write('N22', 'JML', body)
	worksheet260.write('O22', 'MAT', body)
	worksheet260.write('P22', 'IND', body)
	worksheet260.write('Q22', 'ENG', body)
	worksheet260.write('R22', 'SEJ', body)
	worksheet260.write('S22', 'GEO', body)
	worksheet260.write('T22', 'SOS', body)
	worksheet260.write('U22', 'EKO', body)
	worksheet260.write('V22', 'JML', body)

	worksheet260.conditional_format(22,0,row260+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet261.set_column('G:V', 5, center)
	worksheet261.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF DURI KOSAMBI', title)
	worksheet261.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet261.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet261.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet261.write('G5', 'MAT', body)
	worksheet261.write('H5', 'IND', body)
	worksheet261.write('I5', 'ENG', body)
	worksheet261.write('J5', 'SEJ', body)
	worksheet261.write('K5', 'GEO', body)
	worksheet261.write('L5', 'SOS', body)
	worksheet261.write('M5', 'EKO', body)
	worksheet261.write('N5', 'JML', body)
	worksheet261.write('O5', 'MAT', body)
	worksheet261.write('P5', 'IND', body)
	worksheet261.write('Q5', 'ENG', body)
	worksheet261.write('R5', 'SEJ', body)
	worksheet261.write('S5', 'GEO', body)
	worksheet261.write('T5', 'SOS', body)
	worksheet261.write('U5', 'EKO', body)
	worksheet261.write('V5', 'JML', body)



	worksheet261.conditional_format(5,0,row261_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet261.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF DURI KOSAMBI', title)
	worksheet261.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet261.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet261.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet261.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet261.write('K22', 'GEO', body)
	worksheet261.write('L22', 'SOS', body)
	worksheet261.write('M22', 'EKO', body)
	worksheet261.write('N22', 'JML', body)
	worksheet261.write('O22', 'MAT', body)
	worksheet261.write('P22', 'IND', body)
	worksheet261.write('Q22', 'ENG', body)
	worksheet261.write('R22', 'SEJ', body)
	worksheet261.write('S22', 'GEO', body)
	worksheet261.write('T22', 'SOS', body)
	worksheet261.write('U22', 'EKO', body)
	worksheet261.write('V22', 'JML', body)

	worksheet261.conditional_format(22,0,row261+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet262.set_column('G:V', 5, center)
	worksheet262.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CITRA RAYA CIKUPA', title)
	worksheet262.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet262.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet262.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet262.write('G5', 'MAT', body)
	worksheet262.write('H5', 'IND', body)
	worksheet262.write('I5', 'ENG', body)
	worksheet262.write('J5', 'SEJ', body)
	worksheet262.write('K5', 'GEO', body)
	worksheet262.write('L5', 'SOS', body)
	worksheet262.write('M5', 'EKO', body)
	worksheet262.write('N5', 'JML', body)
	worksheet262.write('O5', 'MAT', body)
	worksheet262.write('P5', 'IND', body)
	worksheet262.write('Q5', 'ENG', body)
	worksheet262.write('R5', 'SEJ', body)
	worksheet262.write('S5', 'GEO', body)
	worksheet262.write('T5', 'SOS', body)
	worksheet262.write('U5', 'EKO', body)
	worksheet262.write('V5', 'JML', body)



	worksheet262.conditional_format(5,0,row262_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet262.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CITRA RAYA CIKUPA', title)
	worksheet262.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet262.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet262.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet262.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet262.write('K22', 'GEO', body)
	worksheet262.write('L22', 'SOS', body)
	worksheet262.write('M22', 'EKO', body)
	worksheet262.write('N22', 'JML', body)
	worksheet262.write('O22', 'MAT', body)
	worksheet262.write('P22', 'IND', body)
	worksheet262.write('Q22', 'ENG', body)
	worksheet262.write('R22', 'SEJ', body)
	worksheet262.write('S22', 'GEO', body)
	worksheet262.write('T22', 'SOS', body)
	worksheet262.write('U22', 'EKO', body)
	worksheet262.write('V22', 'JML', body)

	worksheet262.conditional_format(22,0,row262+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet263.set_column('G:V', 5, center)
	worksheet263.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GRAHA PRIMA', title)
	worksheet263.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet263.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet263.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet263.write('G5', 'MAT', body)
	worksheet263.write('H5', 'IND', body)
	worksheet263.write('I5', 'ENG', body)
	worksheet263.write('J5', 'SEJ', body)
	worksheet263.write('K5', 'GEO', body)
	worksheet263.write('L5', 'SOS', body)
	worksheet263.write('M5', 'EKO', body)
	worksheet263.write('N5', 'JML', body)
	worksheet263.write('O5', 'MAT', body)
	worksheet263.write('P5', 'IND', body)
	worksheet263.write('Q5', 'ENG', body)
	worksheet263.write('R5', 'SEJ', body)
	worksheet263.write('S5', 'GEO', body)
	worksheet263.write('T5', 'SOS', body)
	worksheet263.write('U5', 'EKO', body)
	worksheet263.write('V5', 'JML', body)



	worksheet263.conditional_format(5,0,row263_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet263.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GRAHA PRIMA', title)
	worksheet263.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet263.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet263.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet263.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet263.write('K22', 'GEO', body)
	worksheet263.write('L22', 'SOS', body)
	worksheet263.write('M22', 'EKO', body)
	worksheet263.write('N22', 'JML', body)
	worksheet263.write('O22', 'MAT', body)
	worksheet263.write('P22', 'IND', body)
	worksheet263.write('Q22', 'ENG', body)
	worksheet263.write('R22', 'SEJ', body)
	worksheet263.write('S22', 'GEO', body)
	worksheet263.write('T22', 'SOS', body)
	worksheet263.write('U22', 'EKO', body)
	worksheet263.write('V22', 'JML', body)

	worksheet263.conditional_format(22,0,row263+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet264.set_column('G:V', 5, center)
	worksheet264.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KARAWANG', title)
	worksheet264.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet264.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet264.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet264.write('G5', 'MAT', body)
	worksheet264.write('H5', 'IND', body)
	worksheet264.write('I5', 'ENG', body)
	worksheet264.write('J5', 'SEJ', body)
	worksheet264.write('K5', 'GEO', body)
	worksheet264.write('L5', 'SOS', body)
	worksheet264.write('M5', 'EKO', body)
	worksheet264.write('N5', 'JML', body)
	worksheet264.write('O5', 'MAT', body)
	worksheet264.write('P5', 'IND', body)
	worksheet264.write('Q5', 'ENG', body)
	worksheet264.write('R5', 'SEJ', body)
	worksheet264.write('S5', 'GEO', body)
	worksheet264.write('T5', 'SOS', body)
	worksheet264.write('U5', 'EKO', body)
	worksheet264.write('V5', 'JML', body)



	worksheet264.conditional_format(5,0,row264_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet264.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KARAWANG', title)
	worksheet264.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet264.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet264.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet264.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet264.write('K22', 'GEO', body)
	worksheet264.write('L22', 'SOS', body)
	worksheet264.write('M22', 'EKO', body)
	worksheet264.write('N22', 'JML', body)
	worksheet264.write('O22', 'MAT', body)
	worksheet264.write('P22', 'IND', body)
	worksheet264.write('Q22', 'ENG', body)
	worksheet264.write('R22', 'SEJ', body)
	worksheet264.write('S22', 'GEO', body)
	worksheet264.write('T22', 'SOS', body)
	worksheet264.write('U22', 'EKO', body)
	worksheet264.write('V22', 'JML', body)

	worksheet264.conditional_format(22,0,row264+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet265.set_column('G:V', 5, center)
	worksheet265.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TAMAN WISMA ASRI', title)
	worksheet265.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet265.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet265.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet265.write('G5', 'MAT', body)
	worksheet265.write('H5', 'IND', body)
	worksheet265.write('I5', 'ENG', body)
	worksheet265.write('J5', 'SEJ', body)
	worksheet265.write('K5', 'GEO', body)
	worksheet265.write('L5', 'SOS', body)
	worksheet265.write('M5', 'EKO', body)
	worksheet265.write('N5', 'JML', body)
	worksheet265.write('O5', 'MAT', body)
	worksheet265.write('P5', 'IND', body)
	worksheet265.write('Q5', 'ENG', body)
	worksheet265.write('R5', 'SEJ', body)
	worksheet265.write('S5', 'GEO', body)
	worksheet265.write('T5', 'SOS', body)
	worksheet265.write('U5', 'EKO', body)
	worksheet265.write('V5', 'JML', body)



	worksheet265.conditional_format(5,0,row265_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet265.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TAMAN WISMA ASRI', title)
	worksheet265.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet265.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet265.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet265.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet265.write('K22', 'GEO', body)
	worksheet265.write('L22', 'SOS', body)
	worksheet265.write('M22', 'EKO', body)
	worksheet265.write('N22', 'JML', body)
	worksheet265.write('O22', 'MAT', body)
	worksheet265.write('P22', 'IND', body)
	worksheet265.write('Q22', 'ENG', body)
	worksheet265.write('R22', 'SEJ', body)
	worksheet265.write('S22', 'GEO', body)
	worksheet265.write('T22', 'SOS', body)
	worksheet265.write('U22', 'EKO', body)
	worksheet265.write('V22', 'JML', body)

	worksheet265.conditional_format(22,0,row265+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet266.set_column('G:V', 5, center)
	worksheet266.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MANGUN JAYA', title)
	worksheet266.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet266.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet266.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet266.write('G5', 'MAT', body)
	worksheet266.write('H5', 'IND', body)
	worksheet266.write('I5', 'ENG', body)
	worksheet266.write('J5', 'SEJ', body)
	worksheet266.write('K5', 'GEO', body)
	worksheet266.write('L5', 'SOS', body)
	worksheet266.write('M5', 'EKO', body)
	worksheet266.write('N5', 'JML', body)
	worksheet266.write('O5', 'MAT', body)
	worksheet266.write('P5', 'IND', body)
	worksheet266.write('Q5', 'ENG', body)
	worksheet266.write('R5', 'SEJ', body)
	worksheet266.write('S5', 'GEO', body)
	worksheet266.write('T5', 'SOS', body)
	worksheet266.write('U5', 'EKO', body)
	worksheet266.write('V5', 'JML', body)



	worksheet266.conditional_format(5,0,row266_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet266.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MANGUN JAYA', title)
	worksheet266.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet266.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet266.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet266.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet266.write('K22', 'GEO', body)
	worksheet266.write('L22', 'SOS', body)
	worksheet266.write('M22', 'EKO', body)
	worksheet266.write('N22', 'JML', body)
	worksheet266.write('O22', 'MAT', body)
	worksheet266.write('P22', 'IND', body)
	worksheet266.write('Q22', 'ENG', body)
	worksheet266.write('R22', 'SEJ', body)
	worksheet266.write('S22', 'GEO', body)
	worksheet266.write('T22', 'SOS', body)
	worksheet266.write('U22', 'EKO', body)
	worksheet266.write('V22', 'JML', body)

	worksheet266.conditional_format(22,0,row266+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet267.set_column('G:V', 5, center)
	worksheet267.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MARAKASH / SEKTOR 5', title)
	worksheet267.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet267.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet267.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet267.write('G5', 'MAT', body)
	worksheet267.write('H5', 'IND', body)
	worksheet267.write('I5', 'ENG', body)
	worksheet267.write('J5', 'SEJ', body)
	worksheet267.write('K5', 'GEO', body)
	worksheet267.write('L5', 'SOS', body)
	worksheet267.write('M5', 'EKO', body)
	worksheet267.write('N5', 'JML', body)
	worksheet267.write('O5', 'MAT', body)
	worksheet267.write('P5', 'IND', body)
	worksheet267.write('Q5', 'ENG', body)
	worksheet267.write('R5', 'SEJ', body)
	worksheet267.write('S5', 'GEO', body)
	worksheet267.write('T5', 'SOS', body)
	worksheet267.write('U5', 'EKO', body)
	worksheet267.write('V5', 'JML', body)



	worksheet267.conditional_format(5,0,row267_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet267.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MARAKASH / SEKTOR 5', title)
	worksheet267.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet267.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet267.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet267.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet267.write('K22', 'GEO', body)
	worksheet267.write('L22', 'SOS', body)
	worksheet267.write('M22', 'EKO', body)
	worksheet267.write('N22', 'JML', body)
	worksheet267.write('O22', 'MAT', body)
	worksheet267.write('P22', 'IND', body)
	worksheet267.write('Q22', 'ENG', body)
	worksheet267.write('R22', 'SEJ', body)
	worksheet267.write('S22', 'GEO', body)
	worksheet267.write('T22', 'SOS', body)
	worksheet267.write('U22', 'EKO', body)
	worksheet267.write('V22', 'JML', body)

	worksheet267.conditional_format(22,0,row267+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet268.set_column('G:V', 5, center)
	worksheet268.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KEBALEN', title)
	worksheet268.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet268.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet268.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet268.write('G5', 'MAT', body)
	worksheet268.write('H5', 'IND', body)
	worksheet268.write('I5', 'ENG', body)
	worksheet268.write('J5', 'SEJ', body)
	worksheet268.write('K5', 'GEO', body)
	worksheet268.write('L5', 'SOS', body)
	worksheet268.write('M5', 'EKO', body)
	worksheet268.write('N5', 'JML', body)
	worksheet268.write('O5', 'MAT', body)
	worksheet268.write('P5', 'IND', body)
	worksheet268.write('Q5', 'ENG', body)
	worksheet268.write('R5', 'SEJ', body)
	worksheet268.write('S5', 'GEO', body)
	worksheet268.write('T5', 'SOS', body)
	worksheet268.write('U5', 'EKO', body)
	worksheet268.write('V5', 'JML', body)



	worksheet268.conditional_format(5,0,row268_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet268.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KEBALEN', title)
	worksheet268.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet268.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet268.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet268.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet268.write('K22', 'GEO', body)
	worksheet268.write('L22', 'SOS', body)
	worksheet268.write('M22', 'EKO', body)
	worksheet268.write('N22', 'JML', body)
	worksheet268.write('O22', 'MAT', body)
	worksheet268.write('P22', 'IND', body)
	worksheet268.write('Q22', 'ENG', body)
	worksheet268.write('R22', 'SEJ', body)
	worksheet268.write('S22', 'GEO', body)
	worksheet268.write('T22', 'SOS', body)
	worksheet268.write('U22', 'EKO', body)
	worksheet268.write('V22', 'JML', body)

	worksheet268.conditional_format(22,0,row268+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet269.set_column('G:V', 5, center)
	worksheet269.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JATI RANGON', title)
	worksheet269.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet269.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet269.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet269.write('G5', 'MAT', body)
	worksheet269.write('H5', 'IND', body)
	worksheet269.write('I5', 'ENG', body)
	worksheet269.write('J5', 'SEJ', body)
	worksheet269.write('K5', 'GEO', body)
	worksheet269.write('L5', 'SOS', body)
	worksheet269.write('M5', 'EKO', body)
	worksheet269.write('N5', 'JML', body)
	worksheet269.write('O5', 'MAT', body)
	worksheet269.write('P5', 'IND', body)
	worksheet269.write('Q5', 'ENG', body)
	worksheet269.write('R5', 'SEJ', body)
	worksheet269.write('S5', 'GEO', body)
	worksheet269.write('T5', 'SOS', body)
	worksheet269.write('U5', 'EKO', body)
	worksheet269.write('V5', 'JML', body)



	worksheet269.conditional_format(5,0,row269_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet269.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JATI RANGON', title)
	worksheet269.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet269.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet269.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet269.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet269.write('K22', 'GEO', body)
	worksheet269.write('L22', 'SOS', body)
	worksheet269.write('M22', 'EKO', body)
	worksheet269.write('N22', 'JML', body)
	worksheet269.write('O22', 'MAT', body)
	worksheet269.write('P22', 'IND', body)
	worksheet269.write('Q22', 'ENG', body)
	worksheet269.write('R22', 'SEJ', body)
	worksheet269.write('S22', 'GEO', body)
	worksheet269.write('T22', 'SOS', body)
	worksheet269.write('U22', 'EKO', body)
	worksheet269.write('V22', 'JML', body)

	worksheet269.conditional_format(22,0,row269+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet270.set_column('G:V', 5, center)
	worksheet270.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JATIBENING', title)
	worksheet270.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet270.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet270.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet270.write('G5', 'MAT', body)
	worksheet270.write('H5', 'IND', body)
	worksheet270.write('I5', 'ENG', body)
	worksheet270.write('J5', 'SEJ', body)
	worksheet270.write('K5', 'GEO', body)
	worksheet270.write('L5', 'SOS', body)
	worksheet270.write('M5', 'EKO', body)
	worksheet270.write('N5', 'JML', body)
	worksheet270.write('O5', 'MAT', body)
	worksheet270.write('P5', 'IND', body)
	worksheet270.write('Q5', 'ENG', body)
	worksheet270.write('R5', 'SEJ', body)
	worksheet270.write('S5', 'GEO', body)
	worksheet270.write('T5', 'SOS', body)
	worksheet270.write('U5', 'EKO', body)
	worksheet270.write('V5', 'JML', body)



	worksheet270.conditional_format(5,0,row270_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet270.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JATIBENING', title)
	worksheet270.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet270.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet270.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet270.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet270.write('K22', 'GEO', body)
	worksheet270.write('L22', 'SOS', body)
	worksheet270.write('M22', 'EKO', body)
	worksheet270.write('N22', 'JML', body)
	worksheet270.write('O22', 'MAT', body)
	worksheet270.write('P22', 'IND', body)
	worksheet270.write('Q22', 'ENG', body)
	worksheet270.write('R22', 'SEJ', body)
	worksheet270.write('S22', 'GEO', body)
	worksheet270.write('T22', 'SOS', body)
	worksheet270.write('U22', 'EKO', body)
	worksheet270.write('V22', 'JML', body)

	worksheet270.conditional_format(22,0,row270+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet271.set_column('G:V', 5, center)
	worksheet271.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JATIMULYA', title)
	worksheet271.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet271.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet271.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet271.write('G5', 'MAT', body)
	worksheet271.write('H5', 'IND', body)
	worksheet271.write('I5', 'ENG', body)
	worksheet271.write('J5', 'SEJ', body)
	worksheet271.write('K5', 'GEO', body)
	worksheet271.write('L5', 'SOS', body)
	worksheet271.write('M5', 'EKO', body)
	worksheet271.write('N5', 'JML', body)
	worksheet271.write('O5', 'MAT', body)
	worksheet271.write('P5', 'IND', body)
	worksheet271.write('Q5', 'ENG', body)
	worksheet271.write('R5', 'SEJ', body)
	worksheet271.write('S5', 'GEO', body)
	worksheet271.write('T5', 'SOS', body)
	worksheet271.write('U5', 'EKO', body)
	worksheet271.write('V5', 'JML', body)



	worksheet271.conditional_format(5,0,row271_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet271.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JATIMULYA', title)
	worksheet271.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet271.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet271.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet271.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet271.write('K22', 'GEO', body)
	worksheet271.write('L22', 'SOS', body)
	worksheet271.write('M22', 'EKO', body)
	worksheet271.write('N22', 'JML', body)
	worksheet271.write('O22', 'MAT', body)
	worksheet271.write('P22', 'IND', body)
	worksheet271.write('Q22', 'ENG', body)
	worksheet271.write('R22', 'SEJ', body)
	worksheet271.write('S22', 'GEO', body)
	worksheet271.write('T22', 'SOS', body)
	worksheet271.write('U22', 'EKO', body)
	worksheet271.write('V22', 'JML', body)

	worksheet271.conditional_format(22,0,row271+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet272.set_column('G:V', 5, center)
	worksheet272.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PERUMNAS 3', title)
	worksheet272.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet272.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet272.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet272.write('G5', 'MAT', body)
	worksheet272.write('H5', 'IND', body)
	worksheet272.write('I5', 'ENG', body)
	worksheet272.write('J5', 'SEJ', body)
	worksheet272.write('K5', 'GEO', body)
	worksheet272.write('L5', 'SOS', body)
	worksheet272.write('M5', 'EKO', body)
	worksheet272.write('N5', 'JML', body)
	worksheet272.write('O5', 'MAT', body)
	worksheet272.write('P5', 'IND', body)
	worksheet272.write('Q5', 'ENG', body)
	worksheet272.write('R5', 'SEJ', body)
	worksheet272.write('S5', 'GEO', body)
	worksheet272.write('T5', 'SOS', body)
	worksheet272.write('U5', 'EKO', body)
	worksheet272.write('V5', 'JML', body)



	worksheet272.conditional_format(5,0,row272_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet272.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PERUMNAS 3', title)
	worksheet272.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet272.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet272.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet272.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet272.write('K22', 'GEO', body)
	worksheet272.write('L22', 'SOS', body)
	worksheet272.write('M22', 'EKO', body)
	worksheet272.write('N22', 'JML', body)
	worksheet272.write('O22', 'MAT', body)
	worksheet272.write('P22', 'IND', body)
	worksheet272.write('Q22', 'ENG', body)
	worksheet272.write('R22', 'SEJ', body)
	worksheet272.write('S22', 'GEO', body)
	worksheet272.write('T22', 'SOS', body)
	worksheet272.write('U22', 'EKO', body)
	worksheet272.write('V22', 'JML', body)

	worksheet272.conditional_format(22,0,row272+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet273.set_column('G:V', 5, center)
	worksheet273.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF NAROGONG', title)
	worksheet273.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet273.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet273.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet273.write('G5', 'MAT', body)
	worksheet273.write('H5', 'IND', body)
	worksheet273.write('I5', 'ENG', body)
	worksheet273.write('J5', 'SEJ', body)
	worksheet273.write('K5', 'GEO', body)
	worksheet273.write('L5', 'SOS', body)
	worksheet273.write('M5', 'EKO', body)
	worksheet273.write('N5', 'JML', body)
	worksheet273.write('O5', 'MAT', body)
	worksheet273.write('P5', 'IND', body)
	worksheet273.write('Q5', 'ENG', body)
	worksheet273.write('R5', 'SEJ', body)
	worksheet273.write('S5', 'GEO', body)
	worksheet273.write('T5', 'SOS', body)
	worksheet273.write('U5', 'EKO', body)
	worksheet273.write('V5', 'JML', body)



	worksheet273.conditional_format(5,0,row273_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet273.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF NAROGONG', title)
	worksheet273.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet273.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet273.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet273.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet273.write('K22', 'GEO', body)
	worksheet273.write('L22', 'SOS', body)
	worksheet273.write('M22', 'EKO', body)
	worksheet273.write('N22', 'JML', body)
	worksheet273.write('O22', 'MAT', body)
	worksheet273.write('P22', 'IND', body)
	worksheet273.write('Q22', 'ENG', body)
	worksheet273.write('R22', 'SEJ', body)
	worksheet273.write('S22', 'GEO', body)
	worksheet273.write('T22', 'SOS', body)
	worksheet273.write('U22', 'EKO', body)
	worksheet273.write('V22', 'JML', body)

	worksheet273.conditional_format(22,0,row273+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet274.set_column('G:V', 5, center)
	worksheet274.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BEKASI TIMUR REGENCY', title)
	worksheet274.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet274.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet274.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet274.write('G5', 'MAT', body)
	worksheet274.write('H5', 'IND', body)
	worksheet274.write('I5', 'ENG', body)
	worksheet274.write('J5', 'SEJ', body)
	worksheet274.write('K5', 'GEO', body)
	worksheet274.write('L5', 'SOS', body)
	worksheet274.write('M5', 'EKO', body)
	worksheet274.write('N5', 'JML', body)
	worksheet274.write('O5', 'MAT', body)
	worksheet274.write('P5', 'IND', body)
	worksheet274.write('Q5', 'ENG', body)
	worksheet274.write('R5', 'SEJ', body)
	worksheet274.write('S5', 'GEO', body)
	worksheet274.write('T5', 'SOS', body)
	worksheet274.write('U5', 'EKO', body)
	worksheet274.write('V5', 'JML', body)



	worksheet274.conditional_format(5,0,row274_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet274.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BEKASI TIMUR REGENCY', title)
	worksheet274.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet274.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet274.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet274.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet274.write('K22', 'GEO', body)
	worksheet274.write('L22', 'SOS', body)
	worksheet274.write('M22', 'EKO', body)
	worksheet274.write('N22', 'JML', body)
	worksheet274.write('O22', 'MAT', body)
	worksheet274.write('P22', 'IND', body)
	worksheet274.write('Q22', 'ENG', body)
	worksheet274.write('R22', 'SEJ', body)
	worksheet274.write('S22', 'GEO', body)
	worksheet274.write('T22', 'SOS', body)
	worksheet274.write('U22', 'EKO', body)
	worksheet274.write('V22', 'JML', body)

	worksheet274.conditional_format(22,0,row274+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet275.set_column('G:V', 5, center)
	worksheet275.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIKARANG PILAR', title)
	worksheet275.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet275.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet275.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet275.write('G5', 'MAT', body)
	worksheet275.write('H5', 'IND', body)
	worksheet275.write('I5', 'ENG', body)
	worksheet275.write('J5', 'SEJ', body)
	worksheet275.write('K5', 'GEO', body)
	worksheet275.write('L5', 'SOS', body)
	worksheet275.write('M5', 'EKO', body)
	worksheet275.write('N5', 'JML', body)
	worksheet275.write('O5', 'MAT', body)
	worksheet275.write('P5', 'IND', body)
	worksheet275.write('Q5', 'ENG', body)
	worksheet275.write('R5', 'SEJ', body)
	worksheet275.write('S5', 'GEO', body)
	worksheet275.write('T5', 'SOS', body)
	worksheet275.write('U5', 'EKO', body)
	worksheet275.write('V5', 'JML', body)



	worksheet275.conditional_format(5,0,row275_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet275.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIKARANG PILAR', title)
	worksheet275.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet275.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet275.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet275.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet275.write('K22', 'GEO', body)
	worksheet275.write('L22', 'SOS', body)
	worksheet275.write('M22', 'EKO', body)
	worksheet275.write('N22', 'JML', body)
	worksheet275.write('O22', 'MAT', body)
	worksheet275.write('P22', 'IND', body)
	worksheet275.write('Q22', 'ENG', body)
	worksheet275.write('R22', 'SEJ', body)
	worksheet275.write('S22', 'GEO', body)
	worksheet275.write('T22', 'SOS', body)
	worksheet275.write('U22', 'EKO', body)
	worksheet275.write('V22', 'JML', body)

	worksheet275.conditional_format(22,0,row275+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet276.set_column('G:V', 5, center)
	worksheet276.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIKARANG JABABEKA', title)
	worksheet276.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet276.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet276.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet276.write('G5', 'MAT', body)
	worksheet276.write('H5', 'IND', body)
	worksheet276.write('I5', 'ENG', body)
	worksheet276.write('J5', 'SEJ', body)
	worksheet276.write('K5', 'GEO', body)
	worksheet276.write('L5', 'SOS', body)
	worksheet276.write('M5', 'EKO', body)
	worksheet276.write('N5', 'JML', body)
	worksheet276.write('O5', 'MAT', body)
	worksheet276.write('P5', 'IND', body)
	worksheet276.write('Q5', 'ENG', body)
	worksheet276.write('R5', 'SEJ', body)
	worksheet276.write('S5', 'GEO', body)
	worksheet276.write('T5', 'SOS', body)
	worksheet276.write('U5', 'EKO', body)
	worksheet276.write('V5', 'JML', body)



	worksheet276.conditional_format(5,0,row276_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet276.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIKARANG JABABEKA', title)
	worksheet276.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet276.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet276.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet276.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet276.write('K22', 'GEO', body)
	worksheet276.write('L22', 'SOS', body)
	worksheet276.write('M22', 'EKO', body)
	worksheet276.write('N22', 'JML', body)
	worksheet276.write('O22', 'MAT', body)
	worksheet276.write('P22', 'IND', body)
	worksheet276.write('Q22', 'ENG', body)
	worksheet276.write('R22', 'SEJ', body)
	worksheet276.write('S22', 'GEO', body)
	worksheet276.write('T22', 'SOS', body)
	worksheet276.write('U22', 'EKO', body)
	worksheet276.write('V22', 'JML', body)

	worksheet276.conditional_format(22,0,row276+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet277.set_column('G:V', 5, center)
	worksheet277.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PAYAKUMBUH', title)
	worksheet277.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet277.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet277.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet277.write('G5', 'MAT', body)
	worksheet277.write('H5', 'IND', body)
	worksheet277.write('I5', 'ENG', body)
	worksheet277.write('J5', 'SEJ', body)
	worksheet277.write('K5', 'GEO', body)
	worksheet277.write('L5', 'SOS', body)
	worksheet277.write('M5', 'EKO', body)
	worksheet277.write('N5', 'JML', body)
	worksheet277.write('O5', 'MAT', body)
	worksheet277.write('P5', 'IND', body)
	worksheet277.write('Q5', 'ENG', body)
	worksheet277.write('R5', 'SEJ', body)
	worksheet277.write('S5', 'GEO', body)
	worksheet277.write('T5', 'SOS', body)
	worksheet277.write('U5', 'EKO', body)
	worksheet277.write('V5', 'JML', body)



	worksheet277.conditional_format(5,0,row277_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet277.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PAYAKUMBUH', title)
	worksheet277.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet277.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet277.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet277.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet277.write('K22', 'GEO', body)
	worksheet277.write('L22', 'SOS', body)
	worksheet277.write('M22', 'EKO', body)
	worksheet277.write('N22', 'JML', body)
	worksheet277.write('O22', 'MAT', body)
	worksheet277.write('P22', 'IND', body)
	worksheet277.write('Q22', 'ENG', body)
	worksheet277.write('R22', 'SEJ', body)
	worksheet277.write('S22', 'GEO', body)
	worksheet277.write('T22', 'SOS', body)
	worksheet277.write('U22', 'EKO', body)
	worksheet277.write('V22', 'JML', body)

	worksheet277.conditional_format(22,0,row277+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet278.set_column('G:V', 5, center)
	worksheet278.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MERDUATI', title)
	worksheet278.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet278.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet278.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet278.write('G5', 'MAT', body)
	worksheet278.write('H5', 'IND', body)
	worksheet278.write('I5', 'ENG', body)
	worksheet278.write('J5', 'SEJ', body)
	worksheet278.write('K5', 'GEO', body)
	worksheet278.write('L5', 'SOS', body)
	worksheet278.write('M5', 'EKO', body)
	worksheet278.write('N5', 'JML', body)
	worksheet278.write('O5', 'MAT', body)
	worksheet278.write('P5', 'IND', body)
	worksheet278.write('Q5', 'ENG', body)
	worksheet278.write('R5', 'SEJ', body)
	worksheet278.write('S5', 'GEO', body)
	worksheet278.write('T5', 'SOS', body)
	worksheet278.write('U5', 'EKO', body)
	worksheet278.write('V5', 'JML', body)



	worksheet278.conditional_format(5,0,row278_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet278.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MERDUATI', title)
	worksheet278.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet278.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet278.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet278.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet278.write('K22', 'GEO', body)
	worksheet278.write('L22', 'SOS', body)
	worksheet278.write('M22', 'EKO', body)
	worksheet278.write('N22', 'JML', body)
	worksheet278.write('O22', 'MAT', body)
	worksheet278.write('P22', 'IND', body)
	worksheet278.write('Q22', 'ENG', body)
	worksheet278.write('R22', 'SEJ', body)
	worksheet278.write('S22', 'GEO', body)
	worksheet278.write('T22', 'SOS', body)
	worksheet278.write('U22', 'EKO', body)
	worksheet278.write('V22', 'JML', body)

	worksheet278.conditional_format(22,0,row278+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet279.set_column('G:V', 5, center)
	worksheet279.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF ANTAPANI', title)
	worksheet279.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet279.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet279.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet279.write('G5', 'MAT', body)
	worksheet279.write('H5', 'IND', body)
	worksheet279.write('I5', 'ENG', body)
	worksheet279.write('J5', 'SEJ', body)
	worksheet279.write('K5', 'GEO', body)
	worksheet279.write('L5', 'SOS', body)
	worksheet279.write('M5', 'EKO', body)
	worksheet279.write('N5', 'JML', body)
	worksheet279.write('O5', 'MAT', body)
	worksheet279.write('P5', 'IND', body)
	worksheet279.write('Q5', 'ENG', body)
	worksheet279.write('R5', 'SEJ', body)
	worksheet279.write('S5', 'GEO', body)
	worksheet279.write('T5', 'SOS', body)
	worksheet279.write('U5', 'EKO', body)
	worksheet279.write('V5', 'JML', body)



	worksheet279.conditional_format(5,0,row279_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet279.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF ANTAPANI', title)
	worksheet279.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet279.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet279.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet279.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet279.write('K22', 'GEO', body)
	worksheet279.write('L22', 'SOS', body)
	worksheet279.write('M22', 'EKO', body)
	worksheet279.write('N22', 'JML', body)
	worksheet279.write('O22', 'MAT', body)
	worksheet279.write('P22', 'IND', body)
	worksheet279.write('Q22', 'ENG', body)
	worksheet279.write('R22', 'SEJ', body)
	worksheet279.write('S22', 'GEO', body)
	worksheet279.write('T22', 'SOS', body)
	worksheet279.write('U22', 'EKO', body)
	worksheet279.write('V22', 'JML', body)

	worksheet279.conditional_format(22,0,row279+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet280.set_column('G:V', 5, center)
	worksheet280.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MARGAHAYU', title)
	worksheet280.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet280.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet280.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet280.write('G5', 'MAT', body)
	worksheet280.write('H5', 'IND', body)
	worksheet280.write('I5', 'ENG', body)
	worksheet280.write('J5', 'SEJ', body)
	worksheet280.write('K5', 'GEO', body)
	worksheet280.write('L5', 'SOS', body)
	worksheet280.write('M5', 'EKO', body)
	worksheet280.write('N5', 'JML', body)
	worksheet280.write('O5', 'MAT', body)
	worksheet280.write('P5', 'IND', body)
	worksheet280.write('Q5', 'ENG', body)
	worksheet280.write('R5', 'SEJ', body)
	worksheet280.write('S5', 'GEO', body)
	worksheet280.write('T5', 'SOS', body)
	worksheet280.write('U5', 'EKO', body)
	worksheet280.write('V5', 'JML', body)



	worksheet280.conditional_format(5,0,row280_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet280.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MARGAHAYU', title)
	worksheet280.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet280.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet280.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet280.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet280.write('K22', 'GEO', body)
	worksheet280.write('L22', 'SOS', body)
	worksheet280.write('M22', 'EKO', body)
	worksheet280.write('N22', 'JML', body)
	worksheet280.write('O22', 'MAT', body)
	worksheet280.write('P22', 'IND', body)
	worksheet280.write('Q22', 'ENG', body)
	worksheet280.write('R22', 'SEJ', body)
	worksheet280.write('S22', 'GEO', body)
	worksheet280.write('T22', 'SOS', body)
	worksheet280.write('U22', 'EKO', body)
	worksheet280.write('V22', 'JML', body)

	worksheet280.conditional_format(22,0,row280+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	# worksheet281.set_column('G:V', 5, center)
	# worksheet281.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RAJAWALI', title)
	# worksheet281.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet281.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet281.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet281.write('G5', 'MAT', body)
	# worksheet281.write('H5', 'IND', body)
	# worksheet281.write('I5', 'ENG', body)
	# worksheet281.write('J5', 'SEJ', body)
	# worksheet281.write('K5', 'GEO', body)
	# worksheet281.write('L5', 'SOS', body)
	# worksheet281.write('M5', 'EKO', body)
	# worksheet281.write('N5', 'JML', body)
	# worksheet281.write('O5', 'MAT', body)
	# worksheet281.write('P5', 'IND', body)
	# worksheet281.write('Q5', 'ENG', body)
	# worksheet281.write('R5', 'SEJ', body)
	# worksheet281.write('S5', 'GEO', body)
	# worksheet281.write('T5', 'SOS', body)
	# worksheet281.write('U5', 'EKO', body)
	# worksheet281.write('V5', 'JML', body)



	# worksheet281.conditional_format(5,0,row281_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet281.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RAJAWALI', title)
	# worksheet281.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet281.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet281.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet281.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet281.write('K22', 'GEO', body)
	# worksheet281.write('L22', 'SOS', body)
	# worksheet281.write('M22', 'EKO', body)
	# worksheet281.write('N22', 'JML', body)
	# worksheet281.write('O22', 'MAT', body)
	# worksheet281.write('P22', 'IND', body)
	# worksheet281.write('Q22', 'ENG', body)
	# worksheet281.write('R22', 'SEJ', body)
	# worksheet281.write('S22', 'GEO', body)
	# worksheet281.write('T22', 'SOS', body)
	# worksheet281.write('U22', 'EKO', body)
	# worksheet281.write('V22', 'JML', body)

	# worksheet281.conditional_format(22,0,row281+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet282.set_column('G:V', 5, center)
	worksheet282.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PAHLAWAN', title)
	worksheet282.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet282.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet282.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet282.write('G5', 'MAT', body)
	worksheet282.write('H5', 'IND', body)
	worksheet282.write('I5', 'ENG', body)
	worksheet282.write('J5', 'SEJ', body)
	worksheet282.write('K5', 'GEO', body)
	worksheet282.write('L5', 'SOS', body)
	worksheet282.write('M5', 'EKO', body)
	worksheet282.write('N5', 'JML', body)
	worksheet282.write('O5', 'MAT', body)
	worksheet282.write('P5', 'IND', body)
	worksheet282.write('Q5', 'ENG', body)
	worksheet282.write('R5', 'SEJ', body)
	worksheet282.write('S5', 'GEO', body)
	worksheet282.write('T5', 'SOS', body)
	worksheet282.write('U5', 'EKO', body)
	worksheet282.write('V5', 'JML', body)



	worksheet282.conditional_format(5,0,row282_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet282.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PAHLAWAN', title)
	worksheet282.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet282.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet282.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet282.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet282.write('K22', 'GEO', body)
	worksheet282.write('L22', 'SOS', body)
	worksheet282.write('M22', 'EKO', body)
	worksheet282.write('N22', 'JML', body)
	worksheet282.write('O22', 'MAT', body)
	worksheet282.write('P22', 'IND', body)
	worksheet282.write('Q22', 'ENG', body)
	worksheet282.write('R22', 'SEJ', body)
	worksheet282.write('S22', 'GEO', body)
	worksheet282.write('T22', 'SOS', body)
	worksheet282.write('U22', 'EKO', body)
	worksheet282.write('V22', 'JML', body)

	worksheet282.conditional_format(22,0,row282+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet283.set_column('G:V', 5, center)
	worksheet283.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIJERAH', title)
	worksheet283.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet283.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet283.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet283.write('G5', 'MAT', body)
	worksheet283.write('H5', 'IND', body)
	worksheet283.write('I5', 'ENG', body)
	worksheet283.write('J5', 'SEJ', body)
	worksheet283.write('K5', 'GEO', body)
	worksheet283.write('L5', 'SOS', body)
	worksheet283.write('M5', 'EKO', body)
	worksheet283.write('N5', 'JML', body)
	worksheet283.write('O5', 'MAT', body)
	worksheet283.write('P5', 'IND', body)
	worksheet283.write('Q5', 'ENG', body)
	worksheet283.write('R5', 'SEJ', body)
	worksheet283.write('S5', 'GEO', body)
	worksheet283.write('T5', 'SOS', body)
	worksheet283.write('U5', 'EKO', body)
	worksheet283.write('V5', 'JML', body)



	worksheet283.conditional_format(5,0,row283_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet283.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIJERAH', title)
	worksheet283.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet283.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet283.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet283.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet283.write('K22', 'GEO', body)
	worksheet283.write('L22', 'SOS', body)
	worksheet283.write('M22', 'EKO', body)
	worksheet283.write('N22', 'JML', body)
	worksheet283.write('O22', 'MAT', body)
	worksheet283.write('P22', 'IND', body)
	worksheet283.write('Q22', 'ENG', body)
	worksheet283.write('R22', 'SEJ', body)
	worksheet283.write('S22', 'GEO', body)
	worksheet283.write('T22', 'SOS', body)
	worksheet283.write('U22', 'EKO', body)
	worksheet283.write('V22', 'JML', body)

	worksheet283.conditional_format(22,0,row283+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet284.set_column('G:V', 5, center)
	worksheet284.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TEGAL', title)
	worksheet284.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet284.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet284.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet284.write('G5', 'MAT', body)
	worksheet284.write('H5', 'IND', body)
	worksheet284.write('I5', 'ENG', body)
	worksheet284.write('J5', 'SEJ', body)
	worksheet284.write('K5', 'GEO', body)
	worksheet284.write('L5', 'SOS', body)
	worksheet284.write('M5', 'EKO', body)
	worksheet284.write('N5', 'JML', body)
	worksheet284.write('O5', 'MAT', body)
	worksheet284.write('P5', 'IND', body)
	worksheet284.write('Q5', 'ENG', body)
	worksheet284.write('R5', 'SEJ', body)
	worksheet284.write('S5', 'GEO', body)
	worksheet284.write('T5', 'SOS', body)
	worksheet284.write('U5', 'EKO', body)
	worksheet284.write('V5', 'JML', body)



	worksheet284.conditional_format(5,0,row284_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet284.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TEGAL', title)
	worksheet284.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet284.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet284.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet284.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet284.write('K22', 'GEO', body)
	worksheet284.write('L22', 'SOS', body)
	worksheet284.write('M22', 'EKO', body)
	worksheet284.write('N22', 'JML', body)
	worksheet284.write('O22', 'MAT', body)
	worksheet284.write('P22', 'IND', body)
	worksheet284.write('Q22', 'ENG', body)
	worksheet284.write('R22', 'SEJ', body)
	worksheet284.write('S22', 'GEO', body)
	worksheet284.write('T22', 'SOS', body)
	worksheet284.write('U22', 'EKO', body)
	worksheet284.write('V22', 'JML', body)

	worksheet284.conditional_format(22,0,row284+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet285.set_column('G:V', 5, center)
	worksheet285.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MEDAN AREA', title)
	worksheet285.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet285.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet285.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet285.write('G5', 'MAT', body)
	worksheet285.write('H5', 'IND', body)
	worksheet285.write('I5', 'ENG', body)
	worksheet285.write('J5', 'SEJ', body)
	worksheet285.write('K5', 'GEO', body)
	worksheet285.write('L5', 'SOS', body)
	worksheet285.write('M5', 'EKO', body)
	worksheet285.write('N5', 'JML', body)
	worksheet285.write('O5', 'MAT', body)
	worksheet285.write('P5', 'IND', body)
	worksheet285.write('Q5', 'ENG', body)
	worksheet285.write('R5', 'SEJ', body)
	worksheet285.write('S5', 'GEO', body)
	worksheet285.write('T5', 'SOS', body)
	worksheet285.write('U5', 'EKO', body)
	worksheet285.write('V5', 'JML', body)



	worksheet285.conditional_format(5,0,row285_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet285.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MEDAN AREA', title)
	worksheet285.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet285.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet285.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet285.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet285.write('K22', 'GEO', body)
	worksheet285.write('L22', 'SOS', body)
	worksheet285.write('M22', 'EKO', body)
	worksheet285.write('N22', 'JML', body)
	worksheet285.write('O22', 'MAT', body)
	worksheet285.write('P22', 'IND', body)
	worksheet285.write('Q22', 'ENG', body)
	worksheet285.write('R22', 'SEJ', body)
	worksheet285.write('S22', 'GEO', body)
	worksheet285.write('T22', 'SOS', body)
	worksheet285.write('U22', 'EKO', body)
	worksheet285.write('V22', 'JML', body)

	worksheet285.conditional_format(22,0,row285+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet286.set_column('G:V', 5, center)
	worksheet286.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MEDAN JOHOR', title)
	worksheet286.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet286.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet286.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet286.write('G5', 'MAT', body)
	worksheet286.write('H5', 'IND', body)
	worksheet286.write('I5', 'ENG', body)
	worksheet286.write('J5', 'SEJ', body)
	worksheet286.write('K5', 'GEO', body)
	worksheet286.write('L5', 'SOS', body)
	worksheet286.write('M5', 'EKO', body)
	worksheet286.write('N5', 'JML', body)
	worksheet286.write('O5', 'MAT', body)
	worksheet286.write('P5', 'IND', body)
	worksheet286.write('Q5', 'ENG', body)
	worksheet286.write('R5', 'SEJ', body)
	worksheet286.write('S5', 'GEO', body)
	worksheet286.write('T5', 'SOS', body)
	worksheet286.write('U5', 'EKO', body)
	worksheet286.write('V5', 'JML', body)



	worksheet286.conditional_format(5,0,row286_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet286.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MEDAN JOHOR', title)
	worksheet286.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet286.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet286.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet286.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet286.write('K22', 'GEO', body)
	worksheet286.write('L22', 'SOS', body)
	worksheet286.write('M22', 'EKO', body)
	worksheet286.write('N22', 'JML', body)
	worksheet286.write('O22', 'MAT', body)
	worksheet286.write('P22', 'IND', body)
	worksheet286.write('Q22', 'ENG', body)
	worksheet286.write('R22', 'SEJ', body)
	worksheet286.write('S22', 'GEO', body)
	worksheet286.write('T22', 'SOS', body)
	worksheet286.write('U22', 'EKO', body)
	worksheet286.write('V22', 'JML', body)

	worksheet286.conditional_format(22,0,row286+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet287.set_column('G:V', 5, center)
	worksheet287.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF JAMBO TAPE', title)
	worksheet287.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet287.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet287.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet287.write('G5', 'MAT', body)
	worksheet287.write('H5', 'IND', body)
	worksheet287.write('I5', 'ENG', body)
	worksheet287.write('J5', 'SEJ', body)
	worksheet287.write('K5', 'GEO', body)
	worksheet287.write('L5', 'SOS', body)
	worksheet287.write('M5', 'EKO', body)
	worksheet287.write('N5', 'JML', body)
	worksheet287.write('O5', 'MAT', body)
	worksheet287.write('P5', 'IND', body)
	worksheet287.write('Q5', 'ENG', body)
	worksheet287.write('R5', 'SEJ', body)
	worksheet287.write('S5', 'GEO', body)
	worksheet287.write('T5', 'SOS', body)
	worksheet287.write('U5', 'EKO', body)
	worksheet287.write('V5', 'JML', body)



	worksheet287.conditional_format(5,0,row287_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet287.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF JAMBO TAPE', title)
	worksheet287.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet287.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet287.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet287.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet287.write('K22', 'GEO', body)
	worksheet287.write('L22', 'SOS', body)
	worksheet287.write('M22', 'EKO', body)
	worksheet287.write('N22', 'JML', body)
	worksheet287.write('O22', 'MAT', body)
	worksheet287.write('P22', 'IND', body)
	worksheet287.write('Q22', 'ENG', body)
	worksheet287.write('R22', 'SEJ', body)
	worksheet287.write('S22', 'GEO', body)
	worksheet287.write('T22', 'SOS', body)
	worksheet287.write('U22', 'EKO', body)
	worksheet287.write('V22', 'JML', body)

	worksheet287.conditional_format(22,0,row287+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet288.set_column('G:V', 5, center)
	worksheet288.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF THE HOK', title)
	worksheet288.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet288.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet288.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet288.write('G5', 'MAT', body)
	worksheet288.write('H5', 'IND', body)
	worksheet288.write('I5', 'ENG', body)
	worksheet288.write('J5', 'SEJ', body)
	worksheet288.write('K5', 'GEO', body)
	worksheet288.write('L5', 'SOS', body)
	worksheet288.write('M5', 'EKO', body)
	worksheet288.write('N5', 'JML', body)
	worksheet288.write('O5', 'MAT', body)
	worksheet288.write('P5', 'IND', body)
	worksheet288.write('Q5', 'ENG', body)
	worksheet288.write('R5', 'SEJ', body)
	worksheet288.write('S5', 'GEO', body)
	worksheet288.write('T5', 'SOS', body)
	worksheet288.write('U5', 'EKO', body)
	worksheet288.write('V5', 'JML', body)



	worksheet288.conditional_format(5,0,row288_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet288.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF THE HOK', title)
	worksheet288.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet288.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet288.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet288.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet288.write('K22', 'GEO', body)
	worksheet288.write('L22', 'SOS', body)
	worksheet288.write('M22', 'EKO', body)
	worksheet288.write('N22', 'JML', body)
	worksheet288.write('O22', 'MAT', body)
	worksheet288.write('P22', 'IND', body)
	worksheet288.write('Q22', 'ENG', body)
	worksheet288.write('R22', 'SEJ', body)
	worksheet288.write('S22', 'GEO', body)
	worksheet288.write('T22', 'SOS', body)
	worksheet288.write('U22', 'EKO', body)
	worksheet288.write('V22', 'JML', body)

	worksheet288.conditional_format(22,0,row288+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet289.set_column('G:V', 5, center)
	worksheet289.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SAIL', title)
	worksheet289.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet289.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet289.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet289.write('G5', 'MAT', body)
	worksheet289.write('H5', 'IND', body)
	worksheet289.write('I5', 'ENG', body)
	worksheet289.write('J5', 'SEJ', body)
	worksheet289.write('K5', 'GEO', body)
	worksheet289.write('L5', 'SOS', body)
	worksheet289.write('M5', 'EKO', body)
	worksheet289.write('N5', 'JML', body)
	worksheet289.write('O5', 'MAT', body)
	worksheet289.write('P5', 'IND', body)
	worksheet289.write('Q5', 'ENG', body)
	worksheet289.write('R5', 'SEJ', body)
	worksheet289.write('S5', 'GEO', body)
	worksheet289.write('T5', 'SOS', body)
	worksheet289.write('U5', 'EKO', body)
	worksheet289.write('V5', 'JML', body)



	worksheet289.conditional_format(5,0,row289_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet289.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SAIL', title)
	worksheet289.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet289.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet289.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet289.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet289.write('K22', 'GEO', body)
	worksheet289.write('L22', 'SOS', body)
	worksheet289.write('M22', 'EKO', body)
	worksheet289.write('N22', 'JML', body)
	worksheet289.write('O22', 'MAT', body)
	worksheet289.write('P22', 'IND', body)
	worksheet289.write('Q22', 'ENG', body)
	worksheet289.write('R22', 'SEJ', body)
	worksheet289.write('S22', 'GEO', body)
	worksheet289.write('T22', 'SOS', body)
	worksheet289.write('U22', 'EKO', body)
	worksheet289.write('V22', 'JML', body)

	worksheet289.conditional_format(22,0,row289+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet290.set_column('G:V', 5, center)
	worksheet290.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TELANAI JAMBI', title)
	worksheet290.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet290.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet290.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet290.write('G5', 'MAT', body)
	worksheet290.write('H5', 'IND', body)
	worksheet290.write('I5', 'ENG', body)
	worksheet290.write('J5', 'SEJ', body)
	worksheet290.write('K5', 'GEO', body)
	worksheet290.write('L5', 'SOS', body)
	worksheet290.write('M5', 'EKO', body)
	worksheet290.write('N5', 'JML', body)
	worksheet290.write('O5', 'MAT', body)
	worksheet290.write('P5', 'IND', body)
	worksheet290.write('Q5', 'ENG', body)
	worksheet290.write('R5', 'SEJ', body)
	worksheet290.write('S5', 'GEO', body)
	worksheet290.write('T5', 'SOS', body)
	worksheet290.write('U5', 'EKO', body)
	worksheet290.write('V5', 'JML', body)



	worksheet290.conditional_format(5,0,row290_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet290.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TELANAI JAMBI', title)
	worksheet290.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet290.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet290.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet290.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet290.write('K22', 'GEO', body)
	worksheet290.write('L22', 'SOS', body)
	worksheet290.write('M22', 'EKO', body)
	worksheet290.write('N22', 'JML', body)
	worksheet290.write('O22', 'MAT', body)
	worksheet290.write('P22', 'IND', body)
	worksheet290.write('Q22', 'ENG', body)
	worksheet290.write('R22', 'SEJ', body)
	worksheet290.write('S22', 'GEO', body)
	worksheet290.write('T22', 'SOS', body)
	worksheet290.write('U22', 'EKO', body)
	worksheet290.write('V22', 'JML', body)

	worksheet290.conditional_format(22,0,row290+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet291.set_column('G:V', 5, center)
	worksheet291.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SIDOARJO', title)
	worksheet291.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet291.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet291.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet291.write('G5', 'MAT', body)
	worksheet291.write('H5', 'IND', body)
	worksheet291.write('I5', 'ENG', body)
	worksheet291.write('J5', 'SEJ', body)
	worksheet291.write('K5', 'GEO', body)
	worksheet291.write('L5', 'SOS', body)
	worksheet291.write('M5', 'EKO', body)
	worksheet291.write('N5', 'JML', body)
	worksheet291.write('O5', 'MAT', body)
	worksheet291.write('P5', 'IND', body)
	worksheet291.write('Q5', 'ENG', body)
	worksheet291.write('R5', 'SEJ', body)
	worksheet291.write('S5', 'GEO', body)
	worksheet291.write('T5', 'SOS', body)
	worksheet291.write('U5', 'EKO', body)
	worksheet291.write('V5', 'JML', body)



	worksheet291.conditional_format(5,0,row291_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet291.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SIDOARJO', title)
	worksheet291.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet291.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet291.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet291.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet291.write('K22', 'GEO', body)
	worksheet291.write('L22', 'SOS', body)
	worksheet291.write('M22', 'EKO', body)
	worksheet291.write('N22', 'JML', body)
	worksheet291.write('O22', 'MAT', body)
	worksheet291.write('P22', 'IND', body)
	worksheet291.write('Q22', 'ENG', body)
	worksheet291.write('R22', 'SEJ', body)
	worksheet291.write('S22', 'GEO', body)
	worksheet291.write('T22', 'SOS', body)
	worksheet291.write('U22', 'EKO', body)
	worksheet291.write('V22', 'JML', body)

	worksheet291.conditional_format(22,0,row291+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet292.set_column('G:V', 5, center)
	worksheet292.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PURWOKERTO LOR', title)
	worksheet292.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet292.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet292.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet292.write('G5', 'MAT', body)
	worksheet292.write('H5', 'IND', body)
	worksheet292.write('I5', 'ENG', body)
	worksheet292.write('J5', 'SEJ', body)
	worksheet292.write('K5', 'GEO', body)
	worksheet292.write('L5', 'SOS', body)
	worksheet292.write('M5', 'EKO', body)
	worksheet292.write('N5', 'JML', body)
	worksheet292.write('O5', 'MAT', body)
	worksheet292.write('P5', 'IND', body)
	worksheet292.write('Q5', 'ENG', body)
	worksheet292.write('R5', 'SEJ', body)
	worksheet292.write('S5', 'GEO', body)
	worksheet292.write('T5', 'SOS', body)
	worksheet292.write('U5', 'EKO', body)
	worksheet292.write('V5', 'JML', body)



	worksheet292.conditional_format(5,0,row292_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet292.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PURWOKERTO LOR', title)
	worksheet292.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet292.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet292.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet292.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet292.write('K22', 'GEO', body)
	worksheet292.write('L22', 'SOS', body)
	worksheet292.write('M22', 'EKO', body)
	worksheet292.write('N22', 'JML', body)
	worksheet292.write('O22', 'MAT', body)
	worksheet292.write('P22', 'IND', body)
	worksheet292.write('Q22', 'ENG', body)
	worksheet292.write('R22', 'SEJ', body)
	worksheet292.write('S22', 'GEO', body)
	worksheet292.write('T22', 'SOS', body)
	worksheet292.write('U22', 'EKO', body)
	worksheet292.write('V22', 'JML', body)

	worksheet292.conditional_format(22,0,row292+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet293.set_column('G:V', 5, center)
	worksheet293.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF WAY HALIM', title)
	worksheet293.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet293.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet293.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet293.write('G5', 'MAT', body)
	worksheet293.write('H5', 'IND', body)
	worksheet293.write('I5', 'ENG', body)
	worksheet293.write('J5', 'SEJ', body)
	worksheet293.write('K5', 'GEO', body)
	worksheet293.write('L5', 'SOS', body)
	worksheet293.write('M5', 'EKO', body)
	worksheet293.write('N5', 'JML', body)
	worksheet293.write('O5', 'MAT', body)
	worksheet293.write('P5', 'IND', body)
	worksheet293.write('Q5', 'ENG', body)
	worksheet293.write('R5', 'SEJ', body)
	worksheet293.write('S5', 'GEO', body)
	worksheet293.write('T5', 'SOS', body)
	worksheet293.write('U5', 'EKO', body)
	worksheet293.write('V5', 'JML', body)



	worksheet293.conditional_format(5,0,row293_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet293.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF WAY HALIM', title)
	worksheet293.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet293.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet293.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet293.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet293.write('K22', 'GEO', body)
	worksheet293.write('L22', 'SOS', body)
	worksheet293.write('M22', 'EKO', body)
	worksheet293.write('N22', 'JML', body)
	worksheet293.write('O22', 'MAT', body)
	worksheet293.write('P22', 'IND', body)
	worksheet293.write('Q22', 'ENG', body)
	worksheet293.write('R22', 'SEJ', body)
	worksheet293.write('S22', 'GEO', body)
	worksheet293.write('T22', 'SOS', body)
	worksheet293.write('U22', 'EKO', body)
	worksheet293.write('V22', 'JML', body)

	worksheet293.conditional_format(22,0,row293+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet294.set_column('G:V', 5, center)
	worksheet294.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF METRO', title)
	worksheet294.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet294.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet294.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet294.write('G5', 'MAT', body)
	worksheet294.write('H5', 'IND', body)
	worksheet294.write('I5', 'ENG', body)
	worksheet294.write('J5', 'SEJ', body)
	worksheet294.write('K5', 'GEO', body)
	worksheet294.write('L5', 'SOS', body)
	worksheet294.write('M5', 'EKO', body)
	worksheet294.write('N5', 'JML', body)
	worksheet294.write('O5', 'MAT', body)
	worksheet294.write('P5', 'IND', body)
	worksheet294.write('Q5', 'ENG', body)
	worksheet294.write('R5', 'SEJ', body)
	worksheet294.write('S5', 'GEO', body)
	worksheet294.write('T5', 'SOS', body)
	worksheet294.write('U5', 'EKO', body)
	worksheet294.write('V5', 'JML', body)



	worksheet294.conditional_format(5,0,row294_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet294.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF METRO', title)
	worksheet294.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet294.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet294.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet294.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet294.write('K22', 'GEO', body)
	worksheet294.write('L22', 'SOS', body)
	worksheet294.write('M22', 'EKO', body)
	worksheet294.write('N22', 'JML', body)
	worksheet294.write('O22', 'MAT', body)
	worksheet294.write('P22', 'IND', body)
	worksheet294.write('Q22', 'ENG', body)
	worksheet294.write('R22', 'SEJ', body)
	worksheet294.write('S22', 'GEO', body)
	worksheet294.write('T22', 'SOS', body)
	worksheet294.write('U22', 'EKO', body)
	worksheet294.write('V22', 'JML', body)

	worksheet294.conditional_format(22,0,row294+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet295.set_column('G:V', 5, center)
	worksheet295.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF RAJABASA', title)
	worksheet295.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet295.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet295.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet295.write('G5', 'MAT', body)
	worksheet295.write('H5', 'IND', body)
	worksheet295.write('I5', 'ENG', body)
	worksheet295.write('J5', 'SEJ', body)
	worksheet295.write('K5', 'GEO', body)
	worksheet295.write('L5', 'SOS', body)
	worksheet295.write('M5', 'EKO', body)
	worksheet295.write('N5', 'JML', body)
	worksheet295.write('O5', 'MAT', body)
	worksheet295.write('P5', 'IND', body)
	worksheet295.write('Q5', 'ENG', body)
	worksheet295.write('R5', 'SEJ', body)
	worksheet295.write('S5', 'GEO', body)
	worksheet295.write('T5', 'SOS', body)
	worksheet295.write('U5', 'EKO', body)
	worksheet295.write('V5', 'JML', body)



	worksheet295.conditional_format(5,0,row295_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet295.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF RAJABASA', title)
	worksheet295.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet295.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet295.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet295.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet295.write('K22', 'GEO', body)
	worksheet295.write('L22', 'SOS', body)
	worksheet295.write('M22', 'EKO', body)
	worksheet295.write('N22', 'JML', body)
	worksheet295.write('O22', 'MAT', body)
	worksheet295.write('P22', 'IND', body)
	worksheet295.write('Q22', 'ENG', body)
	worksheet295.write('R22', 'SEJ', body)
	worksheet295.write('S22', 'GEO', body)
	worksheet295.write('T22', 'SOS', body)
	worksheet295.write('U22', 'EKO', body)
	worksheet295.write('V22', 'JML', body)

	worksheet295.conditional_format(22,0,row295+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	# worksheet296.set_column('G:V', 5, center)
	# worksheet296.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KEDATON', title)
	# worksheet296.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet296.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet296.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet296.write('G5', 'MAT', body)
	# worksheet296.write('H5', 'IND', body)
	# worksheet296.write('I5', 'ENG', body)
	# worksheet296.write('J5', 'SEJ', body)
	# worksheet296.write('K5', 'GEO', body)
	# worksheet296.write('L5', 'SOS', body)
	# worksheet296.write('M5', 'EKO', body)
	# worksheet296.write('N5', 'JML', body)
	# worksheet296.write('O5', 'MAT', body)
	# worksheet296.write('P5', 'IND', body)
	# worksheet296.write('Q5', 'ENG', body)
	# worksheet296.write('R5', 'SEJ', body)
	# worksheet296.write('S5', 'GEO', body)
	# worksheet296.write('T5', 'SOS', body)
	# worksheet296.write('U5', 'EKO', body)
	# worksheet296.write('V5', 'JML', body)



	# worksheet296.conditional_format(5,0,row296_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet296.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KEDATON', title)
	# worksheet296.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet296.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet296.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet296.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet296.write('K22', 'GEO', body)
	# worksheet296.write('L22', 'SOS', body)
	# worksheet296.write('M22', 'EKO', body)
	# worksheet296.write('N22', 'JML', body)
	# worksheet296.write('O22', 'MAT', body)
	# worksheet296.write('P22', 'IND', body)
	# worksheet296.write('Q22', 'ENG', body)
	# worksheet296.write('R22', 'SEJ', body)
	# worksheet296.write('S22', 'GEO', body)
	# worksheet296.write('T22', 'SOS', body)
	# worksheet296.write('U22', 'EKO', body)
	# worksheet296.write('V22', 'JML', body)

	# worksheet296.conditional_format(22,0,row296+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	# worksheet297.set_column('G:V', 5, center)
	# worksheet297.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PALAPA CUT NYAK DIEN', title)
	# worksheet297.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet297.merge_range('G4:N4', 'JUMLAH BENAR', header)
	# worksheet297.merge_range('O4:V4', 'NILAI STANDAR', header)
	# worksheet297.write('G5', 'MAT', body)
	# worksheet297.write('H5', 'IND', body)
	# worksheet297.write('I5', 'ENG', body)
	# worksheet297.write('J5', 'SEJ', body)
	# worksheet297.write('K5', 'GEO', body)
	# worksheet297.write('L5', 'SOS', body)
	# worksheet297.write('M5', 'EKO', body)
	# worksheet297.write('N5', 'JML', body)
	# worksheet297.write('O5', 'MAT', body)
	# worksheet297.write('P5', 'IND', body)
	# worksheet297.write('Q5', 'ENG', body)
	# worksheet297.write('R5', 'SEJ', body)
	# worksheet297.write('S5', 'GEO', body)
	# worksheet297.write('T5', 'SOS', body)
	# worksheet297.write('U5', 'EKO', body)
	# worksheet297.write('V5', 'JML', body)



	# worksheet297.conditional_format(5,0,row297_10+4,21, 
	#                              {'type': 'no_errors', 'format': border})

	# worksheet297.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PALAPA CUT NYAK DIEN', title)
	# worksheet297.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	# worksheet297.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	# worksheet297.merge_range('G21:N21', 'JUMLAH BENAR', header)
	# worksheet297.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	# worksheet297.write('K22', 'GEO', body)
	# worksheet297.write('L22', 'SOS', body)
	# worksheet297.write('M22', 'EKO', body)
	# worksheet297.write('N22', 'JML', body)
	# worksheet297.write('O22', 'MAT', body)
	# worksheet297.write('P22', 'IND', body)
	# worksheet297.write('Q22', 'ENG', body)
	# worksheet297.write('R22', 'SEJ', body)
	# worksheet297.write('S22', 'GEO', body)
	# worksheet297.write('T22', 'SOS', body)
	# worksheet297.write('U22', 'EKO', body)
	# worksheet297.write('V22', 'JML', body)

	# worksheet297.conditional_format(22,0,row297+21,21, 
	#                              {'type': 'no_errors', 'format': border})
	...
	worksheet298.set_column('G:V', 5, center)
	worksheet298.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PAHOMAN', title)
	worksheet298.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet298.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet298.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet298.write('G5', 'MAT', body)
	worksheet298.write('H5', 'IND', body)
	worksheet298.write('I5', 'ENG', body)
	worksheet298.write('J5', 'SEJ', body)
	worksheet298.write('K5', 'GEO', body)
	worksheet298.write('L5', 'SOS', body)
	worksheet298.write('M5', 'EKO', body)
	worksheet298.write('N5', 'JML', body)
	worksheet298.write('O5', 'MAT', body)
	worksheet298.write('P5', 'IND', body)
	worksheet298.write('Q5', 'ENG', body)
	worksheet298.write('R5', 'SEJ', body)
	worksheet298.write('S5', 'GEO', body)
	worksheet298.write('T5', 'SOS', body)
	worksheet298.write('U5', 'EKO', body)
	worksheet298.write('V5', 'JML', body)



	worksheet298.conditional_format(5,0,row298_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet298.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PAHOMAN', title)
	worksheet298.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet298.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet298.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet298.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet298.write('K22', 'GEO', body)
	worksheet298.write('L22', 'SOS', body)
	worksheet298.write('M22', 'EKO', body)
	worksheet298.write('N22', 'JML', body)
	worksheet298.write('O22', 'MAT', body)
	worksheet298.write('P22', 'IND', body)
	worksheet298.write('Q22', 'ENG', body)
	worksheet298.write('R22', 'SEJ', body)
	worksheet298.write('S22', 'GEO', body)
	worksheet298.write('T22', 'SOS', body)
	worksheet298.write('U22', 'EKO', body)
	worksheet298.write('V22', 'JML', body)

	worksheet298.conditional_format(22,0,row298+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet299.set_column('G:V', 5, center)
	worksheet299.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF KEMILING', title)
	worksheet299.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet299.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet299.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet299.write('G5', 'MAT', body)
	worksheet299.write('H5', 'IND', body)
	worksheet299.write('I5', 'ENG', body)
	worksheet299.write('J5', 'SEJ', body)
	worksheet299.write('K5', 'GEO', body)
	worksheet299.write('L5', 'SOS', body)
	worksheet299.write('M5', 'EKO', body)
	worksheet299.write('N5', 'JML', body)
	worksheet299.write('O5', 'MAT', body)
	worksheet299.write('P5', 'IND', body)
	worksheet299.write('Q5', 'ENG', body)
	worksheet299.write('R5', 'SEJ', body)
	worksheet299.write('S5', 'GEO', body)
	worksheet299.write('T5', 'SOS', body)
	worksheet299.write('U5', 'EKO', body)
	worksheet299.write('V5', 'JML', body)



	worksheet299.conditional_format(5,0,row299_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet299.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF KEMILING', title)
	worksheet299.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet299.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022-2023', sub_title)
	...
	worksheet299.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet299.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet299.write('K22', 'GEO', body)
	worksheet299.write('L22', 'SOS', body)
	worksheet299.write('M22', 'EKO', body)
	worksheet299.write('N22', 'JML', body)
	worksheet299.write('O22', 'MAT', body)
	worksheet299.write('P22', 'IND', body)
	worksheet299.write('Q22', 'ENG', body)
	worksheet299.write('R22', 'SEJ', body)
	worksheet299.write('S22', 'GEO', body)
	worksheet299.write('T22', 'SOS', body)
	worksheet299.write('U22', 'EKO', body)
	worksheet299.write('V22', 'JML', body)

	worksheet299.conditional_format(22,0,row299+21,21, 
	                             {'type': 'no_errors', 'format': border})
...
uploaded_file = st.file_uploader('Letakkan file excel NILAI STANDAR kelas 10 SMA IPS PAS SM1 [LOKASI DEPOK-PADANG]', type='xlsx')
...
if uploaded_file is not None:
	...
	worksheet530.set_column('G:V', 5, center)
	worksheet530.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF POLSEK DEPOK', title)
	worksheet530.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet530.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet530.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet530.write('G5', 'MAT', body)
	worksheet530.write('H5', 'IND', body)
	worksheet530.write('I5', 'ENG', body)
	worksheet530.write('J5', 'SEJ', body)
	worksheet530.write('K5', 'GEO', body)
	worksheet530.write('L5', 'SOS', body)
	worksheet530.write('M5', 'EKO', body)
	worksheet530.write('N5', 'JML', body)
	worksheet530.write('O5', 'MAT', body)
	worksheet530.write('P5', 'IND', body)
	worksheet530.write('Q5', 'ENG', body)
	worksheet530.write('R5', 'SEJ', body)
	worksheet530.write('S5', 'GEO', body)
	worksheet530.write('T5', 'SOS', body)
	worksheet530.write('U5', 'EKO', body)
	worksheet530.write('V5', 'JML', body)



	worksheet530.conditional_format(5,0,row530_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet530.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF POLSEK DEPOK', title)
	worksheet530.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet530.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet530.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet530.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet530.write('K22', 'GEO', body)
	worksheet530.write('L22', 'SOS', body)
	worksheet530.write('M22', 'EKO', body)
	worksheet530.write('N22', 'JML', body)
	worksheet530.write('O22', 'MAT', body)
	worksheet530.write('P22', 'IND', body)
	worksheet530.write('Q22', 'ENG', body)
	worksheet530.write('R22', 'SEJ', body)
	worksheet530.write('S22', 'GEO', body)
	worksheet530.write('T22', 'SOS', body)
	worksheet530.write('U22', 'EKO', body)
	worksheet530.write('V22', 'JML', body)

	worksheet530.conditional_format(22,0,row530+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet531.set_column('G:V', 5, center)
	worksheet531.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF DEPOK 1', title)
	worksheet531.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet531.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet531.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet531.write('G5', 'MAT', body)
	worksheet531.write('H5', 'IND', body)
	worksheet531.write('I5', 'ENG', body)
	worksheet531.write('J5', 'SEJ', body)
	worksheet531.write('K5', 'GEO', body)
	worksheet531.write('L5', 'SOS', body)
	worksheet531.write('M5', 'EKO', body)
	worksheet531.write('N5', 'JML', body)
	worksheet531.write('O5', 'MAT', body)
	worksheet531.write('P5', 'IND', body)
	worksheet531.write('Q5', 'ENG', body)
	worksheet531.write('R5', 'SEJ', body)
	worksheet531.write('S5', 'GEO', body)
	worksheet531.write('T5', 'SOS', body)
	worksheet531.write('U5', 'EKO', body)
	worksheet531.write('V5', 'JML', body)



	worksheet531.conditional_format(5,0,row531_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet531.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF DEPOK 1', title)
	worksheet531.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet531.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet531.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet531.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet531.write('K22', 'GEO', body)
	worksheet531.write('L22', 'SOS', body)
	worksheet531.write('M22', 'EKO', body)
	worksheet531.write('N22', 'JML', body)
	worksheet531.write('O22', 'MAT', body)
	worksheet531.write('P22', 'IND', body)
	worksheet531.write('Q22', 'ENG', body)
	worksheet531.write('R22', 'SEJ', body)
	worksheet531.write('S22', 'GEO', body)
	worksheet531.write('T22', 'SOS', body)
	worksheet531.write('U22', 'EKO', body)
	worksheet531.write('V22', 'JML', body)

	worksheet531.conditional_format(22,0,row531+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet532.set_column('G:V', 5, center)
	worksheet532.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PROKLAMASI DEPOK 2', title)
	worksheet532.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet532.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet532.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet532.write('G5', 'MAT', body)
	worksheet532.write('H5', 'IND', body)
	worksheet532.write('I5', 'ENG', body)
	worksheet532.write('J5', 'SEJ', body)
	worksheet532.write('K5', 'GEO', body)
	worksheet532.write('L5', 'SOS', body)
	worksheet532.write('M5', 'EKO', body)
	worksheet532.write('N5', 'JML', body)
	worksheet532.write('O5', 'MAT', body)
	worksheet532.write('P5', 'IND', body)
	worksheet532.write('Q5', 'ENG', body)
	worksheet532.write('R5', 'SEJ', body)
	worksheet532.write('S5', 'GEO', body)
	worksheet532.write('T5', 'SOS', body)
	worksheet532.write('U5', 'EKO', body)
	worksheet532.write('V5', 'JML', body)



	worksheet532.conditional_format(5,0,row532_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet532.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PROKLAMASI DEPOK 2', title)
	worksheet532.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet532.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet532.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet532.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet532.write('K22', 'GEO', body)
	worksheet532.write('L22', 'SOS', body)
	worksheet532.write('M22', 'EKO', body)
	worksheet532.write('N22', 'JML', body)
	worksheet532.write('O22', 'MAT', body)
	worksheet532.write('P22', 'IND', body)
	worksheet532.write('Q22', 'ENG', body)
	worksheet532.write('R22', 'SEJ', body)
	worksheet532.write('S22', 'GEO', body)
	worksheet532.write('T22', 'SOS', body)
	worksheet532.write('U22', 'EKO', body)
	worksheet532.write('V22', 'JML', body)

	worksheet532.conditional_format(22,0,row532+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet533.set_column('G:V', 5, center)
	worksheet533.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIMANGGIS', title)
	worksheet533.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet533.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet533.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet533.write('G5', 'MAT', body)
	worksheet533.write('H5', 'IND', body)
	worksheet533.write('I5', 'ENG', body)
	worksheet533.write('J5', 'SEJ', body)
	worksheet533.write('K5', 'GEO', body)
	worksheet533.write('L5', 'SOS', body)
	worksheet533.write('M5', 'EKO', body)
	worksheet533.write('N5', 'JML', body)
	worksheet533.write('O5', 'MAT', body)
	worksheet533.write('P5', 'IND', body)
	worksheet533.write('Q5', 'ENG', body)
	worksheet533.write('R5', 'SEJ', body)
	worksheet533.write('S5', 'GEO', body)
	worksheet533.write('T5', 'SOS', body)
	worksheet533.write('U5', 'EKO', body)
	worksheet533.write('V5', 'JML', body)



	worksheet533.conditional_format(5,0,row533_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet533.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIMANGGIS', title)
	worksheet533.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet533.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet533.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet533.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet533.write('K22', 'GEO', body)
	worksheet533.write('L22', 'SOS', body)
	worksheet533.write('M22', 'EKO', body)
	worksheet533.write('N22', 'JML', body)
	worksheet533.write('O22', 'MAT', body)
	worksheet533.write('P22', 'IND', body)
	worksheet533.write('Q22', 'ENG', body)
	worksheet533.write('R22', 'SEJ', body)
	worksheet533.write('S22', 'GEO', body)
	worksheet533.write('T22', 'SOS', body)
	worksheet533.write('U22', 'EKO', body)
	worksheet533.write('V22', 'JML', body)

	worksheet533.conditional_format(22,0,row533+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet534.set_column('G:V', 5, center)
	worksheet534.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SAWANGAN', title)
	worksheet534.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet534.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet534.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet534.write('G5', 'MAT', body)
	worksheet534.write('H5', 'IND', body)
	worksheet534.write('I5', 'ENG', body)
	worksheet534.write('J5', 'SEJ', body)
	worksheet534.write('K5', 'GEO', body)
	worksheet534.write('L5', 'SOS', body)
	worksheet534.write('M5', 'EKO', body)
	worksheet534.write('N5', 'JML', body)
	worksheet534.write('O5', 'MAT', body)
	worksheet534.write('P5', 'IND', body)
	worksheet534.write('Q5', 'ENG', body)
	worksheet534.write('R5', 'SEJ', body)
	worksheet534.write('S5', 'GEO', body)
	worksheet534.write('T5', 'SOS', body)
	worksheet534.write('U5', 'EKO', body)
	worksheet534.write('V5', 'JML', body)



	worksheet534.conditional_format(5,0,row534_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet534.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SAWANGAN', title)
	worksheet534.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet534.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet534.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet534.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet534.write('K22', 'GEO', body)
	worksheet534.write('L22', 'SOS', body)
	worksheet534.write('M22', 'EKO', body)
	worksheet534.write('N22', 'JML', body)
	worksheet534.write('O22', 'MAT', body)
	worksheet534.write('P22', 'IND', body)
	worksheet534.write('Q22', 'ENG', body)
	worksheet534.write('R22', 'SEJ', body)
	worksheet534.write('S22', 'GEO', body)
	worksheet534.write('T22', 'SOS', body)
	worksheet534.write('U22', 'EKO', body)
	worksheet534.write('V22', 'JML', body)

	worksheet534.conditional_format(22,0,row534+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet535.set_column('G:V', 5, center)
	worksheet535.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BRIMOB', title)
	worksheet535.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet535.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet535.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet535.write('G5', 'MAT', body)
	worksheet535.write('H5', 'IND', body)
	worksheet535.write('I5', 'ENG', body)
	worksheet535.write('J5', 'SEJ', body)
	worksheet535.write('K5', 'GEO', body)
	worksheet535.write('L5', 'SOS', body)
	worksheet535.write('M5', 'EKO', body)
	worksheet535.write('N5', 'JML', body)
	worksheet535.write('O5', 'MAT', body)
	worksheet535.write('P5', 'IND', body)
	worksheet535.write('Q5', 'ENG', body)
	worksheet535.write('R5', 'SEJ', body)
	worksheet535.write('S5', 'GEO', body)
	worksheet535.write('T5', 'SOS', body)
	worksheet535.write('U5', 'EKO', body)
	worksheet535.write('V5', 'JML', body)



	worksheet535.conditional_format(5,0,row535_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet535.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BRIMOB', title)
	worksheet535.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet535.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet535.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet535.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet535.write('K22', 'GEO', body)
	worksheet535.write('L22', 'SOS', body)
	worksheet535.write('M22', 'EKO', body)
	worksheet535.write('N22', 'JML', body)
	worksheet535.write('O22', 'MAT', body)
	worksheet535.write('P22', 'IND', body)
	worksheet535.write('Q22', 'ENG', body)
	worksheet535.write('R22', 'SEJ', body)
	worksheet535.write('S22', 'GEO', body)
	worksheet535.write('T22', 'SOS', body)
	worksheet535.write('U22', 'EKO', body)
	worksheet535.write('V22', 'JML', body)

	worksheet535.conditional_format(22,0,row535+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet546.set_column('G:V', 5, center)
	worksheet546.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PAJAJARAN (PPIB)', title)
	worksheet546.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet546.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet546.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet546.write('G5', 'MAT', body)
	worksheet546.write('H5', 'IND', body)
	worksheet546.write('I5', 'ENG', body)
	worksheet546.write('J5', 'SEJ', body)
	worksheet546.write('K5', 'GEO', body)
	worksheet546.write('L5', 'SOS', body)
	worksheet546.write('M5', 'EKO', body)
	worksheet546.write('N5', 'JML', body)
	worksheet546.write('O5', 'MAT', body)
	worksheet546.write('P5', 'IND', body)
	worksheet546.write('Q5', 'ENG', body)
	worksheet546.write('R5', 'SEJ', body)
	worksheet546.write('S5', 'GEO', body)
	worksheet546.write('T5', 'SOS', body)
	worksheet546.write('U5', 'EKO', body)
	worksheet546.write('V5', 'JML', body)



	worksheet546.conditional_format(5,0,row546_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet546.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PAJAJARAN (PPIB)', title)
	worksheet546.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet546.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet546.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet546.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet546.write('K22', 'GEO', body)
	worksheet546.write('L22', 'SOS', body)
	worksheet546.write('M22', 'EKO', body)
	worksheet546.write('N22', 'JML', body)
	worksheet546.write('O22', 'MAT', body)
	worksheet546.write('P22', 'IND', body)
	worksheet546.write('Q22', 'ENG', body)
	worksheet546.write('R22', 'SEJ', body)
	worksheet546.write('S22', 'GEO', body)
	worksheet546.write('T22', 'SOS', body)
	worksheet546.write('U22', 'EKO', body)
	worksheet546.write('V22', 'JML', body)

	worksheet546.conditional_format(22,0,row546+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet547.set_column('G:V', 5, center)
	worksheet547.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SUKASARI', title)
	worksheet547.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet547.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet547.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet547.write('G5', 'MAT', body)
	worksheet547.write('H5', 'IND', body)
	worksheet547.write('I5', 'ENG', body)
	worksheet547.write('J5', 'SEJ', body)
	worksheet547.write('K5', 'GEO', body)
	worksheet547.write('L5', 'SOS', body)
	worksheet547.write('M5', 'EKO', body)
	worksheet547.write('N5', 'JML', body)
	worksheet547.write('O5', 'MAT', body)
	worksheet547.write('P5', 'IND', body)
	worksheet547.write('Q5', 'ENG', body)
	worksheet547.write('R5', 'SEJ', body)
	worksheet547.write('S5', 'GEO', body)
	worksheet547.write('T5', 'SOS', body)
	worksheet547.write('U5', 'EKO', body)
	worksheet547.write('V5', 'JML', body)



	worksheet547.conditional_format(5,0,row547_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet547.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SUKASARI', title)
	worksheet547.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet547.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet547.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet547.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet547.write('K22', 'GEO', body)
	worksheet547.write('L22', 'SOS', body)
	worksheet547.write('M22', 'EKO', body)
	worksheet547.write('N22', 'JML', body)
	worksheet547.write('O22', 'MAT', body)
	worksheet547.write('P22', 'IND', body)
	worksheet547.write('Q22', 'ENG', body)
	worksheet547.write('R22', 'SEJ', body)
	worksheet547.write('S22', 'GEO', body)
	worksheet547.write('T22', 'SOS', body)
	worksheet547.write('U22', 'EKO', body)
	worksheet547.write('V22', 'JML', body)

	worksheet547.conditional_format(22,0,row547+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet548.set_column('G:V', 5, center)
	worksheet548.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF BUBULAK', title)
	worksheet548.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet548.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet548.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet548.write('G5', 'MAT', body)
	worksheet548.write('H5', 'IND', body)
	worksheet548.write('I5', 'ENG', body)
	worksheet548.write('J5', 'SEJ', body)
	worksheet548.write('K5', 'GEO', body)
	worksheet548.write('L5', 'SOS', body)
	worksheet548.write('M5', 'EKO', body)
	worksheet548.write('N5', 'JML', body)
	worksheet548.write('O5', 'MAT', body)
	worksheet548.write('P5', 'IND', body)
	worksheet548.write('Q5', 'ENG', body)
	worksheet548.write('R5', 'SEJ', body)
	worksheet548.write('S5', 'GEO', body)
	worksheet548.write('T5', 'SOS', body)
	worksheet548.write('U5', 'EKO', body)
	worksheet548.write('V5', 'JML', body)



	worksheet548.conditional_format(5,0,row548_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet548.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF BUBULAK', title)
	worksheet548.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet548.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet548.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet548.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet548.write('K22', 'GEO', body)
	worksheet548.write('L22', 'SOS', body)
	worksheet548.write('M22', 'EKO', body)
	worksheet548.write('N22', 'JML', body)
	worksheet548.write('O22', 'MAT', body)
	worksheet548.write('P22', 'IND', body)
	worksheet548.write('Q22', 'ENG', body)
	worksheet548.write('R22', 'SEJ', body)
	worksheet548.write('S22', 'GEO', body)
	worksheet548.write('T22', 'SOS', body)
	worksheet548.write('U22', 'EKO', body)
	worksheet548.write('V22', 'JML', body)

	worksheet548.conditional_format(22,0,row548+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet549.set_column('G:V', 5, center)
	worksheet549.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CITEUREUP', title)
	worksheet549.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet549.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet549.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet549.write('G5', 'MAT', body)
	worksheet549.write('H5', 'IND', body)
	worksheet549.write('I5', 'ENG', body)
	worksheet549.write('J5', 'SEJ', body)
	worksheet549.write('K5', 'GEO', body)
	worksheet549.write('L5', 'SOS', body)
	worksheet549.write('M5', 'EKO', body)
	worksheet549.write('N5', 'JML', body)
	worksheet549.write('O5', 'MAT', body)
	worksheet549.write('P5', 'IND', body)
	worksheet549.write('Q5', 'ENG', body)
	worksheet549.write('R5', 'SEJ', body)
	worksheet549.write('S5', 'GEO', body)
	worksheet549.write('T5', 'SOS', body)
	worksheet549.write('U5', 'EKO', body)
	worksheet549.write('V5', 'JML', body)



	worksheet549.conditional_format(5,0,row549_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet549.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CITEUREUP', title)
	worksheet549.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet549.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet549.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet549.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet549.write('K22', 'GEO', body)
	worksheet549.write('L22', 'SOS', body)
	worksheet549.write('M22', 'EKO', body)
	worksheet549.write('N22', 'JML', body)
	worksheet549.write('O22', 'MAT', body)
	worksheet549.write('P22', 'IND', body)
	worksheet549.write('Q22', 'ENG', body)
	worksheet549.write('R22', 'SEJ', body)
	worksheet549.write('S22', 'GEO', body)
	worksheet549.write('T22', 'SOS', body)
	worksheet549.write('U22', 'EKO', body)
	worksheet549.write('V22', 'JML', body)

	worksheet549.conditional_format(22,0,row549+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet556.set_column('G:V', 5, center)
	worksheet556.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF YASMIN', title)
	worksheet556.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet556.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet556.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet556.write('G5', 'MAT', body)
	worksheet556.write('H5', 'IND', body)
	worksheet556.write('I5', 'ENG', body)
	worksheet556.write('J5', 'SEJ', body)
	worksheet556.write('K5', 'GEO', body)
	worksheet556.write('L5', 'SOS', body)
	worksheet556.write('M5', 'EKO', body)
	worksheet556.write('N5', 'JML', body)
	worksheet556.write('O5', 'MAT', body)
	worksheet556.write('P5', 'IND', body)
	worksheet556.write('Q5', 'ENG', body)
	worksheet556.write('R5', 'SEJ', body)
	worksheet556.write('S5', 'GEO', body)
	worksheet556.write('T5', 'SOS', body)
	worksheet556.write('U5', 'EKO', body)
	worksheet556.write('V5', 'JML', body)



	worksheet556.conditional_format(5,0,row556_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet556.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF YASMIN', title)
	worksheet556.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet556.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet556.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet556.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet556.write('K22', 'GEO', body)
	worksheet556.write('L22', 'SOS', body)
	worksheet556.write('M22', 'EKO', body)
	worksheet556.write('N22', 'JML', body)
	worksheet556.write('O22', 'MAT', body)
	worksheet556.write('P22', 'IND', body)
	worksheet556.write('Q22', 'ENG', body)
	worksheet556.write('R22', 'SEJ', body)
	worksheet556.write('S22', 'GEO', body)
	worksheet556.write('T22', 'SOS', body)
	worksheet556.write('U22', 'EKO', body)
	worksheet556.write('V22', 'JML', body)

	worksheet556.conditional_format(22,0,row556+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet557.set_column('G:V', 5, center)
	worksheet557.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF YOGYA PLAZA', title)
	worksheet557.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet557.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet557.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet557.write('G5', 'MAT', body)
	worksheet557.write('H5', 'IND', body)
	worksheet557.write('I5', 'ENG', body)
	worksheet557.write('J5', 'SEJ', body)
	worksheet557.write('K5', 'GEO', body)
	worksheet557.write('L5', 'SOS', body)
	worksheet557.write('M5', 'EKO', body)
	worksheet557.write('N5', 'JML', body)
	worksheet557.write('O5', 'MAT', body)
	worksheet557.write('P5', 'IND', body)
	worksheet557.write('Q5', 'ENG', body)
	worksheet557.write('R5', 'SEJ', body)
	worksheet557.write('S5', 'GEO', body)
	worksheet557.write('T5', 'SOS', body)
	worksheet557.write('U5', 'EKO', body)
	worksheet557.write('V5', 'JML', body)



	worksheet557.conditional_format(5,0,row557_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet557.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF YOGYA PLAZA', title)
	worksheet557.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet557.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet557.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet557.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet557.write('K22', 'GEO', body)
	worksheet557.write('L22', 'SOS', body)
	worksheet557.write('M22', 'EKO', body)
	worksheet557.write('N22', 'JML', body)
	worksheet557.write('O22', 'MAT', body)
	worksheet557.write('P22', 'IND', body)
	worksheet557.write('Q22', 'ENG', body)
	worksheet557.write('R22', 'SEJ', body)
	worksheet557.write('S22', 'GEO', body)
	worksheet557.write('T22', 'SOS', body)
	worksheet557.write('U22', 'EKO', body)
	worksheet557.write('V22', 'JML', body)

	worksheet557.conditional_format(22,0,row557+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet558.set_column('G:V', 5, center)
	worksheet558.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PARUNG', title)
	worksheet558.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet558.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet558.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet558.write('G5', 'MAT', body)
	worksheet558.write('H5', 'IND', body)
	worksheet558.write('I5', 'ENG', body)
	worksheet558.write('J5', 'SEJ', body)
	worksheet558.write('K5', 'GEO', body)
	worksheet558.write('L5', 'SOS', body)
	worksheet558.write('M5', 'EKO', body)
	worksheet558.write('N5', 'JML', body)
	worksheet558.write('O5', 'MAT', body)
	worksheet558.write('P5', 'IND', body)
	worksheet558.write('Q5', 'ENG', body)
	worksheet558.write('R5', 'SEJ', body)
	worksheet558.write('S5', 'GEO', body)
	worksheet558.write('T5', 'SOS', body)
	worksheet558.write('U5', 'EKO', body)
	worksheet558.write('V5', 'JML', body)



	worksheet558.conditional_format(5,0,row558_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet558.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PARUNG', title)
	worksheet558.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet558.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet558.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet558.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet558.write('K22', 'GEO', body)
	worksheet558.write('L22', 'SOS', body)
	worksheet558.write('M22', 'EKO', body)
	worksheet558.write('N22', 'JML', body)
	worksheet558.write('O22', 'MAT', body)
	worksheet558.write('P22', 'IND', body)
	worksheet558.write('Q22', 'ENG', body)
	worksheet558.write('R22', 'SEJ', body)
	worksheet558.write('S22', 'GEO', body)
	worksheet558.write('T22', 'SOS', body)
	worksheet558.write('U22', 'EKO', body)
	worksheet558.write('V22', 'JML', body)

	worksheet558.conditional_format(22,0,row558+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet575.set_column('G:V', 5, center)
	worksheet575.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CINERE', title)
	worksheet575.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet575.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet575.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet575.write('G5', 'MAT', body)
	worksheet575.write('H5', 'IND', body)
	worksheet575.write('I5', 'ENG', body)
	worksheet575.write('J5', 'SEJ', body)
	worksheet575.write('K5', 'GEO', body)
	worksheet575.write('L5', 'SOS', body)
	worksheet575.write('M5', 'EKO', body)
	worksheet575.write('N5', 'JML', body)
	worksheet575.write('O5', 'MAT', body)
	worksheet575.write('P5', 'IND', body)
	worksheet575.write('Q5', 'ENG', body)
	worksheet575.write('R5', 'SEJ', body)
	worksheet575.write('S5', 'GEO', body)
	worksheet575.write('T5', 'SOS', body)
	worksheet575.write('U5', 'EKO', body)
	worksheet575.write('V5', 'JML', body)



	worksheet575.conditional_format(5,0,row575_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet575.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CINERE', title)
	worksheet575.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet575.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet575.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet575.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet575.write('K22', 'GEO', body)
	worksheet575.write('L22', 'SOS', body)
	worksheet575.write('M22', 'EKO', body)
	worksheet575.write('N22', 'JML', body)
	worksheet575.write('O22', 'MAT', body)
	worksheet575.write('P22', 'IND', body)
	worksheet575.write('Q22', 'ENG', body)
	worksheet575.write('R22', 'SEJ', body)
	worksheet575.write('S22', 'GEO', body)
	worksheet575.write('T22', 'SOS', body)
	worksheet575.write('U22', 'EKO', body)
	worksheet575.write('V22', 'JML', body)

	worksheet575.conditional_format(22,0,row575+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet576.set_column('G:V', 5, center)
	worksheet576.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF CIBINONG', title)
	worksheet576.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet576.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet576.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet576.write('G5', 'MAT', body)
	worksheet576.write('H5', 'IND', body)
	worksheet576.write('I5', 'ENG', body)
	worksheet576.write('J5', 'SEJ', body)
	worksheet576.write('K5', 'GEO', body)
	worksheet576.write('L5', 'SOS', body)
	worksheet576.write('M5', 'EKO', body)
	worksheet576.write('N5', 'JML', body)
	worksheet576.write('O5', 'MAT', body)
	worksheet576.write('P5', 'IND', body)
	worksheet576.write('Q5', 'ENG', body)
	worksheet576.write('R5', 'SEJ', body)
	worksheet576.write('S5', 'GEO', body)
	worksheet576.write('T5', 'SOS', body)
	worksheet576.write('U5', 'EKO', body)
	worksheet576.write('V5', 'JML', body)



	worksheet576.conditional_format(5,0,row576_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet576.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF CIBINONG', title)
	worksheet576.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet576.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet576.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet576.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet576.write('K22', 'GEO', body)
	worksheet576.write('L22', 'SOS', body)
	worksheet576.write('M22', 'EKO', body)
	worksheet576.write('N22', 'JML', body)
	worksheet576.write('O22', 'MAT', body)
	worksheet576.write('P22', 'IND', body)
	worksheet576.write('Q22', 'ENG', body)
	worksheet576.write('R22', 'SEJ', body)
	worksheet576.write('S22', 'GEO', body)
	worksheet576.write('T22', 'SOS', body)
	worksheet576.write('U22', 'EKO', body)
	worksheet576.write('V22', 'JML', body)

	worksheet576.conditional_format(22,0,row576+21,21, 
	                             {'type': 'no_errors', 'format': border})
	# worksheet 577
	...
	worksheet577.set_column('G:V', 5, center)
	worksheet577.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF VETERAN (RUMAH SAKIT)', title)
	worksheet577.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet577.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet577.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet577.write('G5', 'MAT', body)
	worksheet577.write('H5', 'IND', body)
	worksheet577.write('I5', 'ENG', body)
	worksheet577.write('J5', 'SEJ', body)
	worksheet577.write('K5', 'GEO', body)
	worksheet577.write('L5', 'SOS', body)
	worksheet577.write('M5', 'EKO', body)
	worksheet577.write('N5', 'JML', body)
	worksheet577.write('O5', 'MAT', body)
	worksheet577.write('P5', 'IND', body)
	worksheet577.write('Q5', 'ENG', body)
	worksheet577.write('R5', 'SEJ', body)
	worksheet577.write('S5', 'GEO', body)
	worksheet577.write('T5', 'SOS', body)
	worksheet577.write('U5', 'EKO', body)
	worksheet577.write('V5', 'JML', body)



	worksheet577.conditional_format(5,0,row577_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet577.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF VETERAN (RUMAH SAKIT)', title)
	worksheet577.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet577.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet577.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet577.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet577.write('K22', 'GEO', body)
	worksheet577.write('L22', 'SOS', body)
	worksheet577.write('M22', 'EKO', body)
	worksheet577.write('N22', 'JML', body)
	worksheet577.write('O22', 'MAT', body)
	worksheet577.write('P22', 'IND', body)
	worksheet577.write('Q22', 'ENG', body)
	worksheet577.write('R22', 'SEJ', body)
	worksheet577.write('S22', 'GEO', body)
	worksheet577.write('T22', 'SOS', body)
	worksheet577.write('U22', 'EKO', body)
	worksheet577.write('V22', 'JML', body)

	worksheet577.conditional_format(22,0,row577+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet578.set_column('G:V', 5, center)
	worksheet578.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MARTADINATA', title)
	worksheet578.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet578.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet578.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet578.write('G5', 'MAT', body)
	worksheet578.write('H5', 'IND', body)
	worksheet578.write('I5', 'ENG', body)
	worksheet578.write('J5', 'SEJ', body)
	worksheet578.write('K5', 'GEO', body)
	worksheet578.write('L5', 'SOS', body)
	worksheet578.write('M5', 'EKO', body)
	worksheet578.write('N5', 'JML', body)
	worksheet578.write('O5', 'MAT', body)
	worksheet578.write('P5', 'IND', body)
	worksheet578.write('Q5', 'ENG', body)
	worksheet578.write('R5', 'SEJ', body)
	worksheet578.write('S5', 'GEO', body)
	worksheet578.write('T5', 'SOS', body)
	worksheet578.write('U5', 'EKO', body)
	worksheet578.write('V5', 'JML', body)



	worksheet578.conditional_format(5,0,row578_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet578.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MARTADINATA', title)
	worksheet578.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet578.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet578.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet578.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet578.write('K22', 'GEO', body)
	worksheet578.write('L22', 'SOS', body)
	worksheet578.write('M22', 'EKO', body)
	worksheet578.write('N22', 'JML', body)
	worksheet578.write('O22', 'MAT', body)
	worksheet578.write('P22', 'IND', body)
	worksheet578.write('Q22', 'ENG', body)
	worksheet578.write('R22', 'SEJ', body)
	worksheet578.write('S22', 'GEO', body)
	worksheet578.write('T22', 'SOS', body)
	worksheet578.write('U22', 'EKO', body)
	worksheet578.write('V22', 'JML', body)

	worksheet578.conditional_format(22,0,row578+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet588.set_column('G:V', 5, center)
	worksheet588.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF MAHARAJA', title)
	worksheet588.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet588.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet588.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet588.write('G5', 'MAT', body)
	worksheet588.write('H5', 'IND', body)
	worksheet588.write('I5', 'ENG', body)
	worksheet588.write('J5', 'SEJ', body)
	worksheet588.write('K5', 'GEO', body)
	worksheet588.write('L5', 'SOS', body)
	worksheet588.write('M5', 'EKO', body)
	worksheet588.write('N5', 'JML', body)
	worksheet588.write('O5', 'MAT', body)
	worksheet588.write('P5', 'IND', body)
	worksheet588.write('Q5', 'ENG', body)
	worksheet588.write('R5', 'SEJ', body)
	worksheet588.write('S5', 'GEO', body)
	worksheet588.write('T5', 'SOS', body)
	worksheet588.write('U5', 'EKO', body)
	worksheet588.write('V5', 'JML', body)



	worksheet588.conditional_format(5,0,row588_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet588.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF MAHARAJA', title)
	worksheet588.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet588.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet588.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet588.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet588.write('K22', 'GEO', body)
	worksheet588.write('L22', 'SOS', body)
	worksheet588.write('M22', 'EKO', body)
	worksheet588.write('N22', 'JML', body)
	worksheet588.write('O22', 'MAT', body)
	worksheet588.write('P22', 'IND', body)
	worksheet588.write('Q22', 'ENG', body)
	worksheet588.write('R22', 'SEJ', body)
	worksheet588.write('S22', 'GEO', body)
	worksheet588.write('T22', 'SOS', body)
	worksheet588.write('U22', 'EKO', body)
	worksheet588.write('V22', 'JML', body)

	worksheet588.conditional_format(22,0,row588+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet589.set_column('G:V', 5, center)
	worksheet589.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF WARUNG JAMBU', title)
	worksheet589.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet589.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet589.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet589.write('G5', 'MAT', body)
	worksheet589.write('H5', 'IND', body)
	worksheet589.write('I5', 'ENG', body)
	worksheet589.write('J5', 'SEJ', body)
	worksheet589.write('K5', 'GEO', body)
	worksheet589.write('L5', 'SOS', body)
	worksheet589.write('M5', 'EKO', body)
	worksheet589.write('N5', 'JML', body)
	worksheet589.write('O5', 'MAT', body)
	worksheet589.write('P5', 'IND', body)
	worksheet589.write('Q5', 'ENG', body)
	worksheet589.write('R5', 'SEJ', body)
	worksheet589.write('S5', 'GEO', body)
	worksheet589.write('T5', 'SOS', body)
	worksheet589.write('U5', 'EKO', body)
	worksheet589.write('V5', 'JML', body)



	worksheet589.conditional_format(5,0,row589_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet589.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF WARUNG JAMBU', title)
	worksheet589.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet589.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet589.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet589.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet589.write('K22', 'GEO', body)
	worksheet589.write('L22', 'SOS', body)
	worksheet589.write('M22', 'EKO', body)
	worksheet589.write('N22', 'JML', body)
	worksheet589.write('O22', 'MAT', body)
	worksheet589.write('P22', 'IND', body)
	worksheet589.write('Q22', 'ENG', body)
	worksheet589.write('R22', 'SEJ', body)
	worksheet589.write('S22', 'GEO', body)
	worksheet589.write('T22', 'SOS', body)
	worksheet589.write('U22', 'EKO', body)
	worksheet589.write('V22', 'JML', body)

	worksheet589.conditional_format(22,0,row589+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet594.set_column('G:V', 5, center)
	worksheet594.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF PEMDA CIBINONG', title)
	worksheet594.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet594.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet594.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet594.write('G5', 'MAT', body)
	worksheet594.write('H5', 'IND', body)
	worksheet594.write('I5', 'ENG', body)
	worksheet594.write('J5', 'SEJ', body)
	worksheet594.write('K5', 'GEO', body)
	worksheet594.write('L5', 'SOS', body)
	worksheet594.write('M5', 'EKO', body)
	worksheet594.write('N5', 'JML', body)
	worksheet594.write('O5', 'MAT', body)
	worksheet594.write('P5', 'IND', body)
	worksheet594.write('Q5', 'ENG', body)
	worksheet594.write('R5', 'SEJ', body)
	worksheet594.write('S5', 'GEO', body)
	worksheet594.write('T5', 'SOS', body)
	worksheet594.write('U5', 'EKO', body)
	worksheet594.write('V5', 'JML', body)



	worksheet594.conditional_format(5,0,row594_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet594.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF PEMDA CIBINONG', title)
	worksheet594.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet594.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet594.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet594.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet594.write('K22', 'GEO', body)
	worksheet594.write('L22', 'SOS', body)
	worksheet594.write('M22', 'EKO', body)
	worksheet594.write('N22', 'JML', body)
	worksheet594.write('O22', 'MAT', body)
	worksheet594.write('P22', 'IND', body)
	worksheet594.write('Q22', 'ENG', body)
	worksheet594.write('R22', 'SEJ', body)
	worksheet594.write('S22', 'GEO', body)
	worksheet594.write('T22', 'SOS', body)
	worksheet594.write('U22', 'EKO', body)
	worksheet594.write('V22', 'JML', body)

	worksheet594.conditional_format(22,0,row594+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet661.set_column('G:V', 5, center)
	worksheet661.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF GAJAH MADA', title)
	worksheet661.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet661.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet661.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet661.write('G5', 'MAT', body)
	worksheet661.write('H5', 'IND', body)
	worksheet661.write('I5', 'ENG', body)
	worksheet661.write('J5', 'SEJ', body)
	worksheet661.write('K5', 'GEO', body)
	worksheet661.write('L5', 'SOS', body)
	worksheet661.write('M5', 'EKO', body)
	worksheet661.write('N5', 'JML', body)
	worksheet661.write('O5', 'MAT', body)
	worksheet661.write('P5', 'IND', body)
	worksheet661.write('Q5', 'ENG', body)
	worksheet661.write('R5', 'SEJ', body)
	worksheet661.write('S5', 'GEO', body)
	worksheet661.write('T5', 'SOS', body)
	worksheet661.write('U5', 'EKO', body)
	worksheet661.write('V5', 'JML', body)



	worksheet661.conditional_format(5,0,row661_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet661.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF GAJAH MADA', title)
	worksheet661.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet661.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet661.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet661.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet661.write('K22', 'GEO', body)
	worksheet661.write('L22', 'SOS', body)
	worksheet661.write('M22', 'EKO', body)
	worksheet661.write('N22', 'JML', body)
	worksheet661.write('O22', 'MAT', body)
	worksheet661.write('P22', 'IND', body)
	worksheet661.write('Q22', 'ENG', body)
	worksheet661.write('R22', 'SEJ', body)
	worksheet661.write('S22', 'GEO', body)
	worksheet661.write('T22', 'SOS', body)
	worksheet661.write('U22', 'EKO', body)
	worksheet661.write('V22', 'JML', body)

	worksheet661.conditional_format(22,0,row661+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet662.set_column('G:V', 5, center)
	worksheet662.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF LOLONG BELANTI', title)
	worksheet662.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet662.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet662.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet662.write('G5', 'MAT', body)
	worksheet662.write('H5', 'IND', body)
	worksheet662.write('I5', 'ENG', body)
	worksheet662.write('J5', 'SEJ', body)
	worksheet662.write('K5', 'GEO', body)
	worksheet662.write('L5', 'SOS', body)
	worksheet662.write('M5', 'EKO', body)
	worksheet662.write('N5', 'JML', body)
	worksheet662.write('O5', 'MAT', body)
	worksheet662.write('P5', 'IND', body)
	worksheet662.write('Q5', 'ENG', body)
	worksheet662.write('R5', 'SEJ', body)
	worksheet662.write('S5', 'GEO', body)
	worksheet662.write('T5', 'SOS', body)
	worksheet662.write('U5', 'EKO', body)
	worksheet662.write('V5', 'JML', body)



	worksheet662.conditional_format(5,0,row662_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet662.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF LOLONG BELANTI', title)
	worksheet662.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet662.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet662.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet662.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet662.write('K22', 'GEO', body)
	worksheet662.write('L22', 'SOS', body)
	worksheet662.write('M22', 'EKO', body)
	worksheet662.write('N22', 'JML', body)
	worksheet662.write('O22', 'MAT', body)
	worksheet662.write('P22', 'IND', body)
	worksheet662.write('Q22', 'ENG', body)
	worksheet662.write('R22', 'SEJ', body)
	worksheet662.write('S22', 'GEO', body)
	worksheet662.write('T22', 'SOS', body)
	worksheet662.write('U22', 'EKO', body)
	worksheet662.write('V22', 'JML', body)

	worksheet662.conditional_format(22,0,row662+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet663.set_column('G:V', 5, center)
	worksheet663.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF SOETOMO', title)
	worksheet663.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet663.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet663.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet663.write('G5', 'MAT', body)
	worksheet663.write('H5', 'IND', body)
	worksheet663.write('I5', 'ENG', body)
	worksheet663.write('J5', 'SEJ', body)
	worksheet663.write('K5', 'GEO', body)
	worksheet663.write('L5', 'SOS', body)
	worksheet663.write('M5', 'EKO', body)
	worksheet663.write('N5', 'JML', body)
	worksheet663.write('O5', 'MAT', body)
	worksheet663.write('P5', 'IND', body)
	worksheet663.write('Q5', 'ENG', body)
	worksheet663.write('R5', 'SEJ', body)
	worksheet663.write('S5', 'GEO', body)
	worksheet663.write('T5', 'SOS', body)
	worksheet663.write('U5', 'EKO', body)
	worksheet663.write('V5', 'JML', body)



	worksheet663.conditional_format(5,0,row663_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet663.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF SOETOMO', title)
	worksheet663.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet663.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet663.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet663.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet663.write('K22', 'GEO', body)
	worksheet663.write('L22', 'SOS', body)
	worksheet663.write('M22', 'EKO', body)
	worksheet663.write('N22', 'JML', body)
	worksheet663.write('O22', 'MAT', body)
	worksheet663.write('P22', 'IND', body)
	worksheet663.write('Q22', 'ENG', body)
	worksheet663.write('R22', 'SEJ', body)
	worksheet663.write('S22', 'GEO', body)
	worksheet663.write('T22', 'SOS', body)
	worksheet663.write('U22', 'EKO', body)
	worksheet663.write('V22', 'JML', body)

	worksheet663.conditional_format(22,0,row663+21,21, 
	                             {'type': 'no_errors', 'format': border})
	...
	worksheet664.set_column('G:V', 5, center)
	worksheet664.merge_range('A1:V1', '10 SISWA KELAS 10 SMA IPS PERINGKAT TERTINGGI NF TAN MALAKA', title)
	worksheet664.merge_range('A2:V2', 'PENILAIAN AKHIR SEMESTER - SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet664.merge_range('G4:N4', 'JUMLAH BENAR', header)
	worksheet664.merge_range('O4:V4', 'NILAI STANDAR', header)
	worksheet664.write('G5', 'MAT', body)
	worksheet664.write('H5', 'IND', body)
	worksheet664.write('I5', 'ENG', body)
	worksheet664.write('J5', 'SEJ', body)
	worksheet664.write('K5', 'GEO', body)
	worksheet664.write('L5', 'SOS', body)
	worksheet664.write('M5', 'EKO', body)
	worksheet664.write('N5', 'JML', body)
	worksheet664.write('O5', 'MAT', body)
	worksheet664.write('P5', 'IND', body)
	worksheet664.write('Q5', 'ENG', body)
	worksheet664.write('R5', 'SEJ', body)
	worksheet664.write('S5', 'GEO', body)
	worksheet664.write('T5', 'SOS', body)
	worksheet664.write('U5', 'EKO', body)
	worksheet664.write('V5', 'JML', body)



	worksheet664.conditional_format(5,0,row664_10+4,21, 
	                             {'type': 'no_errors', 'format': border})

	worksheet664.merge_range('A17:V17', 'KELAS 10 SMA IPS - LOKASI NF TAN MALAKA', title)
	worksheet664.merge_range('A18:V18', 'PENILAIAN AKHIR SEMESTER', subTitle)
	worksheet664.merge_range('A19:V19', 'SEMESTER 1 TAHUN 2022 - 2023', sub_title)
	...
	worksheet664.merge_range('G21:N21', 'JUMLAH BENAR', header)
	worksheet664.merge_range('O21:V21', 'NILAI STANDAR', header)
	...
	worksheet664.write('K22', 'GEO', body)
	worksheet664.write('L22', 'SOS', body)
	worksheet664.write('M22', 'EKO', body)
	worksheet664.write('N22', 'JML', body)
	worksheet664.write('O22', 'MAT', body)
	worksheet664.write('P22', 'IND', body)
	worksheet664.write('Q22', 'ENG', body)
	worksheet664.write('R22', 'SEJ', body)
	worksheet664.write('S22', 'GEO', body)
	worksheet664.write('T22', 'SOS', body)
	worksheet664.write('U22', 'EKO', body)
	worksheet664.write('V22', 'JML', body)

	worksheet664.conditional_format(22,0,row664+21,21, 
	                             {'type': 'no_errors', 'format': border})
